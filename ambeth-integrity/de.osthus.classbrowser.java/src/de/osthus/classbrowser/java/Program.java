...
public class Program
{
	...
	private static void displayHelpAndWait()
	{
		List<String> messages = Arrays.asList( //
				...
				ARG_KEY_MODULEROOTPATH + "={modulerootpath} sets the root path to the source files needed to identify the modules; "
	...
	/**
	 * Get target path for the export file. Throws an exception if the path wasn't found or doesn't exist.
	 * 
	 * @return Target path
	 */
