...
public class ParserUtil {
	...
	public static final String JAVA_ANNOTATION_PROPERTY = "com.koch.ambeth.config.Property";
	...
	public static void checkType(String typeToCheck) {
		if (TYPE_CLASS.equals(typeToCheck) || TYPE_DELEGATE.equals(typeToCheck)
				|| TYPE_ENUM.equals(typeToCheck) || TYPE_INTERFACE.equals(typeToCheck)
	...
	public static List<TypeDescription> analyzeClasses(List<ClassHolder> classes,
			Map<String, String> moduleMap, List<String> modulesToBeAnalyzed) {
		List<TypeDescription> foundTypes = new ArrayList<>();
		if (classes == null) {
			return foundTypes;
		}
	...
	private static boolean isModuleSkipped(String moduleName, List<String> modulesToBeAnalyzed) {
		...
		boolean doAnalyze = StringUtils.isBlank(moduleName)
				|| modulesToBeAnalyzed.contains(moduleName.trim().toLowerCase());
		return !doAnalyze;
	}
	...
	private static boolean isTypeSkipped(Class<?> classToBeAnalyzed) {
		boolean skip = false;
		if (classToBeAnalyzed.isAnonymousClass() || classToBeAnalyzed.isLocalClass()
				|| classToBeAnalyzed.isMemberClass()
	...
	public static MethodDescription createMethodDescriptionFrom(Method methodInfo) {
		if (methodInfo == null) {
			throw new IllegalArgumentException(
					"Mandatory values for creating a method description are missing!");
		}
	...
	public static FieldDescription createFieldDescriptionFrom(Field fieldInfo) {
		if (fieldInfo == null) {
			throw new IllegalArgumentException(
					"Mandatory values for creating a field description are missing!");
		}
	...
	public static List<String> getModifiersFrom(Method methodInfo) {
		if (methodInfo == null) {
			throw new IllegalArgumentException(
					"Mandatory values to get the method modifiers are missing!");
		}
	...
	public static List<String> getModifiersFrom(Field fieldInfo) {
		if (fieldInfo == null) {
			throw new IllegalArgumentException(
					"Mandatory values to get the field modifiers are missing!");
		}
	...
	public static List<String> getParameterTypesFrom(Method methodInfo) {
		if (methodInfo == null) {
			throw new IllegalArgumentException(
					"Mandatory values to get the parameter types are missing!");
		}
	...
	public static boolean containsAnnotation(List<AnnotationInfo> annotationInfo,
