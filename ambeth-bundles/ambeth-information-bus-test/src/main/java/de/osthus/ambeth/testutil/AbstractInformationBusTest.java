...
@TestFrameworkModule({ BytecodeModule.class, CacheModule.class, CacheBytecodeModule.class, CacheDataChangeModule.class, CacheStreamModule.class,
		DataChangeModule.class, EventModule.class, EventDataChangeModule.class, MappingModule.class, MergeModule.class, MergeBytecodeModule.class,
		ObjectCopierModule.class, SecurityModule.class, SensorModule.class, ServiceModule.class, StreamModule.class })
