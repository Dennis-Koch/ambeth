...
@TestProperties(name = CoreConfigurationConstants.PluginPaths,
		value = "${pluginScanResource}/modules.jar;${pluginScanResource}/jars/;${pluginScanResource}/onejarfolder")
public class PluginClasspathScannerTest extends AbstractIocTest {
	...
	public static void beforeClass() throws URISyntaxException {
		...
		String pluginScanResource =
				new File(PluginClasspathScannerTest.class.getResource("/pluginScanResource").toURI())
						.getAbsolutePath();
	...
	public void pluginClassRegistTest() throws Exception {
		// inject as module
		applicationContext.createService("application",
				bootstrapModuleClasses.toArray(new Class<?>[bootstrapModuleClasses.size()]));
		applicationContext.createService("framework",
				frameworkModuleClasses.toArray(new Class<?>[frameworkModuleClasses.size()]));
	}
