...
/**
 * The ImplementAbstractObjectBehavior creates objects that implement an interface registered for
 * {@link IImplementAbstractObjectFactory}. The generated implementations inherit from
 * {@link IImplementAbstractObjectFactory#getBaseType(Class)} if interface type was registered with
 * an base type.
 */
public class ImplementAbstractObjectBehavior extends AbstractBehavior {
	 ...
	 *
	 * @param visitor the last visitor
	 * @param type the Type to be implemented
	 * @return The new visitor
	 */
	protected ClassVisitor visitType(ClassVisitor visitor, Class<?> type,
			List<IBytecodeBehavior> cascadePendingBehaviors) {
		return visitor;
	}
