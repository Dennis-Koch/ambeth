...
/**
 * IImplementAbstractObjectFactoryExtendable provides configuration for
 * {@link IImplementAbstractObjectFactory} to implement objects based on interfaces. Optionally the
...
public interface IImplementAbstractObjectFactoryExtendable {
	 ...
	 *
	 * @param baseType The (abstract) base type to be extended
	 * @param keyType The type to be implemented
	 */
	void registerBaseType(Class<?> baseType, Class<?> keyType);

	/**
	 * Registers a type to be implemented by this extension. The implementation will implement
	 * interfaceTypes
	 *
	 * @param interfaceTypes The interface types to be implemented
	 * @param keyType The type to be implemented
	 */
	 ...
	 *
	 * @param keyType The type to be unregistered
	 */
