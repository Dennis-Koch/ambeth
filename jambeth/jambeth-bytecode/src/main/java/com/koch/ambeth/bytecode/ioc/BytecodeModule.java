...
public class BytecodeModule implements IInitializingModule {
	...
	public void afterPropertiesSet(IBeanContextFactory beanContextFactory) throws Throwable {
		beanContextFactory.registerBean("bytecodeEnhancer", BytecodeEnhancer.class)
				.autowireable(IBytecodeEnhancer.class, IBytecodeBehaviorExtendable.class);

		IBeanConfiguration bytecodeClassLoaderBC =
				beanContextFactory.registerBean(BytecodeClassLoader.class)
						.autowireable(IBytecodeClassLoader.class, IBytecodePrinter.class);
		beanContextFactory.link(bytecodeClassLoaderBC).to(IEventListenerExtendable.class)
				.with(ClearAllCachesEvent.class).optional();
	}

	public static IBeanConfiguration addDefaultBytecodeBehavior(
			IBeanContextFactory beanContextFactory, Class<? extends IBytecodeBehavior> behaviorType) {
