...
public class FieldInstance {
	public static final String getSignature(java.lang.reflect.Field field) {
		try {
			java.lang.reflect.Method getGenericSignature =
					field.getClass().getDeclaredMethod("getGenericSignature");
	...
	public static final String getSignatureFromReturnType(String methodSignature) {
		...
		final ParamHolder<String> fieldSignature = new ParamHolder<>();
	...
	public static final String getSignatureFromParameterType(java.lang.reflect.Method method,
			int parameterIndex) {
		String methodSignature = MethodInstance.getSignature(method);
		return getSignatureFromParameterType(methodSignature, parameterIndex);
	}

	public static final String getSignatureFromParameterType(MethodInstance method,
			int parameterIndex) {
		return getSignatureFromParameterType(method.getSignature(), parameterIndex);
	}

	public static final String getSignatureFromParameterType(String methodSignature,
	...
	public FieldInstance(java.lang.reflect.Field field) {
		this(Type.getType(field.getDeclaringClass()),
				TypeUtil.getModifiersToAccess(field.getModifiers()), field.getName(), getSignature(field),
	...
	public FieldInstance(int access, String name, String signature, Class<?> type) {
		this(BytecodeBehaviorState.getState().getNewType(), access, name, signature,
				Type.getType(type));
	}
