...
/**
 * IImplementAbstractObjectFactory implements objects based on interfaces. Optionally the
...
public interface IImplementAbstractObjectFactory {
	...
	/**
	 * Returns the base type registered for this type. The base type as a(n abstract) class that is
	 * extended when creating the types implementation.
	 *
	 * @param keyType The type to be implemented
	...
	/**
	 * Creates the implementation of the type. Optionally the implementation can inherit from an
	 * (abstract) base base type
	 *
	 * @param keyType The type to be implemented
