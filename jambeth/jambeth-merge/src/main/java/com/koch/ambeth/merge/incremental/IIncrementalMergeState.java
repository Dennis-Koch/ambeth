...
public interface IIncrementalMergeState extends IMergeProcessFinishListenerExtendable {
	...
	<T> T getCustomState(Object key);

	<T> T setCustomState(Object key, Object value);
}
