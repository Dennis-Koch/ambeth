...
public class EmbeddedEnhancementHint implements ITargetNameEnhancementHint, Serializable {
	...
	public EmbeddedEnhancementHint(Class<?> rootEntityType, Class<?> parentObjectType,
			String memberPath) {
	...
	public boolean equals(Object obj) {
		...
		return getParentObjectType().equals(other.getParentObjectType())
				&& getMemberPath().equals(other.getMemberPath());
	}
	...
	public String toString() {
		return getClass().getSimpleName() + " Root: " + getRootEntityType().getSimpleName() + ", Path: "
				+ getMemberPath() + ", Parent: " + getParentObjectType().getSimpleName();
	}
}
