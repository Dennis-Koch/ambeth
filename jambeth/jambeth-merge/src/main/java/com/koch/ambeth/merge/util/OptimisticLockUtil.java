...
public final class OptimisticLockUtil {
	public static OptimisticLockException throwDeleted(IObjRef objRef) {
		throw new OptimisticLockException(
				"Object outdated: " + objRef + " has been deleted concurrently", null, objRef);
	}

	public static OptimisticLockException throwDeleted(IObjRef objRef, Object obj) {
		throw new OptimisticLockException(
				"Object outdated: " + objRef + " has been deleted concurrently", null, obj);
	}
	...
	public static OptimisticLockException throwModified(IObjRef objRef, Object givenVersion,
		...
		if (obj != null) {
			throw new OptimisticLockException(
					"Object outdated: " + objRef + " has been modified concurrently" + givenVersionString,
					null, obj);
		}
		throw new OptimisticLockException(
				"Object outdated: " + objRef + " has been modified concurrently" + givenVersionString, null,
