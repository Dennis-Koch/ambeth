...
public class ObjRefMixin {
	public boolean objRefEquals(IObjRef objRef, Object obj) {
		...
		if (objRef.getIdNameIndex() != other.getIdNameIndex()
				|| !objRef.getRealType().equals(other.getRealType())) {
			return false;
		}
	...
	public void objRefToString(IObjRef objRef, StringBuilder sb) {
		...
		sb.append(" version=").append(objRef.getVersion()).append(" type=")
				.append(objRef.getRealType().getName());
	}
}
