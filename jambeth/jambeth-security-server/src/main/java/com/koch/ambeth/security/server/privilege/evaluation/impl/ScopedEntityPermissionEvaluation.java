...
public class ScopedEntityPermissionEvaluation
		implements IScopedEntityPermissionEvaluation, IScopedCreateEntityStep, IScopedUpdateEntityStep,
		IScopedDeleteEntityStep, IScopedExecuteEntityStep {
	protected Boolean create, read, update, delete, execute;

	protected final ArrayList<ScopedEntityPropertyPermissionEvaluation> unusedPropertyPermissions =
			new ArrayList<>();

	protected final HashMap<String, ScopedEntityPropertyPermissionEvaluation> propertyPermissions =
			new HashMap<>();
	...
	public IScopedCreateEntityPropertyStep allowReadProperty(String propertyName) {
		...
		allowRead();
		ScopedEntityPropertyPermissionEvaluation propertyPermission =
				getPropertyPermission(propertyName);
	...
	protected ScopedEntityPropertyPermissionEvaluation getPropertyPermission(String propertyName) {
		ScopedEntityPropertyPermissionEvaluation propertyPermission =
				propertyPermissions.get(propertyName);
