...
public interface IEntityTypePermissionRule extends IPermissionRule {
	/**
	 * Use this to implement per-entity-type security (in SQL-terminology: table-level-security)
	 * and/or per-property security (in SQL: column-level security)
	 *
	 * @param entityType
	 * @param currentUser
	 ...
	 * @param pe
	 */
	void evaluatePermissionOnType(Class<?> entityType, IAuthorization currentUser,
