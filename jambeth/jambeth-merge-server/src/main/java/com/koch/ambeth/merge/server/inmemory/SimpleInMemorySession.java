...
public class SimpleInMemorySession implements IDisposable {
	...
	protected final HashSet<IObjRef> createdObjRefs = new HashSet<>();

	protected final HashSet<IObjRef> updatedObjRefs = new HashSet<>();

	protected final HashSet<IObjRef> deletedObjRefs = new HashSet<>();

	protected final HashSet<IObjRef> changesOfSession = new HashSet<>();
