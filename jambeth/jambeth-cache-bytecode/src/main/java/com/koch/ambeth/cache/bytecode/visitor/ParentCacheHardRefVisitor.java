...
public class ParentCacheHardRefVisitor extends ClassGenerator {
	private static final MethodInstance template_m_setParentCacheValueHardRef = new MethodInstance(
			null, IParentCacheValueHardRef.class, void.class, "setParentCacheValueHardRef", Object.class);
	...
	protected void implementParentCacheValueHardRef() {
		FieldInstance f_pcvhr = new FieldInstance(Opcodes.ACC_PRIVATE, "$pcvhr",
				template_m_setParentCacheValueHardRef.getSignatureFromParameterType(0),
