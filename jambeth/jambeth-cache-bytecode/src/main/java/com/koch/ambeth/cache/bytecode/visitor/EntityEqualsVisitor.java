...
public class EntityEqualsVisitor extends ClassGenerator {
    ...
    private static final MethodInstance entityEquals_toString_Obj = new MethodInstance(null, templateType, String.class, "toString", IEntityEquals.class, IPrintable.class);
