...
public class EntityMetaDataHolderVisitor extends ClassGenerator {
	public static final MethodInstance m_template_getEntityMetaData = new MethodInstance(null,
			IEntityMetaDataHolder.class, IEntityMetaData.class, "get__EntityMetaData");

	public static MethodInstance getImplementedGetEntityMetaData(ClassGenerator cv,
