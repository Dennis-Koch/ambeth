...
public class SetCacheModificationMethodCreator extends ClassGenerator {
    private static final MethodInstance m_callCacheModificationActive =
            new MethodInstance(null, SetCacheModificationMethodCreator.class, void.class, "callCacheModificationActive", ICacheModification.class, boolean.class, boolean.class);

    private static final MethodInstance m_callCacheModificationInternalUpdate =
            new MethodInstance(null, SetCacheModificationMethodCreator.class, void.class, "callCacheModificationInternalUpdate", ICacheModification.class, boolean.class, boolean.class);
