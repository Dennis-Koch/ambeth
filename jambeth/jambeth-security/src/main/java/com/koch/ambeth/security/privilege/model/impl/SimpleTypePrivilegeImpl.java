...
public class SimpleTypePrivilegeImpl extends AbstractTypePrivilege {
	...
	public SimpleTypePrivilegeImpl(Boolean create, Boolean read, Boolean update, Boolean delete,
			Boolean execute, ITypePropertyPrivilege defaultPropertyPrivileges) {
