...
public class AmbethKafkaJUnitRuleLegacy implements TestRule {
    // constant variables
    private static final Logger LOGGER = LoggerFactory.getLogger(AmbethKafkaJUnitRuleLegacy.class);
    ...
    public AmbethKafkaJUnitRuleLegacy(Object test) {
        this.test = Objects.requireNonNull(test, "test must be valid");
    }
    ...
    public Statement apply(Statement base, Description description) {
        return new Statement() {
            ...
            public void evaluate() throws Throwable {
                ...
                testName = testClass.getName() + '.' + description.getMethodName();
                ...
                AmbethKafkaJUnitRuleLegacy.this.kafkaProps = AmbethKafkaConfiguration.extractKafkaProperties(props);
