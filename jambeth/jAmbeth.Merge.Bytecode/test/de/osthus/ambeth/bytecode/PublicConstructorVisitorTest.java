...
@TestProperties(name = ConfigurationConstants.mappingFile, value = "de/osthus/ambeth/bytecode/orm.xml")
@TestRebuildContext
public class PublicConstructorVisitorTest extends AbstractIocTest
{
	@Autowired
	...
	public void testDefaultAndNonDefaultConstructor()
	{
		...
		Constructor<?> nonDefaultConstructor = declaredConstructors[1];
		Assert.assertEquals(2, nonDefaultConstructor.getParameterTypes().length);
	}
