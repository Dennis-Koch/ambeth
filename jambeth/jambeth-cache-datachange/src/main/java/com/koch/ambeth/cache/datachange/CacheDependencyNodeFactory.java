...
public class CacheDependencyNodeFactory {
	public static CacheDependencyNode addRootCache(IRootCache rootCache,
			IdentityHashMap<IRootCache, CacheDependencyNode> rootCacheToNodeMap) {
	...
	public static CacheDependencyNode buildRootNode(
