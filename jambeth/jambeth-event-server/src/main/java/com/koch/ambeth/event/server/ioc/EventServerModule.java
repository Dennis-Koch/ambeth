...
public class EventServerModule implements IInitializingModule, IPropertyLoadingBean {
	...
	public void afterPropertiesSet(IBeanContextFactory beanContextFactory) throws Throwable {
		beanContextFactory.registerBean(EVENT_MANAGER, EventManager.class)
				.autowireable(IEventProvider.class, IEventStore.class, IEventStoreHandlerExtendable.class);

		beanContextFactory.registerBean("eventService", EventService.class)
