...
public class H2Module implements IInitializingModule, IPropertyLoadingBean {
	...
	public void afterPropertiesSet(IBeanContextFactory beanContextFactory) throws Throwable {
		...
		beanContextFactory.registerBean(H2ExtendedDialect.class)
		...
		beanContextFactory.registerBean(H2SequencePrimaryKeyProvider.class)
				.autowireable(IPrimaryKeyProvider.class);

		beanContextFactory.registerBean(H2ConnectionExtension.class)
