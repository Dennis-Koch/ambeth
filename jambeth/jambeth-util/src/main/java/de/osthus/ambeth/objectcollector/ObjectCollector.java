...
public class ObjectCollector implements IObjectCollector, IThreadLocalObjectCollector, ICollectableControllerExtendable
{
	...
	protected final HashMap<Class<?>, IObjectCollectorItem> unusedListMap = new HashMap<Class<?>, IObjectCollectorItem>(100, 0.5f);

	protected final HashMap<Class<?>, ICollectableController> typeToControllerMap = new HashMap<Class<?>, ICollectableController>(16, 0.5f);
	...
	public void unregisterCollectableController(ICollectableController collectableController, Class<?> handledType)
	{
		...
		try
		{
			...
			{
				throw new IllegalArgumentException("CollectableController " + collectableController + " is not mapped to type " + handledType);
			}
	...
	protected IObjectCollectorItem allocateOcItem(final Class<?> type) throws NoSuchMethodException
	{
		...
		IObjectCollectorItem ocItem = new SimpleLockingObjectCollectorItem(this, collectableController, type);
