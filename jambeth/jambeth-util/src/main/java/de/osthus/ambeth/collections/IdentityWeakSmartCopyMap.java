 ...
 * @param <V>
 */
public class IdentityWeakSmartCopyMap<K, V> extends IdentityWeakHashMap<K, V>
{
	...
	{
		final IdentityWeakSmartCopyMap<K, V> This = this;
		// Copy existing data in FULLY NEW STRUCTURE
		IMapEntry<K, V>[] table = this.table;
		IdentityWeakHashMap<K, V> backupMap = new IdentityWeakHashMap<K, V>(table.length, this.loadFactor)
		{
			@Override
