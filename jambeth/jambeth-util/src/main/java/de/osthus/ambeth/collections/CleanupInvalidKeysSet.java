...
public class CleanupInvalidKeysSet<K> extends HashSet<K>
{
	...
	public CleanupInvalidKeysSet(IInvalidKeyChecker<K> invalidKeyChecker, Collection<? extends K> sourceCollection)
	{
	...
	public CleanupInvalidKeysSet(IInvalidKeyChecker<K> invalidKeyChecker, int initialCapacity, float loadFactor, Class<? extends ISetEntry> entryClass)
	{
