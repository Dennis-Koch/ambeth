...
public interface IDedicatedConverterExtendable
{
	 ...
	 * </code>
	 * 
	 * @param dedicatedConverter
	 *            given {@link IDedicatedConverter} to register
	 * @param sourceType
	 *            Most abstract sourceType the given {@link IDedicatedConverter} claims to be able to convert from
	 * @param targetType
	 *            Most specific targetType the given {@link IDedicatedConverter} claims to be able to convert to
	 */
	 ...
	 * 
	 * @param dedicatedConverter
	 *            given {@link IDedicatedConverter} to unregister
	 * @param sourceType
	 *            Most abstract sourceType the given {@link IDedicatedConverter} claims to be able to convert from
	 * @param targetType
	 *            Most specific targetType the given {@link IDedicatedConverter} claims to be able to convert to
