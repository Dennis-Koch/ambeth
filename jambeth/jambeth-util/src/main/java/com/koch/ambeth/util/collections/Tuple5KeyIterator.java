...
public class Tuple5KeyIterator<Key1, Key2, Key3, Key4, Key5, V>
		implements Iterator<Tuple5KeyEntry<Key1, Key2, Key3, Key4, Key5, V>> {
	...
	public Tuple5KeyIterator(AbstractTuple5KeyHashMap<Key1, Key2, Key3, Key4, Key5, V> hashMap,
			Tuple5KeyEntry<Key1, Key2, Key3, Key4, Key5, V>[] table, boolean removeAllowed) {
	...
	public void remove() {
		...
		hashMap.remove(currEntry.getKey1(), currEntry.getKey2(), currEntry.getKey3(),
				currEntry.getKey4(), currEntry.getKey5());
