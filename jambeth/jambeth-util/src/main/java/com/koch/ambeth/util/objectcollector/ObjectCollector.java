...
public class ObjectCollector implements IObjectCollector, IThreadLocalObjectCollector, ICollectableControllerExtendable {
    ...
    public static final String BEAN_NAME = "objectCollector";

    protected final HashMap<Class<?>, IObjectCollectorItem> unusedListMap = new HashMap<>(100, 0.5f);

    protected final HashMap<Class<?>, ICollectableController> typeToControllerMap = new HashMap<>(16, 0.5f);
