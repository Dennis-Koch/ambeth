...
public class ObservableArrayList<V> implements List<V>, IList<V>, Externalizable, IObservableList<V> {
    ...
    public void addNotifyCollectionChangedListener(INotifyCollectionChangedListener listener) {
        ...
        ((CollectionChangeSupport) notifyCollectionChangedSupport).addNotifyCollectionChangedListener(listener);
    }
    ...
    public void removeNotifyCollectionChangedListener(INotifyCollectionChangedListener listener) {
        ...
        ((CollectionChangeSupport) notifyCollectionChangedSupport).removeNotifyCollectionChangedListener(listener);
    }
    ...
    protected void fireNotifyCollectionChanged(NotifyCollectionChangedEvent event) {
        ...
        ((CollectionChangeSupport) notifyCollectionChangedSupport).fireCollectionChange(event);
    }
    ...
    public <T extends V> boolean addAll(T[] externArray, int startIndex, int length) {
        ...
        if (notifyCollectionChangedSupport != null && length > 0) {
            if (startIndex != 0 || length != externArray.length) {
                T[] scopedArray = (T[]) Array.newInstance(externArray.getClass().getComponentType(), length);
    ...
    public boolean removeAll(final Collection<?> c) {
        ...
        if (notifyCollectionChangedSupport != null && result.size > 0) {
            fireNotifyCollectionChanged(new NotifyCollectionChangedEvent(this, NotifyCollectionChangedAction.Remove, result.toArray()));
        }
