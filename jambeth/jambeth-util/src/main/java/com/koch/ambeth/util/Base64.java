...
public class Base64 {
	...
	/**
	 * Discards any characters outside of the base64 alphabet, per the requirements on page 25 of RFC
	 * 2045 - "Any characters outside of the base64 alphabet are to be ignored in base64 encoded
	 * data."
	 *
	 ...
	 * @return An object (of type byte[]) containing the base64 encoded data which corresponds to the
	 *         byte[] supplied.
