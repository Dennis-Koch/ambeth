...
public final class ListUtil {
    ...
    public static Collection<Object> createCollectionOfType(Class<?> expectedCollectionType, Constructor<?> setTypeC, Constructor<?> sizeSetTypeC, Constructor<?> listTypeC,
    ...
    @SneakyThrows
    @SuppressWarnings("unchecked")
    public static Collection<Object> createCollectionOfType(Class<?> expectedCollectionType, int size, Constructor<?> setTypeC, Constructor<?> sizeSetTypeC, Constructor<?> listTypeC,
            Constructor<?> sizeListTypeC) {
        ...
        if (Set.class.isAssignableFrom(expectedCollectionType)) {
            if (size != -1 && sizeSetTypeC != null) {
                return (Collection<Object>) sizeSetTypeC.newInstance((int) (size / AbstractHashSet.DEFAULT_LOAD_FACTOR) + 1, AbstractHashSet.DEFAULT_LOAD_FACTOR);
            }
