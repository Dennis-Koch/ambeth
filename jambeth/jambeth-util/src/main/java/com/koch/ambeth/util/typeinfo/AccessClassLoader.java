...
public class AccessClassLoader extends ClassLoader {
	private static final WeakHashMap<ClassLoader, Reference<AccessClassLoader>> parentToAccessClassLoaderMap =
	...
	static AccessClassLoader get(Class<?> type) {
		...
		writeLock.lock();
		try {
			Reference<AccessClassLoader> accessClassLoaderR =
					parent != null ? parentToAccessClassLoaderMap.get(parent) : noParentAccessClassLoaderR;
