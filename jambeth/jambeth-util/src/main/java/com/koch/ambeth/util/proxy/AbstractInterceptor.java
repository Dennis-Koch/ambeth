...
public abstract class AbstractInterceptor extends CascadedInterceptor {
	...
	protected Object intercept(Object obj, Method method, Object[] args, MethodProxy proxy,
			Annotation annotation, String methodName, Boolean isAsyncBegin) throws Throwable {
		if (annotation instanceof Process) {
			return interceptApplication(obj, method, args, proxy, annotation, isAsyncBegin);
		}
		if (annotation instanceof Merge || methodName.startsWith("create")
				|| methodName.startsWith("update") || methodName.startsWith("save")
				|| methodName.startsWith("merge") || methodName.startsWith("insert")) {
			return interceptMerge(method, args, annotation, isAsyncBegin);
		}
		if (annotation instanceof Remove || methodName.startsWith("delete")
				|| methodName.startsWith("remove")) {
			return interceptDelete(method, args, annotation, isAsyncBegin);
		}
		if (annotation instanceof Find || methodName.startsWith("retrieve")
				|| methodName.startsWith("read") || methodName.startsWith("find")
	...
	protected Object interceptMerge(Method method, Object[] args, Annotation annotation,
	...
	protected Object interceptDelete(Method method, Object[] args, Annotation annotation,
			Boolean isAsyncBegin) throws Throwable {
		if (Boolean.FALSE.equals(isAsyncBegin)) {
			throw new RuntimeException();
			// return ((IAsyncResult)invocation.Arguments[0]).AsyncState;
	...
	protected Object interceptLoadIntern(Method method, Object[] arguments, Annotation annotation,
			Boolean isAsyncBegin, Object result) throws Throwable {
		return result;
	}

	protected abstract Object interceptMergeIntern(Method method, Object[] arguments,
			Annotation annotation, Boolean isAsyncBegin) throws Throwable;

	protected abstract Object interceptDeleteIntern(Method method, Object[] arguments,
			Annotation annotation, Boolean isAsyncBegin) throws Throwable;
}
