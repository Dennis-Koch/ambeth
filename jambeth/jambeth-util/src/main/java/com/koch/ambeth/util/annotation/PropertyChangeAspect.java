...
/**
 * If PropertyChangeAspect is added to a class or interface the bytecode enhancement - if connected
 * to the IOC container - will add support for PCEs (PropertyChangeEvents) implementing
