...
public class SimpleObjectCollectorItem implements IObjectCollectorItem {
	protected final ArrayList<Object> unusedList = new ArrayList<>();
	...
	protected SimpleObjectCollectorItem(IObjectCollector objectCollector,
			ICollectableController collectableController, Class<?> constructorClass) {
		if (collectableController == null) {
			throw new IllegalArgumentException("No " + ICollectableController.class.getSimpleName()
					+ " found for type " + constructorClass.getName());
		}
