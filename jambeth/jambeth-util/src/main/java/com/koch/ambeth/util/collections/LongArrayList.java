...
/**
 * Hochperformante Implementierung einer Liste speziell f�r primitive Integer. Die �bliche
 * Verwendung einer auf Integer.class typisierten java.util.List f�hrt zu einer enormen Garbage-Last
