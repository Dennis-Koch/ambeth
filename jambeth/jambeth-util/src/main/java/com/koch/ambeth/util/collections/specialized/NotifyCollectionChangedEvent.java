...
public class NotifyCollectionChangedEvent extends java.util.EventObject {
	...
	/**
	 * Initializes a new instance of the NotifyCollectionChangedEventArgs class that describes a
	 * {@link NotifyCollectionChangedAction#Reset} change.
	 *
	 * @param action The action that caused the event. This must be set to
	 *        {@link NotifyCollectionChangedAction#Reset}.
	 ...
	 * multi-item change.
	 *
	 * @param action The action that caused the event. This can be set to
	 *        {@link NotifyCollectionChangedAction#Reset}, {@link NotifyCollectionChangedAction#Add},
	 *        or {@link NotifyCollectionChangedAction#Remove}.
	 * @param changedItems The items that are affected by the change.
	 * @throws {@link IllegalArgumentException} If action is not Reset, Add, or Remove, or if action
	 *         is Reset and changedItems is not null.
	 */
	public NotifyCollectionChangedEvent(Object source, NotifyCollectionChangedAction action,
			Object[] changedItems) {
	...
	/**
	 * Initializes a new instance of the NotifyCollectionChangedEventArgs class that describes a
	 * multi-item {@link NotifyCollectionChangedAction#Replace} change.
	 *
	 * @param action The action that caused the event. This can only be set to
	 *        {@link NotifyCollectionChangedAction#Replace}.
	 ...
	 */
	public NotifyCollectionChangedEvent(Object source, NotifyCollectionChangedAction action,
			Object[] newItems, Object[] oldItems) {
		this(source, action, newItems, oldItems, -1);
	}

	/**
	 * Initializes a new instance of the NotifyCollectionChangedEventArgs class that describes a
	 * multi-item change or a {@link NotifyCollectionChangedAction#Reset} change.
	 *
	 * @param action The action that caused the event. This can be set to
	 *        {@link NotifyCollectionChangedAction#Reset}, {@link NotifyCollectionChangedAction#Add},
	 *        or {@link NotifyCollectionChangedAction#Remove}.
	 ...
	 * @throws {@link IllegalArgumentException} If action is not Reset, Add, or Remove, if action is
	 *         Reset and either changedItems is not null or startingIndex is not -1, or if action is
	 *         Add or Remove and startingIndex is less than -1.
	 * @throws {@link IllegalArgumentException} If action is Add or Remove and changedItems is null.
	 */
	public NotifyCollectionChangedEvent(Object source, NotifyCollectionChangedAction action,
			Object[] changedItems, int startingIndex) {
		super(source);
		this.action = action;
	 ...
	 * @throws {@link IllegalArgumentException} If action is not Reset, Add, or Remove, or if action
	 *         is Reset and either changedItems is not null or index is not -1.
	 */
	public NotifyCollectionChangedEvent(Object source, NotifyCollectionChangedAction action,
	...
	/**
	 * Initializes a new instance of the NotifyCollectionChangedEventArgs class that describes a
	 * one-item {@link NotifyCollectionChangedAction#Replace} change.
	 *
	 * @param action The action that caused the event. This can only be set to
	 *        {@link NotifyCollectionChangedAction#Replace}.
	 ...
	 * @param newItems The new items that are replacing the original items.
	 * @param oldItems The original items that are replaced.
	 * @param startingIndex The index of the first item of the items that are being replaced.
	 * @throws {@link IllegalArgumentException} If action is not Replace.
	 * @throws {@link IllegalArgumentException} If oldItems or newItems is null.
	 */
	public NotifyCollectionChangedEvent(Object source, NotifyCollectionChangedAction action,
			Object[] newItems, Object[] oldItems, int startingIndex) {
		super(source);
	...
	/**
	 * Initializes a new instance of the NotifyCollectionChangedEventArgs class that describes a
	 * multi-item {@link NotifyCollectionChangedAction#Move} change.
	 *
	 * @param action The action that caused the event. This can only be set to
	 *        {@link NotifyCollectionChangedAction#Move} .
	 * @param changedItems The items affected by the change.
	 * @param newIndex The new index for the changed items.
	 ...
	 */
	public NotifyCollectionChangedEvent(Object source, NotifyCollectionChangedAction action,
			Object[] changedItems, int newIndex, int oldIndex) {
		super(source);
	 ...
	 * @param newIndex The new index for the changed item.
	 ...
	 *
	 * @return A {@link NotifyCollectionChangedAction} value that describes the action that caused the
	 *         event.
	 */
	...
	/**
	 * Gets the list of items affected by a {@link NotifyCollectionChangedAction} Replace, Remove, or
	 * Move action.
	 *
	 * @return The list of items affected by a {@link NotifyCollectionChangedAction} Replace, Remove,
	 *         or Move action.
	 */
	...
	/**
	 * Gets the index at which a {@link NotifyCollectionChangedAction} Move, Remove, or Replace action
	 * occurred.
	 *
	 * @return The zero-based index at which a {@link NotifyCollectionChangedAction} Move, Remove, or
	 *         Replace action occurred.
	 */
