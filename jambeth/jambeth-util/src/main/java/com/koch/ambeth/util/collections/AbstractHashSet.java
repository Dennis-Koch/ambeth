...
public abstract class AbstractHashSet<K> implements ISet<K>, IPrintable, Cloneable, IDTOType {
	...
	public AbstractHashSet(int initialCapacity, final float loadFactor,
	...
	protected abstract ISetEntry<K> createEntry(final int hash, final K key,
			final ISetEntry<K> nextEntry);
