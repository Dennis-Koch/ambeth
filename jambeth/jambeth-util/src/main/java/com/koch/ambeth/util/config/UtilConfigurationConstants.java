...
public final class UtilConfigurationConstants {
	...
	/**
	 * Allows to run Ambeth in debug mode. This e.g. enables more exception to ease debugging. Valid
	 * values: "true" or "false". Default is "false".
	 */
	public static final String DebugMode = "ambeth.debug.active";

	/**
	 * Allows to define a name which is attached to e.g. log statements or db users during tests to
	 * distinguish them from normal/productive use.
	 */
