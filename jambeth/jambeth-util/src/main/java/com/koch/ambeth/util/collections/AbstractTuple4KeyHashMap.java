...
public abstract class AbstractTuple4KeyHashMap<Key1, Key2, Key3, Key4, V>
		implements IPrintable, Iterable<Tuple4KeyEntry<Key1, Key2, Key3, Key4, V>>, Externalizable {
	...
	protected Tuple4KeyEntry<Key1, Key2, Key3, Key4, V>[] createTable(final int capacity) {
		return (Tuple4KeyEntry<Key1, Key2, Key3, Key4, V>[]) Array.newInstance(Tuple4KeyEntry.class,
				capacity);
	}
	...
	protected void addEntry(final int hash, Key1 key1, Key2 key2, Key3 key3, Key4 key4, final V value,
	...
	protected boolean equalKeys(final Key1 key1, final Key2 key2, final Key3 key3, final Key4 key4,
			final Tuple4KeyEntry<Key1, Key2, Key3, Key4, V> entry) {
	...
	public void putAll(
			final AbstractTuple4KeyHashMap<? extends Key1, ? extends Key2, ? extends Key3, ? extends Key4, ? extends V> map) {
	...
	protected V setValueForEntry(final Tuple4KeyEntry<Key1, Key2, Key3, Key4, V> entry,
			final V value) {
		V oldValue = entry.getValue();
	...
	protected abstract Tuple4KeyEntry<Key1, Key2, Key3, Key4, V> createEntry(final int hash,
			final Key1 key1, final Key2 key2, final Key3 key3, final Key4 key4, final V value,
	...
	public Iterator<Tuple4KeyEntry<Key1, Key2, Key3, Key4, V>> iterator() {
		return new Tuple4KeyIterator<>(this, table, true);
	}
