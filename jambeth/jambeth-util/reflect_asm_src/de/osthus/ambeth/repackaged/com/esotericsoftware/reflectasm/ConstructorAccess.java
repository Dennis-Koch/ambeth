...
import static de.osthus.ambeth.repackaged.org.objectweb.asm.Opcodes.POP;
...
public abstract class ConstructorAccess<T>
{
	 ...
	 * <p>
	 * If the underlying class is a inner (non-static nested) class, a new instance will be created using <code>null</code> as the this$0 synthetic reference.
	 * The instantiated object will work as long as it actually don't use any member variable or method fron the enclosing instance.
	 */
		...
		synchronized (loader)
		{
			...
			catch (ClassNotFoundException ignored)
			{
				...
				cw.visit(V1_1, ACC_PUBLIC + ACC_SUPER, accessClassNameInternal, null,
						"de/osthus/ambeth/repackaged/com/esotericsoftware/reflectasm/ConstructorAccess", null);
	...
	static private void insertConstructor(ClassWriter cw)
	{
		...
		mv.visitMethodInsn(INVOKESPECIAL, "de/osthus/ambeth/repackaged/com/esotericsoftware/reflectasm/ConstructorAccess", "<init>", "()V");
		mv.visitInsn(RETURN);
		mv.visitMaxs(1, 1);
		mv.visitEnd();
	}
