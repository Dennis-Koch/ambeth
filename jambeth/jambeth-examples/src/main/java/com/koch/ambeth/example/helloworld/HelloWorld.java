...
public class HelloWorld {
	public static void main(String[] args) throws Throwable {
		try (IServiceContext rootContext = BeanContextFactory.createBootstrap()) {
			IServiceContext beanContext = rootContext.createService("helloWorld", HelloWorldModule.class,
					IocModule.class);
			...
			String helloWorldString = conversionHelper.convertValueToType(String.class,
					new HelloWorldToken());
