...
public class EntityMetaDataRelationMemberVisitor extends ClassGenerator {
	protected static final MethodInstance template_m_getCascadeLoadMode =
			new MethodInstance(null, RelationMember.class, CascadeLoadMode.class, "getCascadeLoadMode");

	protected static final MethodInstance template_m_setCascadeLoadMode = new MethodInstance(null,
			IRelationMemberWrite.class, void.class, "setCascadeLoadMode", CascadeLoadMode.class);

	protected static final MethodInstance template_m_isManyTo =
			new MethodInstance(null, RelationMember.class, boolean.class, "isManyTo");
	...
	public EntityMetaDataRelationMemberVisitor(ClassVisitor cv, Class<?> entityType,
	...
	protected void implementCascadeLoadMode() {
		FieldInstance f_cascadeLoadMode = implementField(
				new FieldInstance(Opcodes.ACC_PRIVATE, "__cascadeLoadMode", null, CascadeLoadMode.class));
	...
	protected void implementIsManyTo() {
		FieldInstance f_isManyTo =
				implementField(new FieldInstance(Opcodes.ACC_PRIVATE, "__isManyTo", null, boolean.class));
