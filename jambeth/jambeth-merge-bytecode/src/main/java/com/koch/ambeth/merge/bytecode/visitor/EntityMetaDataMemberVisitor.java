...
public class EntityMetaDataMemberVisitor extends ClassGenerator {
	protected static final MethodInstance template_m_canRead =
			new MethodInstance(null, Member.class, boolean.class, "canRead");

	protected static final MethodInstance template_m_canWrite =
			new MethodInstance(null, Member.class, boolean.class, "canWrite");

	protected static final MethodInstance template_m_getAnnotation =
			new MethodInstance(null, Member.class, Annotation.class, "getAnnotation", Class.class);

	protected static final MethodInstance template_m_getDeclaringType =
			new MethodInstance(null, Member.class, Class.class, "getDeclaringType");

	protected static final MethodInstance template_m_getNullEquivalentValue =
			new MethodInstance(null, Member.class, Object.class, "getNullEquivalentValue");

	protected static final MethodInstance template_m_getName =
			new MethodInstance(null, Member.class, String.class, "getName");

	protected static final MethodInstance template_m_getEntityType =
			new MethodInstance(null, Member.class, Class.class, "getEntityType");

	protected static final MethodInstance template_m_getElementType =
			new MethodInstance(null, Member.class, Class.class, "getElementType");

	protected static final MethodInstance template_m_getRealType =
			new MethodInstance(null, Member.class, Class.class, "getRealType");

	protected static final MethodInstance template_m_isToMany =
			new MethodInstance(null, Member.class, boolean.class, "isToMany");

	public static final MethodInstance template_m_getValue =
			new MethodInstance(null, Member.class, Object.class, "getValue", Object.class);

	public static final MethodInstance template_m_getValueWithFlag =
			new MethodInstance(null, Member.class, Object.class, "getValue", Object.class, boolean.class);

	protected static final MethodInstance template_m_setValue =
			new MethodInstance(null, Member.class, void.class, "setValue", Object.class, Object.class);
	...
	public EntityMetaDataMemberVisitor(ClassVisitor cv, Class<?> declaringType, Class<?> entityType,
			String memberName, IEntityMetaDataProvider entityMetaDataProvider,
	...
	protected void implementGetAnnotation(IPropertyInfo[] property) {
		...
		FieldInstance f_typeToAnnotationMap =
				implementStaticAssignedField("sf__typeToAnnotationMap", typeToAnnotationMap);
		MethodGenerator mv = visitMethod(template_m_getAnnotation);
	...
	protected void implementGetValue(IPropertyInfo[] propertyPath) {
		for (int a = 0, size = propertyPath.length; a < size; a++) {
			...
			if (property instanceof MethodPropertyInfo
					&& ((MethodPropertyInfo) property).getGetter() == null) {
				throw new IllegalStateException("Property not readable: "
						+ property.getEntityType().getName() + "." + property.getName());
			}
		}
	...
	protected void implementSetValue(IPropertyInfo[] propertyPath) {
		...
		if (lastProperty instanceof MethodPropertyInfo
				&& ((MethodPropertyInfo) lastProperty).getSetter() == null) {
			mv.throwException(Type.getType(UnsupportedOperationException.class), "Property not writable: "
					+ lastProperty.getEntityType().getName() + "." + lastProperty.getName());
			mv.returnValue();
			mv.endMethod();
			return;
		}
	...
	protected Type invokeGetProperty(MethodGenerator mv, IPropertyInfo property,
			Type typeOfArgumentOnStack) {
		if (property instanceof MethodPropertyInfo) {
	...
	protected void implementIsToMany(IPropertyInfo[] propertyPath) {
		...
		mv.push(
				Collection.class.isAssignableFrom(propertyPath[propertyPath.length - 1].getPropertyType()));
		mv.returnValue();
		mv.endMethod();
	}
