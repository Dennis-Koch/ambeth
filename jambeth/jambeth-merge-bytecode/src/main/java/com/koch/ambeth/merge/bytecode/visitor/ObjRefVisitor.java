...
public class ObjRefVisitor extends ClassGenerator {
	...
	private static final PropertyInstance template_p_realType =
			PropertyInstance.findByTemplate(IObjRef.class, "RealType", Class.class, false);

	private static final PropertyInstance template_p_idIndex =
			PropertyInstance.findByTemplate(IObjRef.class, "IdNameIndex", byte.class, false);

	private static final PropertyInstance template_p_id =
			PropertyInstance.findByTemplate(IObjRef.class, "Id", Object.class, false);

	private static final PropertyInstance template_p_version =
			PropertyInstance.findByTemplate(IObjRef.class, "Version", Object.class, false);

	private static final MethodInstance template_m_equals =
			new MethodInstance(null, Object.class, boolean.class, "equals", Object.class);

	private static final MethodInstance template_m_hashCode =
			new MethodInstance(null, Object.class, int.class, "hashCode");

	private static final MethodInstance template_m_toString =
			new MethodInstance(null, Object.class, String.class, "toString");

	private static final MethodInstance template_m_toStringSb =
			new MethodInstance(null, IPrintable.class, void.class, "toString", StringBuilder.class);

	private static final MethodInstance m_objRef_equals = new MethodInstance(null, templateType,
			boolean.class, "objRefEquals", IObjRef.class, Object.class);

	private static final MethodInstance m_objRef_hashCode =
			new MethodInstance(null, templateType, int.class, "objRefHashCode", IObjRef.class);

	private static final MethodInstance m_objRef_toStringSb = new MethodInstance(null, templateType,
			void.class, "objRefToString", IObjRef.class, StringBuilder.class);
	...
	protected void implementIdVersionConstructor(final PropertyInstance p_id,
			final PropertyInstance p_version) {
		...
		MethodGenerator mv =
				visitMethod(new ConstructorInstance(Opcodes.ACC_PUBLIC, null, Object.class, Object.class));
		mv.loadThis();
	...
	protected void implementRealType() {
		implementProperty(template_p_realType, new Script() {
			...
			@Override
			public void execute(MethodGenerator mg) {
				mg.throwException(Type.getType(UnsupportedOperationException.class),
	...
	protected PropertyInstance implementPotentialPrimitive(PropertyInstance property,
			final Member member) {
		if (member == null) {
		...
		final MethodInstance m_convertValueToType =
				new MethodInstance(ReflectUtil.getDeclaredMethod(false, IConversionHelper.class,
						Object.class, "convertValueToType", Class.class, Object.class));

		final Type type = Type.getType(member.getRealType());
		final FieldInstance field = implementField(
				new FieldInstance(Opcodes.ACC_PRIVATE, "f_" + property.getName(), null, type));
		return implementProperty(property, new Script() {
			@Override
			public void execute(MethodGenerator mg) {
	...
	protected PropertyInstance implementId() {
		return implementPotentialPrimitive(template_p_id,
				metaData.getIdMemberByIdIndex((byte) idIndex));
	}
	...
	protected void implementToString() {
		...
		}
		{
			...
			if (method == null || Type.getType(Object.class).equals(method.getOwner())
					|| (method.getAccess() & Opcodes.ACC_ABSTRACT) != 0) {
