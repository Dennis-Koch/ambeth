...
public class EmbeddedRelationMember extends RelationMember implements IEmbeddedMember, IRelationMemberWrite
{
	private final RelationMember childMember;
	...
	@Override
	public RelationMember getChildMember()
	{
		return childMember;
	}
