...
public abstract class AbstractOfflineServiceUrlProvider implements IServiceUrlProvider, IOfflineListenerExtendable, IInitializingBean {
    protected final IExtendableContainer<IOfflineListener> offlineListeners = new DefaultExtendableContainer<>(IOfflineListener.class, "offlineListener");
    ...
    public void lockForRestart(boolean offlineAfterRestart) {
        var listeners = offlineListeners.getExtensionsShared();

        for (var offlineListener : listeners) {
