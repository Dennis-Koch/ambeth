...
public final class ServiceConfigurationConstants {
    ...
    @ConfigurationConstantDescription("TODO")
    public static final String ClientServiceFactoryType = "service.client-service.factory-type";

    @ConfigurationConstantDescription("TODO")
    public static final String ServiceRemoteInterceptorType = "service.client-service.remote-interceptor-type";
