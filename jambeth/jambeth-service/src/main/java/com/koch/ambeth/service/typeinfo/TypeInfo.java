...
public class TypeInfo implements ITypeInfo {
    ...
    protected ITypeInfoItem[] allMembers;

    protected final Class<?> realType;

    protected final Map<String, ITypeInfoItem> nameToMemberDict = new HashMap<>(0.5f);

    protected final Map<String, ITypeInfoItem> nameToXmlMemberDict = new HashMap<>(0.5f);
    ...
    public ITypeInfoItem[] getAllMembers() {
        return allMembers;
    }
    ...
    public void postInit(ITypeInfoItem[] members, ITypeInfoItem[] allMembers) {
        this.members = members;
        this.allMembers = allMembers;

        for (var member : this.allMembers) {
