...
/**
 * Base implementation for all string datatypes derinved from xsd:string. The only purpose of this place holder is to support the isValidLiteral tests across
 * string types.
 */
public class XSDBaseStringType extends XSDDatatype
{
	...
	// Functionality moved to XSDDatatype but old code left here temporarily
	// until
	...
	/**
	 * Compares two instances of values of the given datatype. This ignores lang tags and optionally allows plain literals to equate to strings. The latter
	 * option is currently set by a static global flag in LiteralLabel.
	 */
	@Override
	public boolean isEqual(LiteralLabel value1, LiteralLabel value2)
	{
		// value1 will have been used to dispatch here so we know value1 is an
		// xsdstring or extension
		if ((value2.getDatatype() == null && JenaParameters.enablePlainLiteralSameAsString) || (value2.getDatatype() instanceof XSDBaseStringType))
		{
