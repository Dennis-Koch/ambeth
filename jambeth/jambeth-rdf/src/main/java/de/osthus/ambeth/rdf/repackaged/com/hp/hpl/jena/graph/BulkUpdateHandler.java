 ...
 * <p>
 * Bulk updates are not necessarily transactions; that is, a bulk update may fail part-way through, leaving some but not all triples added or deleted. However,
 * if a bulk update does not fail (ie throw an exception) then the addition or removal of triples must have been successfully completed in accordance with the
 * operation of the owning graph.
 */
public interface BulkUpdateHandler
{
	 ...
	 * 
	 * @param triples
	 *            a list of Triple objects to add
	 * @deprecated See GraphUtil for helper functions for migration.
	 */
	@Deprecated
	...
	/**
	 * Add all the elements from the iterator into the graph this is handler for. Each element of the iterator must be a Triple. WARNING. An implementation may
	 * have to expand the iterator into a data structure containing all the component elements; hence long iterators may be expensive on store.
	 * 
	 * @param it
	 *            an Iterator delivering Triples
	 * @deprecated See GraphUtil for helper functions for migration.
	 */
	@Deprecated
	 ...
	 * 
	 * @param g
	 *            a Graph whose triples are to be added
	 * @param withReifications
	 *            if true, the reified triples of g are added as well
	 * @deprecated See GraphUtil for helper functions for migration.
	 */
	@Deprecated
	...
	/**
	 * Delete all the triples in the iterator from the graph this is handler for. Each element from the iterator must be a Triple. WARNING. An implementation
	 * may have to expand the iterator into a data structure containing all the component elements; hence long iterators may be expensive on store.
	 * 
	 * @param it
	 *            an iterator over Triple
	 * @deprecated See GraphUtil for helper functions for migration.
	 */
	@Deprecated
	 ...
	 * 
	 * @param g
	 *            a graph whose triples are to be deleted
	 * @deprecated See GraphUtil for helper functions for migration.
	 */
	@Deprecated
	void delete(Graph g);
	 ...
	 *            a graph whose triples are to be deleted
	 * @param withReifications
	 *            if true, delete g's reifications from this graph
	 * @deprecated See GraphUtil for helper functions for migration.
	 */
	@Deprecated
