...
public class SomeValuesFromRestrictionImpl extends RestrictionImpl implements SomeValuesFromRestriction
{
	...
	/**
	 * A factory for generating SomeValuesFromRestriction facets from nodes in enhanced graphs. Note: should not be invoked directly by user code: use
	...
	public static Implementation factory = new Implementation()
	{
		...
		{
			// node will support being a SomeValuesFromRestriction facet if it
			// has rdf:type owl:Restriction or equivalent
			// and the combination of owl:onProperty and owl:someValuesFrom (or
			// equivalents)
