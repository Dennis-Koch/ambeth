...
/**
 * Group aggregation functions calculated a value during grouping and placed in the output binding. This class is relationship of an aggregation expression and
 * that variable. Evaluation returns the variable's bound value.
 */
...
public class ExprAggregator extends ExprNode
{
	...
	{
		return new ExprAggregator(v, aggregator.copy(aggregator.getExpr()));
	}
