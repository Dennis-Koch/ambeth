...
/**
 * Location files in the filing system. A FileLocator can have a "current directory" - this is separate from any location mapping (see
 * 
 * @link{LocationMapping ) as it applies only to files.
 */
...
public class LocatorFile implements Locator
{
	...
	{
		return other instanceof LocatorFile && equals(thisDir, ((LocatorFile) other).thisDir);
	}
