 ...
 * 
 * <p>
 * Model includes list and query methods which will return all the statements which are selected by a selector object. This is the interface of such selector
 * objects.
 * 
 */
...
public interface Selector
{
	...
	/**
	 * Answer true iff this Selector is completely characterised by its subject, predicate, and object fields. If so, the <code>test</code> predicate need not
	 * be called to decide if a statement is acceptable. This allows query engines lattitude for optimisation (and our memory-based implementation both exploits
	 * this licence).
	 */
	boolean isSimple();
