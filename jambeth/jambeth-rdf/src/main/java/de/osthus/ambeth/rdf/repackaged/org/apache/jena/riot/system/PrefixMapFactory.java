...
public class PrefixMapFactory
{
	 ...
	 * 
	 * @param pmap
	 *            Mapping from prefix to IRI string
	 * @return Prefix Map
	 */
	 ...
	 * <p>
	 * This differs from using one of the various {@code create} methods since it does not copy the existing prefix map, rather it maintains both a local map
	 * and the existing map. All operations favour the local map but defer to the existing map if the local map cannot fulfil a request.
	 * </p>
	 * 
	 * @param pmap
	...
	/**
	 * Return an immutable view of the prefix map. Throws {@linkplain UnsupportedOperationException} on attempts to update it. Refelcts hcnages mad to the
	 * underlying map.
	 * 
	 * @param pmap
	 *            PrefixMap
