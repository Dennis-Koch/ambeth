...
package de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine;
...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.AlarmClock;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.core.describe.DescribeHandler;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.core.describe.DescribeHandlerRegistry;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.iterator.QueryIteratorWrapper;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.graph.GraphFactory;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.modify.TemplateLib;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.DatasetUtils;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.ModelUtils;
...
public class QueryExecutionBase implements QueryExecution
{
	...
	// /**
	// * Executes as a construct query, placing the results into a newly constructed {@link
	// de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.graph.GraphDistinctDataBag}.
	...
	private void startQueryIterator()
	{
		...
		/*
		 * Timeouts: -1,-1 No timeouts N, same as -1,N Overall timeout only. No wrapper needed. N,-1 Timeout on first row only. Need to cancel on first row. N,M
		 * First/overall timeout. Need to reset on first row.
		 */
