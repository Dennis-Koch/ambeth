...
public class ParserARQ extends SPARQLParser
{
	...
	private static void perform(Query query, String string, Action action)
	{
		...
		catch (de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.lang.arq.ParseException ex)
		{
			throw new QueryParseException(ex.getMessage(), ex.currentToken.beginLine, ex.currentToken.beginColumn);
		}
		catch (de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.lang.arq.TokenMgrError tErr)
		{
