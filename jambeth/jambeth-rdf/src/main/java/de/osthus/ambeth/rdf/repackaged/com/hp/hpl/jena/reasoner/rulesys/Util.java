...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.reasoner.IllegalParameterException;
...
public class Util
{
	 ...
	 * 
	 * @param n1
	 *            the first numeric valued literal node
	 * @param n2
	 ...
	 * 
	 * @param n1
	 *            the first time instant (XSDDateTime) valued literal node
	 * @param n2
	 ...
	 * 
	 */
	// Thanks to Bradley Schatz (Bradley@greystate.com) for the original
	// suggestions
	// for datetime comparison. This code is a rewrite based on those
	// suggestions.
	 ...
	 * 
	 * @param parameter
	 *            the configuration property being set (to help with error messages)
	 * @param value
	 *            the parameter value
	 ...
	 * 
	 * @param config
	 *            the resource whose values are to be updated
	 * @param parameter
	 *            a predicate defining the parameter to be set
	 * @param value
	 *            the new value
	 */
