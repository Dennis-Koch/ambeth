...
/**
 * ElementDataset - an association of an RDF Dataset (graph level version) with a query pattern. Unused in parser.
 */
...
public class ElementDataset extends Element
{
	...
	public void setDataset(DatasetGraph ds)
	{
		dataset = ds;
	}
	...
	public void setPatternElement(Element elt)
	{
		element = elt;
	}
