...
/**
 * 
 * This class provides a number of static methods which interact with java.nio.charset.Charset to analyze and transform the strings identifing character
 * encodings.
 */
abstract public class CharEncoding
{
	...
	/**
	 * Gives the canonical name for this charset. If {@link #isIANA()} returns true, then this is the name registered at IANA. If {@link #isInNIO()} returns
	 * true, and {@link #isIANA()} returns false, then this name will start with "x-". The name is case insensitive, but not case normalized.
	 * 
	...
	/**
	 * Returns true if this charset registered at IANA. Since the registry may change, the results of this method may not be entirely up-to-date, and draws from
	 * the knowledge in the Java java.nio.charset.Charset class. If {@link #isInNIO()} returns false, no information is known, and this method returns false.
	 * 
	...
	/**
	 * Returns true if this charset is supported by java.nio.charset.Charset. Without this support {@link #isIANA()} does not work correctly.
	 * 
	...
	/**
	 * If {@link #isIANA} or {@link #isInNIO} return false, this returns a suggested warning message. If {@link #isIANA} is true, then this returns null.
	 * 
