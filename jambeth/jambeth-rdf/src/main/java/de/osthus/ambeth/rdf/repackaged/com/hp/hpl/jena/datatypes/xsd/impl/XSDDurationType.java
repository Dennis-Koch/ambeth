...
/**
 * The XSD duration type, the only job of this extra layer is to wrap the return value in a more convenient accessor type. We could avoid this proliferation of
 * trivial types by use of reflection but since that causes allergic reactions in some we use brute force.
 * <p>
