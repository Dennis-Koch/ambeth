...
/**
 * Results from a query in a table-like manner for SELECT queries. Each row corresponds to a set of bindings which fulfil the conditions of the query. Access to
 * the results is by variable name.
 * 
 * @see Query
 * @see QueryExecution
 * @see QuerySolution
