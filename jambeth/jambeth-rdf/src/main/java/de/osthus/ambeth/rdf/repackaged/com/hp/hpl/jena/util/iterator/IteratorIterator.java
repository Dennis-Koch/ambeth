 ...
 * 
 * @deprecated use {@linkplain de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.util.iterator.WrappedIterator#create}
 */
@Deprecated
public class IteratorIterator<T> implements Iterator<T>
{
	...
	/**
	 * The first element of this Iterator is the first element of the first non-empty element of <code>e</code>.
	 * 
	 * @param e
	 *            An Iterator all of whose members are themselves Iterator's.
	 */
