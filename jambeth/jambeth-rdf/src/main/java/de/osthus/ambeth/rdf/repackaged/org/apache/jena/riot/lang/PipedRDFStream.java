...
/**
 * Abstract implementation of a producer class that implements {@code StreamRDF}; use one of the concrete implementations that match the RDF primitive you are
 * using.
 * 
 * @param <T>
