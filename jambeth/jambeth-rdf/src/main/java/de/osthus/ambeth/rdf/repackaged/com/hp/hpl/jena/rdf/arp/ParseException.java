...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.rdf.arp.impl.ARPLocation;

import java.lang.reflect.Field;

/**
 * An exception during the RDF processing of ARP. Note: it is distinguished from an XML related exception from Xerces because while both are
 * SAXParseException's, the latter are not de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.arp.ParseException's.
 */
public class ParseException extends SAXParseException implements ARPErrorNumbers
{
	...
	/**
	 * The error number (from {@link ARPErrorNumbers}) related to this exception.
	 * 
	...
	/**
	 * Is this error an RDF syntax error. A syntax error indicates that well-formed XML, uses RDF properties and attributes, and whitespace and XML elements, in
	 * a way that does not conform with the RDF/XML Syntax (Revised) specification. (Currently most such errors have code
	 * {@link ARPErrorNumbers#ERR_SYNTAX_ERROR}, but this may change in the future).
	 * 
	...
	public String getMessage()
	{
		// turn 1 to W001
		// turn 204 to E204
		String idStr = id != 0 ? "{" + (id < 200 ? "W" : "E") + ("" + (1000 + id)).substring(1) + "} " : "";
	...
	/**
	 * The string from {@link ARPErrorNumbers} associated with an integer error code
	 * 
	 * @param errNo
	 *            An error code from {@link ARPErrorNumbers}.
	...
	/**
	 * The integer code associated with a string from {@link ARPErrorNumbers}.
	 * 
	 * @param upper
	 *            A field name from {@link ARPErrorNumbers}, (in upper case).
