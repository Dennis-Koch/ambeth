...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.datatypes.xsd.impl.XMLLiteralType;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.shared.impl.JenaParameters;

/**
 * The TypeMapper provides a global registry of known datatypes. The datatypes can be retrieved by their URI or from the java class that is used to represent
 * them.
 */
...
public class TypeMapper
{
	...
	/**
	 * Return the single global instance of the TypeMapper. Done this way rather than simply making the static field directly accessible to allow us to
	 ...
	 * @return Datatype the datatype definition registered at uri, if there is no such registered type it returns a new instance of the default datatype
	 *         implementation, if the uri is null it returns null (indicating a plain RDF literal).
	 */
	...
	/**
	 * Lookup a known datatype. An unkown datatype or a datatype with uri null will return null will mean that the value will be treated as a old-style plain
	 * literal.
	 * 
	 * @param uri
	 *            the URI of the desired datatype
	 ...
	 * 
	 * @param value
	 *            a value instance to be represented
	 * @return Datatype a datatype whose value space matches the java class of <code>value</code>
	 */
	 ...
	 * 
	 * @param clazz
	 *            a Java class to be represented
