...
package de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.cache;
...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.ActionKeyValue;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Cache;

/**
 * A simple fixed size cache that uses the hash code to address a slot. Clash policy is to overwrite. No object creation during lookup or insert.
 */
