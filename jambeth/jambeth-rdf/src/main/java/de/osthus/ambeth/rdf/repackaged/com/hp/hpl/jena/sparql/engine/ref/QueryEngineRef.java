...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.algebra.Transformer;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.algebra.optimize.TransformPropertyFunction;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.QueryEngineBase;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.QueryEngineFactory;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.QueryEngineRegistry;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.iterator.QueryIteratorCheck;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.main.QC;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.Context;

/**
 * "Reference" query engine - this simply executes the algebra expression as-is using a simple (non-scalable) execution strategy that follows the definition of
 * SPARQL as closely as possible. The reference query engine does provide the algebra extensions.
 */
