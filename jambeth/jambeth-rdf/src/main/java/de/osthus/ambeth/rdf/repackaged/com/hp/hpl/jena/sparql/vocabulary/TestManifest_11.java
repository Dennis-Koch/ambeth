...
public class TestManifest_11
{
	...
	/**
	 * <p>
	 * A type of test specifically for syntax testing of SPARQL Update. Syntax tests are not required to have an associated result, only an action. Negative
	 * syntax tests are tests of which the result should be a parser error.
	 * </p>
	 */
	public static final Resource NegativeUpdateSyntaxTest11 = m_model
			.createResource("http://www.w3.org/2001/sw/DataAccess/tests/test-manifest#NegativeUpdateSyntaxTest11");
	 ...
	 * </p>
	 */
	public static final Resource PositiveUpdateSyntaxTest11 = m_model
			.createResource("http://www.w3.org/2001/sw/DataAccess/tests/test-manifest#PositiveUpdateSyntaxTest11");
