...
public interface LanguageTagCodes
{
	...
	/**
	 * A tag with non-standard extra subtags. Set for language tags with additional subtags over their IANA registration, or a third subtag for unregistered
	 * tags of the form ISO639Code-ISO3166Code.
	 */
