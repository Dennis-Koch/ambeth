...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.pfunction.PFuncSimple;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.FmtUtils;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.IterLib;

/**
 * Assignment: does not change the value of an existing binding. Either the subject or object must be a constant or be a bound variable. If both are bound, it
 * degenerates to a test of RDF term equality.
 */
