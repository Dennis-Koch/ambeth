...
/**
 * A Pool of objects. Base implements a non-blocking pool (returns null on no entry) with infinite upper bound. Set effective size by creating the right number
 * of entries when created.
 */
