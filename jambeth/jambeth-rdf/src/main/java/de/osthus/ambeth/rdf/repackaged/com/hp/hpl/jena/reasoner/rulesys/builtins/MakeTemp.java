...
public class MakeTemp extends BaseBuiltin
{
	...
	public boolean bodyCall(Node[] args, int length, RuleContext context)
	{
		...
		{
			if (!context.getEnv().bind(args[i], NodeFactory.createAnon()))
				return false;
		}
		return true;
	}
	...
	/**
	 * This method is invoked when the builtin is called in a rule head. Such a use is only valid in a forward rule. Exected args are the instance to be
	 * annotated, the property to use and the type of the resulting bNode.
	 * 
	 * @param args
