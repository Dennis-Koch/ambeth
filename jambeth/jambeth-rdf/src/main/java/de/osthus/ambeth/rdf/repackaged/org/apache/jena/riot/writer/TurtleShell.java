...
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.writer.WriterConst.GAP_P_O;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.writer.WriterConst.GAP_S_P;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.writer.WriterConst.INDENT_OBJECT;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.writer.WriterConst.INDENT_PREDICATE;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.writer.WriterConst.LONG_PREDICATE;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.writer.WriterConst.LONG_SUBJECT;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.writer.WriterConst.MIN_PREDICATE;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.writer.WriterConst.OBJECT_LISTS;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.writer.WriterConst.RDF_First;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.writer.WriterConst.RDF_Nil;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.writer.WriterConst.RDF_Rest;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.writer.WriterConst.RDF_type;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.writer.WriterConst.rdfNS;
...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.other.GLib;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.out.NodeFormatter;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.out.NodeFormatterTTL;
...
public abstract class TurtleShell
{
	...
	private final class ShellGraph
	{
		...
		/**
		 * Find Bnodes that can written as [] Subject position (top level) - only used for subject position anywhere in the dataset Object position (any level)
		...
		// --- Lists setup
		/*
		 * Find all list heads and all nodes in well-formed lists. Return a (list head -> Elements map), list elements)
		 */
