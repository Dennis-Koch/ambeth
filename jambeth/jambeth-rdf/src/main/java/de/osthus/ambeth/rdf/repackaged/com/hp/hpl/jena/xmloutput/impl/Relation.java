...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.util.iterator.Map1Iterator;
...
class Relation<T>
{
	 ...
	 * 
	 * When this is called any other <code>a</code> related to this <code>b</code> is removed. When this is called any other <code>b</code> related to this
	...
	/**
	 * Uniquely <code>a</code> is now related to <code>b</code>. Many <code>b</code>'s can be related to each <code>a</code>. When this is called any other
	 * <code>a</code> related to this <code>b</code> is removed.
	 */
	...
	/**
	 * <code>a</code> is now related to uniquely <code>b</code>. Many <code>a</code>'s can be related to each <code>b</code>. When this is called any other
	 * <code>b</code> related to this <code>a</code> is removed.
	 */
	...
	/**
	 * Takes this to its transitive closure. See B. Roy. <b>Transitivit� et connexit�.</b> <i>C.R. Acad. Sci.</i> Paris <b>249</b>, 1959 pp 216-218. or S.
	 * Warshall, <b>A theorem on Boolean matrices</b>, <i>Journal of the ACM</i>, <b>9</b>(1), 1962, pp11-12
	 */
	...
	/**
	 * An Iterator over the pairs of the Relation. Each pair is returned as a java.util.Map.Entry. The first element is accessed through <code>getKey()</code>,
	...
	{
		Map1<Map.Entry<T, Set<T>>, Iterator<PairEntry<T, T>>> m1 = new Map1<Map.Entry<T, Set<T>>, Iterator<PairEntry<T, T>>>()
		{
			@Override
		...
		Map1Iterator<Map.Entry<T, Set<T>>, Iterator<PairEntry<T, T>>> iter1 = new Map1Iterator<>(m1, rows.entrySet().iterator());
		// And now flatten it.
...
// Hard(er) to read.
// return new IteratorIterator<PairEntry<T, T>>(new Map1Iterator<Map.Entry<T,
// Set<T>>, Iterator<PairEntry<T, T>>>(new Map1<Map.Entry<T, Set<T>>,
// Iterator<PairEntry<T, T>>>() {
