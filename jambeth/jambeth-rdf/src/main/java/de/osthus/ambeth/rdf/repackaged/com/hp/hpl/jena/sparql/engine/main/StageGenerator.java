...
/**
 * Interface for execution of a basic graph pattern. A StageGenerator is registred in the context of an query execution to be found and called by the
 * StageBuilder.
 * 
 * The StageGenerator is called repeated for a basic graph pattern with each possible bindings unsed to instantiate variables where possible.
 * 
