...
public class OntPropertyImpl extends OntResourceImpl implements OntProperty
{
	...
	/**
	 * A factory for generating OntProperty facets from nodes in enhanced graphs. Note: should not be invoked directly by user code: use
	...
	public static Implementation factory = new Implementation()
	{
		...
		{
			// node will support being an OntProperty facet if it has rdf:type
			// owl:Property or equivalent
	 ...
	 * 
	 * @param direct
	 *            If true, only answer the direcly adjacent properties in the property hierarchy: i&#046;e&#046; eliminate any property for which there is a
	 ...
	 *            A property to test.
	 * @param direct
	 *            If true, only consider the direcly adjacent properties in the property hierarchy
	...
	/**
	 * <p>
	 * Assert that the given property is the inverse of this property. Any existing statements for <code>inverseOf</code> will be removed.
	 * </p>
	 * 
	 * @param prop
	...
	/**
	 * <p>
	 * Answer the property that is the inverse of this property. If no such property is defined, return null. If more than one inverse is defined, return an
	 * abritrary selection.
	 * </p>
	 * 
	 ...
	 * href="../../../../../../how-to/rdf-frames.html"> RDF frames howto</a>.
	 * </p>
	 * 
	...
	public ExtendedIterator<OntClass> listDeclaringClasses(boolean direct)
	{
		...
		if (cands.isEmpty())
		{
			...
			if (!direct)
			{
				...
				return ((OntModel) getModel()).listClasses().filterDrop(new Filter<OntClass>()
				{
					@Override
		...
		else
		{
			...
			// pick out classes from the domain for which this is a declared
			// prop
	...
	{
		return getModel().listStatements(null, getProfile().ON_PROPERTY(), this).mapWith(new SubjectAsMapper<>(Restriction.class));
	}
	...
	/**
	 * <p>
	 * Answer a property that is attached to the given model, which will either be this property or a new property object with the same URI in the given model.
	 * If the given model is an ontology model, make the new property object an ontproperty.
	 * </p>
	 * 
	 * @param m
	 *            A model
	...
	/**
	 * <p>
	 * Filter that accepts classes which have the given property as one of their declared properties.
	 * </p>
	 */
