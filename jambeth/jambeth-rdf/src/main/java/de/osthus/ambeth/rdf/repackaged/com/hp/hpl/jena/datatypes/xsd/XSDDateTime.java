...
/**
 * Represent an XSD date/time value. Rather than have a separate type for each legal date/time value combination this is a combination type than does runtime
...
public class XSDDateTime extends AbstractDateTime
{
	...
	/**
	 * Set the mask for this date/time to be that appropriate for the given XSD subtype. If the type is a subtype of XSDdateTime the mask will be narrowed
	 * appropriately, other types will be silently ignored.
	 */
	...
	private static int[] convertCalendar(Calendar date)
	{
		...
		// By observation (Sun Java 6), this is necesary (to force internal
	...
	/**
	 * Return the date time as a java Calendar object. If the timezone has been specified then the object is normalized to GMT. If the zone has not been
	 * specified then we use the default timezone.
	 * 
