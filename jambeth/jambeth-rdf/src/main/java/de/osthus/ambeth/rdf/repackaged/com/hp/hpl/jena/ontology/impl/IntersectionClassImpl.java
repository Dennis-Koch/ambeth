...
public class IntersectionClassImpl extends BooleanClassDescriptionImpl implements IntersectionClass
{
	...
	/**
	 * A factory for generating IntersectionClass facets from nodes in enhanced graphs. Note: should not be invoked directly by user code: use
	...
	public static Implementation factory = new Implementation()
	{
		...
		{
			// node will support being an IntersectionClass facet if it has
			// rdf:type owl:Class and an owl:intersectionOf statement (or
			// equivalents)
