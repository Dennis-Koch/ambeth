...
{
	// ---- MIN(DISTINCT expr)
	public AggMinDistinct(Expr expr)
	{
		super(expr);
	}
	...
	{
		return new AggMinDistinct(expr);
	}

	@Override
	public String toString()
	{
		return "min(distinct " + ExprUtils.fmtSPARQL(getExpr()) + ")";
	}

	@Override
	public String toPrefixString()
	{
		return "(min distinct " + WriterExpr.asString(getExpr()) + ")";
	}

	@Override
	public int hashCode()
	{
		return HC_AggMinDistinct ^ expr.hashCode();
	}
