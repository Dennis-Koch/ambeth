...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.algebra.op.OpPropFunc;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.graph.GNode;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.graph.GraphList;
...
public class PropertyFunctionGenerator
{
	...
	private static void findPropertyFunctions(Context context, BasicPattern pattern, PropertyFunctionRegistry registry, List<Triple> propertyFunctionTriples)
	{
	...
	private static void findPropertyFunctionArgs(Context context, BasicPattern triples, List<Triple> propertyFunctionTriples,
