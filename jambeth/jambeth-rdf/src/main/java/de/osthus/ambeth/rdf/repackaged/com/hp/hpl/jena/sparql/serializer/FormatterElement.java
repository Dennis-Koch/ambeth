...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.path.PathWriter;
...
public class FormatterElement extends FormatterBase implements ElementVisitor
{
	...
	public void visit(ElementSubQuery el)
	{
		...
		Serializer.serializeARQ(q, out, new FormatterElement(out, context), new FmtExprSPARQL(out, context), null);
		out.decIndent(INDENT);
		out.print("}");
	}
