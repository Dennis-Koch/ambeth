...
/**
 * <p>
 * This data bag will gather items in memory until a size threshold is passed, at which point it will write out all of the items to disk using the supplied
 * serializer.
 * </p>
 * <p>
 * After adding is finished, call {@link #iterator()} to set up the data bag for reading back items and iterating over them. The iterator will retrieve the
 * items in sorted order using the supplied comparator.
 * </p>
 * <p>
 * IMPORTANT: You may not add any more items after this call. You may subsequently call {@link #iterator()} multiple times which will give you a new iterator
 * for each invocation. If you do not consume the entire iterator, you should call {@link Iter#close(Iterator)} to close any FileInputStreams associated with
 * the iterator.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * Implementation Notes: Data is stored in an ArrayList as it comes in. When it is time to spill, that data is sorted and written to disk. An iterator will read
 * in each file and perform a merge-sort as the results are returned.
 * </p>
 */
public class SortedDataBag<E> extends AbstractDataBag<E>
{
	...
	/**
	 * Returns an iterator over a set of elements of type E. If you do not exhaust the iterator, you should call
	 * {@link de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.iterator.Iter#close(Iterator)} to be sure any open file handles are closed.
	 * 
	 * @return an Iterator
	 */
	@Override
