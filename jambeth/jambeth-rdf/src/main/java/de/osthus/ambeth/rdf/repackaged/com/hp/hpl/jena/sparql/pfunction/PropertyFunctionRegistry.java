...
package de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.pfunction;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.MappedLoader;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.vocabulary.ListPFunction;
...
public class PropertyFunctionRegistry
{
	 ...
	 * 
	 * @param uri
	 *            String URI for the PropertyFunction
	 * @param factory
	...
	{
		put(ListPFunction.member.getURI(), de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.pfunction.library.listMember.class);
		put(ListPFunction.index.getURI(), de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.pfunction.library.listIndex.class);
		put(ListPFunction.length.getURI(), de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.pfunction.library.listLength.class);

		// (Very) old forms
		put(ListPFunction.listMember.getURI(), de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.pfunction.library.listMember.class);
		put(ListPFunction.listIndex.getURI(), de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.pfunction.library.listIndex.class);
		put(ListPFunction.listLength.getURI(), de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.pfunction.library.listLength.class);

		put(RDFS.member.getURI(), de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.pfunction.library.container.class);
	}
}
