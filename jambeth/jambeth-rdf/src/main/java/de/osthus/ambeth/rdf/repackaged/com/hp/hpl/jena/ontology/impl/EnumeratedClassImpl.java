...
public class EnumeratedClassImpl extends OntClassImpl implements EnumeratedClass
{
	...
	/**
	 * A factory for generating EnumeratedClass facets from nodes in enhanced graphs. Note: should not be invoked directly by user code: use
	...
	public static Implementation factory = new Implementation()
	{
		...
		{
			// node will support being an EnumeratedClass facet if it has
			// rdf:type owl:Class and an owl:oneOf statement (or equivalents)
	...
	/**
	 * <p>
	 * Assert that this class is exactly the enumeration of the given individuals. Any existing statements for <code>oneOf</code> will be removed.
	 * </p>
	 * 
	 * @param en
	 *            A list of individuals that defines the class extension for this class
	 * @exception ProfileException
	 *                If the {@link Profile#ONE_OF()} property is not supported in the current language profile.
	 */
	@Override
	...
	/**
	 * <p>
	 * Remove the statement that this enumeration includes <code>res</code> among its members. If this statement is not true of the current model, nothing
	 * happens.
	 * </p>
	 * 
	 * @param res
