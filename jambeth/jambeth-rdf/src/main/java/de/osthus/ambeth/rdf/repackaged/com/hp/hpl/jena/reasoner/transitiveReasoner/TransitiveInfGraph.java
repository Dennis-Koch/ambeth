...
/**
 * Implementation of InfGraph used by the TransitiveReasoner. This is returned by the TransitiveReasoner when a data graph (together with an optional schema)
 * has been bound.
 * 
 * <p>
 * The cached property and class graphs are calculated by the reasoner when the schema is bound. If the data graph does not include schema information then the
 * caches generated at schema binding stage are reused here. Otherwise the caches are regenerated.
 * </p>
 */
public class TransitiveInfGraph extends BaseInfGraph
{
	 ...
	 * 
	 * @param reasoner
	 *            the parent instance of the transitive reasoner, including any precomputed class and property caches
	 * @param data
	...
	public synchronized void prepare()
	{
		...
		transitiveEngine = new TransitiveEngine(((TransitiveReasoner) reasoner).getSubClassCache().deepCopy(), ((TransitiveReasoner) reasoner)
				.getSubPropertyCache().deepCopy());
		// The deepCopies reduce the value of precomputing the closure in the
		// reasoner object
	...
	public Capabilities getCapabilities()
	{
		if (capabilities == null)
			capabilities = new InfFindSafeCapabilities();
		return capabilities;
	}
