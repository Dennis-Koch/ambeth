...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.BulkUpdateHandler;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.impl.WrappedBulkUpdateHandler;
...
/**
 * <p>
 * A base class for composition graphs that are composed from zero or more sub-graphs (thus providing a basis for polyadic composition operators). A
 * distinguished graph is the designated graph for additions to the union. By default, this is the first sub-graph of the composition, however any of the graphs
 * in the composition can be nominated to be the distinguished graph.
 * </p>
 */
public abstract class Polyadic extends CompositionBase
{
	 ...
	 * </p>
	 * 
	 * @see de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.Graph#close()
	 */
	@Override
	public void close()
	{
	 ...
	 * @see de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.Graph#dependsOn(Graph)
	 */
	@Override
	...
	/**
	 * <p>
	 * Remove the given graph from this composition. If the removed graph is the designated updateable graph, the updatable graph goes back to the default for
	 * this composition.
	 * </p>
	 * 
	 * @param graph
	...
	/**
	 * <p>
	 * Answer the distinguished graph for the composition, which will be the graph that receives triple adds and deletes. If no base graph is defined, return
	 * null.
	 * </p>
	 * 
	 * @return The distinguished updateable graph, or null if there are no graphs in this composition
	 */
	 ...
	 * 
	 * @param graph
	 *            One of the graphs currently in this composition to be the designated graph to receive udpates
	...
	// the following methods all delegate handling capabilities to the base
	// graph
	// TODO: this needs to be integrated with WrappedGraph, but we don't have
	// time to do so before Jena 2.0 release
