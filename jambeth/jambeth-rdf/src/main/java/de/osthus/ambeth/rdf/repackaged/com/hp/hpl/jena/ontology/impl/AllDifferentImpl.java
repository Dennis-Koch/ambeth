...
public class AllDifferentImpl extends OntResourceImpl implements AllDifferent
{
	...
	/**
	 * A factory for generating AllDifferent facets from nodes in enhanced graphs. Note: should not be invoked directly by user code: use
	...
	public static Implementation factory = new Implementation()
	{
		...
		{
			// node will support being an AllDifferent facet if it has rdf:type
			// owl:AllDifferent or equivalent
	 ...
	 * 
	 * @param n
	 *            The node that represents the axiom
	 * @param g
	 *            The enhanced graph that contains n
	 */
