...
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.RDFLanguages.*;
...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.lang.JsonLDReader;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.lang.LangRIOT;
...
public class RDFParserRegistry
{
	...
	/**
	 * Register a language and it's parser factory. To create a {@link Lang} object use {@link LangBuilder}.
	 */
