...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.resultset.CSVOutput;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.resultset.JSONOutput;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.resultset.RDFOutput;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.resultset.ResultsFormat;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.resultset.TSVOutput;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.resultset.TextOutput;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.resultset.XMLOutput;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.resultset.XMLOutputASK;
...
public class ResultSetFormatter
{
	 ...
	 * 
	 * @param format
	 *            Name of RDF format (names as Jena writers)
	 * @param resultSet
	...
	/**
	 * Write out an RDF model that encodes the result set. See also the same method taking an output stream.
	 * 
	 * @param out
	 *            Output : ideally, should be a UTF-8 print writer (not system default)
	 * @param format
	 *            Name of RDF format (names as Jena writers)
	 * @param resultSet
	 *            The result set to encode in RDF
	...
	/**
	 * Write out an RDF model that encodes a boolean result. See also the same method taking an output stream.
	 * 
	 * @param out
	 *            Output : ideally, should be a UTF-8 print writer (not system default)
	 * @param format
	...
	/**
	 * Output a result set in the JSON format Format: <a href="http://www.w3.org/TR/rdf-sparql-json-res/">Serializing SPARQL Query Results in JSON</a> JSON: <a
	 * href="http://json.org">http://json.org/</a>
	 * 
	 * @param resultSet
	 *            result set
	 */
	...
	/**
	 * Output a boolean result in the SSE format Format: <a href="http://jena.apache.org/documentation/notes/sse.html">SSE</a>
	 * 
	 * @param booleanResult
	 *            The boolean result to encode
	 */
	...
	/**
	 * Output a result set in the SSE format Format: <a href="http://jena.apache.org/documentation/notes/sse.html">SSE</a>
	 * 
	 * @param resultSet
	 *            result set
	 */
