...
public class RestrictionImpl extends OntClassImpl implements Restriction
{
	...
	/**
	 * A factory for generating Restriction facets from nodes in enhanced graphs. Note: should not be invoked directly by user code: use
	...
	public static Implementation factory = new Implementation()
	{
		...
		{
			// node will support being an Restriction facet if it has rdf:type
			// owl:Restriction or equivalent
	...
	/**
	 * <p>
	 * Assert that the property that this restriction applies to is the given property. Any existing statements for <code>onProperty</code> will be removed.
	 * </p>
	 * 
	 * @param prop
	 *            The property that this restriction applies to
	 * @exception ProfileException
	 *                If the {@link Profile#ON_PROPERTY()} property is not supported in the current language profile.
	 */
	@Override
	...
	/**
	 * <p>
	 * Answer the property that this property restriction applies to. If there is more than one such resource, an arbitrary selection is made (though
	 * well-defined property restrictions should not have more than one <code>onProperty</code> statement.
	 * </p>
	 * 
	 ...
	 *                if the class cannot be converted to an all values from restriction given the lanuage profile and the current state of the underlying
	 *                model.
	 */
	@Override
	 ...
	 * @exception ProfileException
	 *                if {@link Profile#ALL_VALUES_FROM()} is not supported in the current profile
	 */
	@Override
	 ...
	 * @exception ProfileException
	 *                if {@link Profile#SOME_VALUES_FROM()} is not supported in the current profile
	 */
	@Override
	 ...
	 * @exception ProfileException
	 *                if {@link Profile#HAS_VALUE()} is not supported in the current profile
	 */
	@Override
	...
	/**
	 * <p>
	 * Answer true if this restriction is a cardinality restriction (ie is a property restriction constructed with an <code>owl:cardinality</code> operator, or
	 * similar). This is not a test for a restriction that tests cardinalities in general.
	 * </p>
	 * 
	 * @return True if this is a cardinality property restriction
	 * @exception ProfileException
	 *                if {@link Profile#CARDINALITY()} is not supported in the current profile
	 */
	@Override
	...
	/**
	 * <p>
	 * Answer true if this restriction is a min cardinality restriction (ie is a property restriction constructed with an <code>owl:minCardinality</code>
	 * operator, or similar). This is not a test for a restriction that tests cardinalities in general.
	 * </p>
	 * 
	 * @return True if this is a minCardinality property restriction
	 * @exception ProfileException
	 *                if {@link Profile#MIN_CARDINALITY()} is not supported in the current profile
	 */
	@Override
	...
	/**
	 * <p>
	 * Answer true if this restriction is a max cardinality restriction (ie is a property restriction constructed with an <code>owl:maxCardinality</code>
	 * operator, or similar). This is not a test for a restriction that tests cardinalities in general.
	 * </p>
	 * 
	 * @return True if this is a maxCardinality property restriction
	 * @exception ProfileException
	 *                if {@link Profile#MAX_CARDINALITY()} is not supported in the current profile
	 */
	@Override
	 ...
	 * 
	 * @param cls
	 *            The class to which all values of the restricted property must belong, to be in the extension of this restriction
	 ...
	 * 
	 * @param cls
	 *            The class to which at least one value of the restricted property must belong, to be in the extension of this restriction
	 ...
	 * 
	 * @param value
	 *            The value which the restricted property must have, for resource to be in the extension of this restriction
