...
public class OntologyImpl extends OntResourceImpl implements Ontology
{
	...
	public static Implementation factory = new Implementation()
	{
		...
		{
			// node will support being an Ontology facet if it has rdf:type
			// owl:Ontology or equivalent
	...
	/**
	 * <p>
	 * Assert that this ontology imports only the given ontology. Any existing statements for <code>sameAs</code> will be removed.
	 * </p>
	 * 
	 * @param res
	 *            Represents a resource that this ontology imports.
	 * @exception ProfileException
	 *                If the {@link Profile#IMPORTS()} property is not supported in the current language profile.
	 */
	@Override
	...
	/**
	 * <p>
	 * Answer an iterator over all of the resources representing ontologies imported by this ontology. Each elemeent of the iterator will be an
	 * {@link OntResource}.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Remove the statement that this ontology imports the ontology represented by the given resource. If this statement is not true of the current model,
	 * nothing happens.
	 * </p>
	 * 
	 * @param res
	...
	/**
	 * <p>
	 * Assert that this ontology is backward compatible with the given ontology. Any existing statements for <code>sameAs</code> will be removed.
	 * </p>
	 * 
	 * @param res
	 *            Represents a resource that this ontology is compatible with.
	 * @exception ProfileException
	 *                If the {@link Profile#BACKWARD_COMPATIBLE_WITH} property is not supported in the current language profile.
	 */
	@Override
	...
	/**
	 * <p>
	 * Answer a resource that represents an ontology that is backwards compatible with this ontology. If there is more than one such resource, an arbitrary
	 * selection is made.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Answer an iterator over all of the resources representing ontologies that this ontology is backwards compatible with. Each element of the iterator will
	 * be an {@link OntResource}.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Remove the statement that this ontology is backwards compatible with the ontology represented by the given resource. If this statement is not true of the
	...
	/**
	 * <p>
	 * Assert that this ontology is a new version of the given ontology. Any existing statements for <code>priorVersion</code> will be removed.
	 * </p>
	 * 
	 * @param res
	 *            Represents a resource that this ontology supercedes.
	 * @exception ProfileException
	 *                If the {@link Profile#PRIOR_VERSION} property is not supported in the current language profile.
	 */
	@Override
	...
	/**
	 * <p>
	 * Answer a resource that represents an ontology that is superceded by this ontology. If there is more than one such resource, an arbitrary selection is
	 * made.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Assert that this ontology is incompatible with the given ontology. Any existing statements for <code>incompatibleWith</code> will be removed.
	 * </p>
	 * 
	 * @param res
	 *            Represents a resource that this ontology is incompatible with.
	 * @exception ProfileException
	 *                If the {@link Profile#INCOMPATIBLE_WITH} property is not supported in the current language profile.
	 */
	@Override
	...
	/**
	 * <p>
	 * Answer a resource that represents an ontology that is is incompatible with this ontology. If there is more than one such resource, an arbitrary selection
	 * is made.
	 * </p>
	 * 
