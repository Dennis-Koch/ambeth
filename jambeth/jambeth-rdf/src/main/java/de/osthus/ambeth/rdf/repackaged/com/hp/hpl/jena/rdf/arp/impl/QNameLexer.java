...
abstract public class QNameLexer implements Names, ARPErrorNumbers
{
	...
	{
		return (fl & select) == fl && wanted.equals(getLocalName()) && getUri().equals(xmlns) ? fl : 0;
	}
	...
	{
		if ((fl & select) == fl && wanted.equals(getLocalName()))
		{
	...
	{
		return knownRDFProperties.contains(name) || isMemberProperty(name);
	}
