...
public class Item extends ItemLocation
{
	...
	{
		return createList(noLine, noColumn);
	}
	...
	{
		return createNode(node, noLine, noColumn);
	}
	...
	{
		return createSymbol(symbol, noLine, noColumn);
	}
	...
	{
		return createNil(noLine, noColumn);
	}
