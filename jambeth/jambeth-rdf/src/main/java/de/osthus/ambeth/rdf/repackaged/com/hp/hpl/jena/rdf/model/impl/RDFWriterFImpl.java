...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.n3.N3JenaWriter;
...
public class RDFWriterFImpl extends Object implements RDFWriterF
{
	...
	protected static final String LANGS[] = { "RDF/XML", "RDF/XML-ABBREV", "N-TRIPLE", "N-TRIPLES", "N-Triples", "N3", N3JenaWriter.n3WriterPrettyPrinter,
			N3JenaWriter.n3WriterPlain, N3JenaWriter.n3WriterTriples, N3JenaWriter.n3WriterTriplesAlt, N3JenaWriter.turtleWriter,
			N3JenaWriter.turtleWriterAlt1, N3JenaWriter.turtleWriterAlt2 };
	// default readers for each language

	protected static final String DEFAULTWRITERS[] = { Jena.PATH + ".xmloutput.impl.Basic", Jena.PATH + ".xmloutput.impl.Abbreviated",
			Jena.PATH + ".rdf.model.impl.NTripleWriter", Jena.PATH + ".rdf.model.impl.NTripleWriter", Jena.PATH + ".rdf.model.impl.NTripleWriter",
			Jena.PATH + ".n3.N3JenaWriter", Jena.PATH + ".n3.N3JenaWriterPP",

			Jena.PATH + ".n3.N3TurtleJenaWriter", // Write Turtle to ensure safe
													// round tripping.
			Jena.PATH + ".n3.N3TurtleJenaWriter", // Ditto.

			// Jena.PATH + ".n3.N3JenaWriterPlain", // Keep as N3 for now - a
			// test fails.
			// Jena.PATH + ".n3.N3JenaWriterTriples",

			Jena.PATH + ".n3.N3JenaWriterTriples", // Same writer, different
													// writer name
			Jena.PATH + ".n3.N3TurtleJenaWriter", // Alternative names for
													// Turtle
			Jena.PATH + ".n3.N3TurtleJenaWriter", Jena.PATH + ".n3.N3TurtleJenaWriter", };
