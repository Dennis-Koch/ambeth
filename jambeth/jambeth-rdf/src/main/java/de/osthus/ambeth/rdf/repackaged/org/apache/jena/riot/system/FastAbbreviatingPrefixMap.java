...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Trie;
 ...
 * <p>
 * This is an alternative implementation of the {@link PrefixMap} interface, it is broadly similar to the default {@link PrefixMapStd} implementation but is
 * faster in output heavy workloads. If you are calling the {@link PrefixMap#expand(String)} or {@link PrefixMap#expand(String, String)} methods a lot then you
 * should be using this implementation.
 * </p>
 * <p>
 * To improve on output performance this implementation maintains a {@link Trie} mapping namespace IRIs to their prefixes as well as a normal mapping. Therefore
 * IRI abbreviation can be done as an approximately O(1) operation in the worst case . If you contrast this with the abbreviation performance of the default
 * {@code PrefixMap} which is worst case O(n) then this is a substantial saving in scenarios where you primarily use a prefix map for output.
 * </p>
 * <p>
 * Generally speaking all other operations should be roughly equivalent to the default {@code PrefixMap} though the memory overhead of this implementation will
 * be marginally higher due to the extra information maintained in the {@code Trie}.
 * </p>
 */
public class FastAbbreviatingPrefixMap extends PrefixMapBase
{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.system.LightweightPrefixMap#abbreviate(java.lang .String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.system.LightweightPrefixMap#abbrev(java.lang.String)
	 */
	@Override
