...
/**
 * Base class for implementations of a DatasetGraph as a set of graphs. This can be a fixed collection or a changeable collection depending on the
 * implementation of getDefaultGraph()/getGraph(Node)
 */
