...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.QueryExecutionBase;
...
public class QueryExecutionFactory
{
	 ...
	 *            List of URIs to make up the default graph
	...
	/**
	 * Create a service request for remote execution over HTTP. The returned class, {@link QueryEngineHTTP}, allows various HTTP specific parameters to be set.
	 * 
	 * @param service
	 *            Endpoint URL
	 * @param query
