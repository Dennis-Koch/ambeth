...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.modify.request.UpdateVisitor;
...
/**
 * Example implementation of an update engine that does not stream data, instead it will build it up into an in-memory UpdateRequest, and then traverse it after
 * all update operations have finished.
 */
public class UpdateEngineNonStreaming extends UpdateEngineMain
{
	 ...
	 * 
	 * @param graphStore
	 *            Graph Store the updates operate over
	 * @param inputBinding
	...
	/**
	 * Returns an {@link UpdateSink} that adds all update operations into an internal {@link UpdateRequest} object. After the last update operation has been
	 * added, the {@link #execute()} method is called.
	 */
	@Override
