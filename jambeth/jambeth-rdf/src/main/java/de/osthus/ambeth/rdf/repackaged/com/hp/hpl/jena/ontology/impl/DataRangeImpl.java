...
public class DataRangeImpl extends OntResourceImpl implements DataRange
{
	...
	/**
	 * A factory for generating DataRange facets from nodes in enhanced graphs. Note: should not be invoked directly by user code: use
	...
	public static Implementation factory = new Implementation()
	{
		...
		{
			// node will support being an DataRange facet if it has rdf:type
			// owl:Datarange and is a bNode
