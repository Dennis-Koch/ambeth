...
public class LabelToNodeMap
{
	...
	/**
	 * Create variables (Var), starting from zero each time This means that parsing a query string will generate the same variable names for bNode variables
	 * each time, making Query.equals and Query.hashCode work.
	 * 
	 * @return LabelToNodeMap
	 */
