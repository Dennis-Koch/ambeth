...
/**
 * Datatype template that adapts any response back from Xerces type parsing to an appropriate java representation. This is primarily used in creating user
 * defined types - the built in types have a fixed mapping.
 * <p>
 * This class is probably now redundant in that XSDDatatype can support run time conversion of union results. Left in for now during restructuring and in case
 * any existing user code expects this type - very unlikely.
 * </p>
 */
public class XSDGenericType extends XSDDatatype
{
	...
	// No longer need to perform any special case processing of union types
	// since we
	...
	// throw new DatatypeFormatException(lexicalForm, this, "during parse -" +
	// e);
	// }
	// }
