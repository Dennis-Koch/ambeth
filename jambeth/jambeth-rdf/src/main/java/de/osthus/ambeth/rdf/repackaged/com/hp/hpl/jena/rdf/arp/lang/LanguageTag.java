...
public class LanguageTag implements LanguageTagCodes
{
	...
	// Overall properties
	/**
	 * The properties of this LanguageTag, expressed as a bitwise or of fields from {@link LanguageTagCodes}. If the tag is illegal only <CODE>LT_ILLEGAL</CODE>
	 * is reported. Examples include:
	 * <dl>
	...
	public String errorMessage()
	{
		switch (tags[0].length())
		{
			...
			case 3:
				...
				if (lang == null)
				{
					return "ISO-639 does not define language: '" + tags[0] + "'.";
				}
				if (lang.twoCharCode != null)
				{
					return "RFC 3066 section 2.3 mandates the use of '" + lang.twoCharCode + "' instead of '" + tags[0] + "'.";
					// Section 2.3 Para 2
				}
				if (!lang.terminologyCode.equals(tags[0]))
				{
					return "RFC 3066 section 2.3 mandates the use of '" + lang.terminologyCode + "' instead of '" + tags[0] + "'.";
					// Section 2.3 Para 3
				}
				// Section 2.3 para 4,5,6 in a separate function.
				break;
