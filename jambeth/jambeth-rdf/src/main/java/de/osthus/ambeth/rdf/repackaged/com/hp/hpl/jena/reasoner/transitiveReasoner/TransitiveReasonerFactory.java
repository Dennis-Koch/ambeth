...
public class TransitiveReasonerFactory implements ReasonerFactory
{
	 ...
	 * 
	 * @param configuration
	 *            a set of arbitrary configuration information to be passed the reasoner encoded within an RDF graph. This reasoner has no configuration
	 *            parameters so this arg is always ignored.
	 */
	@Override
	...
	public Model getCapabilities()
	{
		if (capabilities == null)
		{
			...
			base.addProperty(ReasonerVocabulary.nameP, "Transitive Reasoner")
					...
					.addProperty(ReasonerVocabulary.supportsP, ReasonerVocabulary.directSubPropertyOf).addProperty(ReasonerVocabulary.versionP, "0.1");
		}
		return capabilities;
	}
