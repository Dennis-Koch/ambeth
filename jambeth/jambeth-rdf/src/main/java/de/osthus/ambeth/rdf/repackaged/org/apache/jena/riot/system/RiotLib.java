...
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.RDFLanguages.sameLang;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.writer.WriterConst.PREFIX_IRI;
...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.WriterDatasetRIOT;
...
public class RiotLib
{
	...
	{
		LabelToNode labelToNode = true ? SyntaxLabels.createLabelToNode() : LabelToNode.createUseLabelEncoded();
