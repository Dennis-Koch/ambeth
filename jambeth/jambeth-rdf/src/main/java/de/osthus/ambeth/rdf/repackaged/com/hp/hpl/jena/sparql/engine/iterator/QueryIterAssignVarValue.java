...
/**
 * Extend each solution by a (var, node) When used with mustBeNewVar=false, this is a join. If the input already has the variable assigned, then it must be the
 * same (.equals) node and if it is not, the input row is rejected.
 * 
 * @see QueryIterAssign
 */
