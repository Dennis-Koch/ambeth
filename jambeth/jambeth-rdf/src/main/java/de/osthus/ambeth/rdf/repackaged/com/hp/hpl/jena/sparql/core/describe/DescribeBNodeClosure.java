...
package de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.core.describe;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.Closure;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.Context;

/**
 * DescribeHandler that calculates the bNode closure. Takes all the statements of this resource, and for every object that is a bNode, it recursively includes
 * its statements.
 */
