...
package de.osthus.ambeth.rdf.repackaged.arq.cmdline;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.core.DataFormat;
...
public class ModDatasetGeneral extends ModDataset
{
	...
	public void registerWith(CmdGeneral cl)
	{
		...
		cl.add(dataDecl, "--data=FILE", "Data for the datset - triple or quad formats");
		cl.add(graphDecl, "--graph=FILE", "Graph for default graph of the datset");
		cl.add(namedGraphDecl, "--namedGraph=FILE", "Add a graph into the dataset as a named graph");
	}
	...
	public Dataset createDataset()
	{
		...
		if ((dataURLs == null || dataURLs.size() == 0) && (graphURLs == null || graphURLs.size() == 0)
