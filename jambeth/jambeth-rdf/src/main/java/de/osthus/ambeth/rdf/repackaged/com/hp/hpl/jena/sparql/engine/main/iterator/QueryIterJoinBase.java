...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.algebra.JoinType;
...
/**
 * Join or LeftJoin by calculating both sides, then doing the join It usually better to use substitute algorithm (not this QueryIterator in other words) as that
 * is effectively indexing from one side into the other.
 */
