...
package de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.function;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.datatypes.xsd.impl.XSDBaseNumericType;
...
public class CastXSD implements FunctionFactory
{
	...
	protected static class Instance extends FunctionBase1
	{
		...
		/*
		 * In RDF (2004 at least), whitespace is not legal in lexcial forms of, for example, integers. http://www.w3.org/TR/rdf-concepts/#section-Datatypes
		...
		protected NodeValue cast(String s, NodeValue nv, XSDDatatype castType2)
		{
			...
			else
			{
				...
				if (castType instanceof XSDBaseNumericType || castType.equals(XSDDatatype.XSDfloat) || castType.equals(XSDDatatype.XSDdouble)
						|| castType.equals(XSDDatatype.XSDboolean) || castType instanceof XSDAbstractDateTimeType) // Includes durations, and Gregorian
				{
