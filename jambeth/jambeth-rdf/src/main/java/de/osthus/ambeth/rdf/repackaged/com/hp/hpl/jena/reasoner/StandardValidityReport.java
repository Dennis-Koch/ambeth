...
public class StandardValidityReport implements ValidityReport
{
	...
	/**
	 * Returns true if no logical inconsistencies were detected (in which case there will be at least one error Report included). Warnings may still be present.
	 * As of Jena 2.2 we regard classes which can't be instantiated as warnings rather than errors.
	 */
	@Override
