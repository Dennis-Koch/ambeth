...
/**
 * This interface collects together those operations that the backchaining engine needs to invoke in the parent InfGraph. This allows different inf graphs to
 * exploit the same core backchaining engine.
 */
public interface BackwardRuleInfGraphI extends SilentAddI, InfGraph
{
	 ...
	 * 
	 * @param clause
	 *            the term representing the call
	 * @param env
