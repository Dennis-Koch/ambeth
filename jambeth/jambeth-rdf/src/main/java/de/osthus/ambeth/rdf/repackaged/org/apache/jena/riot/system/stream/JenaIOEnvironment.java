...
package de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.system.stream;

import java.util.StringTokenizer;

import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.web.TypedInputStream;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.adapters.AdapterFileManager;
...
/**
 * Code for using the general facilities of the location mapper/ filemanager subsystem and set up for Jena usage. e.g. find a location mapper with RDf
 * description.
 */
public class JenaIOEnvironment
{
	...
	public static final String DEFAULT_PATH = "location-mapping.ttl;location-mapping.rdf;location-mapping.n3;"
	...
	/**
	 * Search a path (which is delimited by ";" because ":" is used in URIs) to find a description of a LocationMapper, then create and return a LocationMapper
