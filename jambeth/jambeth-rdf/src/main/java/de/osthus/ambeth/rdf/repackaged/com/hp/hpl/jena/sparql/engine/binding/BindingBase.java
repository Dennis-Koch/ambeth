...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.iterator.IteratorConcat;
...
/**
 * Machinary encapsulating a mapping from a name to a value. The "parent" is a shared, immutable, common set of bindings. An association of var/node must not
 * override a setting in the parent.
 * 
 * @see BindingFactory
