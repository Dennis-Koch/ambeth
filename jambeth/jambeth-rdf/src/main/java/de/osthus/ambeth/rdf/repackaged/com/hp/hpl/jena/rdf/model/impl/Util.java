...
public class Util extends Object
{
	 ...
	 * of the string is returned. The algorithm tries to find the longest NCName at the end of the uri, not immediately preceeded by the first colon in the
	 * string.
	 * 
	 * @param uri
	...
	public static String substituteStandardEntities(String s)
	{
		...
		{
			return substituteEntitiesInElementContent(s).replaceAll("'", "&apos;").replaceAll("\t", "&#9;").replaceAll("\n", "&#xA;").replaceAll("\r", "&#xD;")
					.replaceAll("\"", "&quot;");
		}
		else
			return s;
	 ...
	 * 
	 * <p>
	 * Implementation note: as a (possibly misguided) performance hack, the obvious cascade of replaceAll calls is replaced by an explicit loop that looks for
