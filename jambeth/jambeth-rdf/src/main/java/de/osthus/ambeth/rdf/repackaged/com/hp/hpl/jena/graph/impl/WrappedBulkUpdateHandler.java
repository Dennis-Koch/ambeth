...
/**
 * WrappedBulkUpdateHandler - a base class for wrapped bulk update handlers (needed so WrappedGraph works properly with events). Each operation is passed on to
 * the base handler, and then this graph's event manager is notified.
 */
