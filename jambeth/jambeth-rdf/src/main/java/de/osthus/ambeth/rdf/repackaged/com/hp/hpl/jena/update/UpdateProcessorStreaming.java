...
{
	/**
	 * The properties associated with a query execution - implementation specific parameters This includes Java objects (so it is not an RDF graph). Keys should
	 * be URIs as strings. May be null (this implementation does not provide any configuration).
	 */
