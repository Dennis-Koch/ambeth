...
/**
 * Root class for XSD datatypes with binary values, xsd:hexBinary and xsd:base64Binary. The binary value is stored as a byte[] in the LiteralLabel.
 */
...
public abstract class XSDbinary extends XSDDatatype
{
	...
	{
		return value1.getDatatype() == value2.getDatatype() && Arrays.equals((byte[]) value1.getValue(), (byte[]) value2.getValue());
		// && value1.getLexicalForm().equals(value2.getLexicalForm()); // bug
		// tracking, not real code
	}
	...
	public int getHashCode(LiteralLabel lit)
	{
		...
		// Java arrays are not equal by value and their hash code of the
		// sameValue array are different.
		if (lit.isWellFormed())
