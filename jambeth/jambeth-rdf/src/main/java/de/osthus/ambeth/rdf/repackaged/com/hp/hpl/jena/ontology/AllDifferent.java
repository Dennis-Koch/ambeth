...
/**
 * <p>
 * Interface defining an individual in which all members of a collection are declared pair-wise disjoint. This allows ontologies that wish to support the unique
 * names assumption to add this condition in languages (like OWL) that do not make the same assumption, with a minimum number of statements. Instances of the
 * all different axiom are expected to have a property (e.g. <code>owl:distinctMembers</code> defining the list of distinct individuals in the ontology. For a
 * given vocabulary, this will be defined by the {@linkplain Profile#DISTINCT_MEMBERS distinctMembers} entry.
 * </p>
 */
public interface AllDifferent extends OntResource
{
	...
	/**
	 * <p>
	 * Assert that the list of distinct individuals in this AllDifferent declaration is the given list. Any existing statements for <code>distinctMembers</code>
	 * will be removed.
	 * </p>
	 * 
	 * @param members
	 *            A list of the members that are declared to be distinct.
	 * @exception ProfileException
	 *                If the {@link Profile#DISTINCT_MEMBERS()} property is not supported in the current language profile.
	 */
	 ...
	 * 
	 * @param res
	 *            A resource that will be added to the list of all different members.
	 * @exception ProfileException
	 *                If the {@link Profile#DISTINCT_MEMBERS()} property is not supported in the current language profile.
	 */
	 ...
	 * 
	 * @param individuals
	 *            An iterator over the distinct invididuals that will be added
	 * @exception ProfileException
	 *                If the {@link Profile#DISTINCT_MEMBERS()} property is not supported in the current language profile.
	 */
	...
	/**
	 * <p>
	 * Answer true if this AllDifferent declaration includes <code>res</code> as one of the distinct individuals.
	 * </p>
	 * 
	 * @param res
