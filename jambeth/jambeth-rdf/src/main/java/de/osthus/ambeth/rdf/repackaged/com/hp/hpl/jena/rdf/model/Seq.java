 ...
 * 
 * <p>
 * This interface defines methods for accessing RDF Sequence resources. These methods operate on the RDF statements contained in a model. The Sequence
 * implementation may cache state from the underlying model, so objects should not be added to or removed from the Sequence by directly manipulating its
 * properties, whilst the Sequence is being accessed through this interface.
 * </p>
 * 
 * <p>
 * When a member is deleted from a sequence using this interface, or an iterator returned through this interface, all the other members with higher ordinals are
 * renumbered to one below what they previously were.
 * </p>
 * 
 * <p>
...
public interface Seq extends Container
{
	 ...
	 *            The member to be added.
	 * @param l
	 *            the language of the value added .
	 * @return this object to enable cascading of method calls.
	 */
	 ...
	 * @param o
	 *            The member sought. .
	 * @return an index of the member in this sequence or 0 if the member is not found in this sequence.
	 */
	 ...
	 *            The member sought.
	 * @param l
	 *            the language of the member sought .
	 * @return an index of the member in this sequence or 0 if the member is not found in this sequence.
	 */
	 ...
	 * 
	 * @param index
	 *            The index whose member is to be set.
	 * @param o
	 *            The value to be set.
