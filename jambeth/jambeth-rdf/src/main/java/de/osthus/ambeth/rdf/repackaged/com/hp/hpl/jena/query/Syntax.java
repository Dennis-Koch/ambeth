...
public class Syntax extends Symbol
{
	...
	/**
	 * The name of the default query language for query parsing. The default query language syntax must be capable of accepting any SPARQL query but may also
	 * accept extensions.
	 */
	public static Syntax defaultQuerySyntax = syntaxSPARQL_11;

	/**
	 * The name of the default update language for update parsing. The default update language syntax must be capable of accepting any SPARQL query but may also
	 * accept extensions.
	 */
