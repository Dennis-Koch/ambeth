...
/**
 * Interface for lightweight prefix maps, this is similar to {@link PrefixMapping} from Jena Core but it omits any reverse lookup functionality.
 * <p>
 * The contract also does not require an implementation to do any validation unlike the Jena Core {@link PrefixMapping} which require validation of prefixes.
 * </p>
 * <h3>Implementations</h3>
 * <p>
 * For input dominated workloads where you are primarily calling {@link #expand(String)} or {@link #expand(String, String)} it is best to use the default
 * implementation - {@link PrefixMapStd}. For output dominated workloads where you are primarily calling {@link #abbrev(String)} or {@link #abbreviate(String)}
...
public interface PrefixMap
{
	...
	/**
	 * Return a fresh copy of the underlying mapping, should be safe to modify unlike the mapping returned from {@link #getMapping()}
	 * 
