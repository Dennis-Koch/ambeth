...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.rdf.arp.impl.RDFXMLParser;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.shared.UnknownPropertyException;
...
public class JenaReader implements RDFReader, ARPErrorNumbers
{
	...
	/**
	 * Supported properties: error-mode (String) default, lax, strict, strict-ignore, strict-warning, strict-error, strict.error <br/>
	...
	static Object processArpOptions(ARPOptions options, String str, Object v, RDFErrorHandler eh)
	{
		...
		if (str.equals("ERROR-MODE"))
		{
			...
			eh.error(new IllegalArgumentException("Property \"ERROR-MODE\" takes the following values: "
