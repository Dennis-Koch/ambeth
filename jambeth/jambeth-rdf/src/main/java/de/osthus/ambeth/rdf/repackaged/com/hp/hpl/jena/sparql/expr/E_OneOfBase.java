...
{
	/*
	 * This operation stores it's arguments as a single list. The first element of the array is the expression being tested, the rest are the items to be used
	 * to test against. There are cached copies of the LHS (car) and RHS (cdr).
	 */
