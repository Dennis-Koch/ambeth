...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.vocabulary.LocationMappingVocab;
...
/**
 * Alternative locations for URIs. Maintains two maps: single item alternatives and alternative prefixes. To suggest an alternative location, first check the
 * single items, then check the prefixes.
 * 
 * A LocationMapper can be configured by an RDF file. The default for this is "etc/location-mapping.n3".
 * 
...
public class LocationMapper
{
	...
	public static final String DEFAULT_PATH = "file:location-mapping.rdf;file:location-mapping.n3;file:location-mapping.ttl;"
			+ "file:etc/location-mapping.rdf;file:etc/location-mapping.n3;" + "file:etc/location-mapping.ttl";
	 ...
	 * 
	 * @see de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.vocabulary.LocationMappingVocab
	 */
	...
	/**
	 * Apply mappings: first try for an exact alternative location, then try to remap by prefix, finally, try the special case of filenames in a specific base
	 * directory.
	 * 
	 * @param uri
	 * @param otherwise
