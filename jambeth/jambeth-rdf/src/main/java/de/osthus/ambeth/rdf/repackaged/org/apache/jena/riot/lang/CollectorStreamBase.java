...
/**
 * Base class for StreamRDF implementations which store received <T> objects in a {@link java.util.Collection}.
 * 
 * The resulting collection can be retrieved via the {@link #getCollected()} method.
 * 
 * Implementations are suitable for single-threaded parsing, for use with small data or distributed computing frameworks (e.g. Hadoop) where the overhead of
 * creating many threads is significant.
 * 
 * @param <T>
