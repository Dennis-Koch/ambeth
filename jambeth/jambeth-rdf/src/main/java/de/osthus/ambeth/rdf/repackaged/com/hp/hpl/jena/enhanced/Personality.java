...
/**
 * Defines a set of permitted mappings from [interface] Class objects to {@link Implementation} factories that can generate instances of the facet represented
 * by the Class.
 */
public class Personality<T>
{
	 ...
	 * 
	 * @param interf
	 *            The interface to add, expressed as a Type object.
	 * @param impl
