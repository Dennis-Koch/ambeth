...
public interface Dataset // extends Transactional
{
	...
	/**
	 * Does this dataset support transactions? Supporting transactions mean that the dataset implementation provides {@link #begin}, {@link #commit},
	 * {@link #abort}, {@link #end} which otherwise may throw {@link UnsupportedOperationException}
	 */
