...
public class FOAF
{
	...
	/**
	 * <p>
	 * A personal mailbox, ie. an Internet mailbox associated with exactly one owner, the first owner of this mailbox. This is a 'static inverse functional
	 * property', in that there is (across time and change) at most one individual that ever has any particular value for foaf:mbox.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * An image that can be used to represent some thing (ie. those depictions which are particularly representative of something, eg. one's photo on a
	 * homepage).
	 * </p>
	 */
