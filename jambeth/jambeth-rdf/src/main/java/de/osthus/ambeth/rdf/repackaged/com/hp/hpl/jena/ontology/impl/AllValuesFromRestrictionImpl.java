...
public class AllValuesFromRestrictionImpl extends RestrictionImpl implements AllValuesFromRestriction
{
	...
	/**
	 * A factory for generating AllValuesFromRestriction facets from nodes in enhanced graphs. Note: should not be invoked directly by user code: use
	...
	public static Implementation factory = new Implementation()
	{
		...
		{
			// node will support being a AllValuesFromRestriction facet if it
			// has rdf:type owl:Restriction or equivalent
			// and the combination of owl:onProperty and owl:allValuesFrom (or
			// equivalents)
	...
	/**
	 * <p>
	 * Assert that this restriction restricts the property to have all values be members of the given class. Any existing statements for
	 * <code>allValuesFrom</code> will be removed.
	 * </p>
	 * 
	 * @param cls
	...
	/**
	 * <p>
	 * Answer the resource characterising the constraint on all values of the restricted property. This may be a class, the URI of a concrete datatype, a
	 * DataRange object or the URI rdfs:Literal.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Remove the statement that this restriction has all values from the given class among the values for the restricted property. If this statement is not
