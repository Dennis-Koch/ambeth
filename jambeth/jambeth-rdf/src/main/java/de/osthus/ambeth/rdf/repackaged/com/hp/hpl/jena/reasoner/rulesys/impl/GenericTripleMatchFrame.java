...
/**
 * Frame on the choice point stack used to represent the state of some form of triple match - this is either a direct graph query or a query to a cached set of
 * results.
 * <p>
...
public class GenericTripleMatchFrame extends GenericChoiceFrame
{
	...
	{
		if (objectVar != null)
			interpreter.bind(objectVar, triple.getObject());
