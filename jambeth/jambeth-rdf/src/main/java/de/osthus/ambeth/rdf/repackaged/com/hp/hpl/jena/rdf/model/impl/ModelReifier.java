...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.FrontsTriple;
...
public class ModelReifier
{
	...
	/**
	 * DEVEL. setting this _true_ means that nodes that reify statements will drag their reification quads into other nodes when they are added to them inside
	 * statements.
	 */
	 ...
	 * 
	 * @param s
	 *            the statement for which a reification is sought
	 ...
	 * 
	 * @param s
	 *            the statement whose reifications are sought.
	...
	/**
	 * If _n_ is a ReifiedStatement, create a local copy of it, which will force the underlying reifier to take note of the mapping.
	 */
	...
	/**
	 * A mapper that maps modes to their corresponding ReifiedStatement objects. This cannot be static: getRS cannot be static, because the mapping is
	 * model-specific.
	 */
