...
public class AdapterLocationMapper extends de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.util.LocationMapper
{
	...
	{
		return mapper.altMapping(uri, otherwise);
	}

	@Override
	public void addAltEntry(String uri, String alt)
	{
		mapper.addAltEntry(uri, alt);
	}

	@Override
	public void addAltPrefix(String uriPrefix, String altPrefix)
	{
		mapper.addAltPrefix(uriPrefix, altPrefix);
	}
