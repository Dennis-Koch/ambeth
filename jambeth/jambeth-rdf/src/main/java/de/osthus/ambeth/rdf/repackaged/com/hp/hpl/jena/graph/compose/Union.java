...
public class Union extends Dyadic implements Graph
{
	...
	/**
	 * To find in the union, find in the components, concatenate the results, and omit duplicates. That last is a performance penalty, but I see no way to
	 * remove it unless we know the graphs do not overlap.
	 */
	@Override
	protected ExtendedIterator<Triple> _graphBaseFind(final TripleMatch t)
	{
