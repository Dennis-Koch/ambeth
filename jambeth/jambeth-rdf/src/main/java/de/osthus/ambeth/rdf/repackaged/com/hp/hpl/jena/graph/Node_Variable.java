...
/**
 * "variable" nodes; these are outside the RDF2003 specification, but are used internally for "placeholder" nodes where blank nodes would be wrong, most
 * specifically in Query.
 */

public class Node_Variable extends Node_Fluid
{
	/**
	 * Initialise this Node_Variable with a name object (which should be a VariableName object).
	 */
	...
	/**
	 * Initialise this Node_Variable from a string <code>name</code>, which becomes wrapped in a VariableName.
	 */
