...
public class HashedBunchMap extends HashCommon<Object> implements BunchMap
{
	...
	/**
	 * Clear this map: all entries are removed. The keys <i>and value</i> array elements are set to null (so the values may be garbage-collected).
	 */
	@Override
	public void clear()
	{
	...
	/**
	 * Called by HashCommon when a key is removed: remove associated element of the <code>values</code> array.
	 */
	@Override
	...
	/**
	 * Called by HashCommon when a key is moved: move the associated element of the <code>values</code> array.
	 */
	@Override
