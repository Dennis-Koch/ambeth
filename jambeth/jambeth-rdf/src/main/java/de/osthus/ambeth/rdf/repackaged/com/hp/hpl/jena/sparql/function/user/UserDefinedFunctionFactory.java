...
package de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.function.user;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.expr.ExprTransformer;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.function.Function;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.function.FunctionFactory;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.function.FunctionRegistry;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.lang.sparql_11.ParseException;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.lang.sparql_11.SPARQLParser11;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.sse.builders.ExprBuildException;

/**
 * A function factory for managing user defined functions aka function macros.
 * <p>
 * User defined functions provide a simple mechanism for a user to inject custom functions into SPARQL processing without the need to write any code. These
 * functions essentially act as macros/aliases for another SPARQL expression and serve as a means to aid users in simplifying their SPARQL queries.
 * </p>
 * <p>
 ...
 * </pre>
 * <p>
 * Internally the call to the <strong>square</strong> function is translated into its equivalent SPARQL expression and executed in that form.
 * </p>
 * <p>
 ...
 * expand the function definitions to give the resulting expression associated with a function. Please see {@link #getPreserveDependencies()} for more
 * information on this.
 * </p>
 */
public class UserDefinedFunctionFactory implements FunctionFactory
{
	 ...
	 * <p>
	 * When this is disabled (as it is by default) function definitions are fully expanded at registration time. So if you add a function that references an
	 * existing user defined function it will be expanded to include the resulting expression rather than left with a reference to another function. This
	 * protects the user from depending on other functions whose definitions are later removed or changed.
	 * </p>
	 * <p>
	 * However it may sometimes be desirable to have dependencies preserved in which case this option may be disabled with the corresponding
