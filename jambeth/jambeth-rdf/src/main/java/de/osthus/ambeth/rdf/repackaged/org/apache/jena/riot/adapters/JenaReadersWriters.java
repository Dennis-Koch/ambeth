...
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.RDFLanguages.JSONLD;
...
public class JenaReadersWriters
{
	...
	public static class RDFReaderRIOT_JSONLD extends RDFReaderRIOT
	{
		public RDFReaderRIOT_JSONLD()
		{
	...
	public static class RDFWriterRIOT_Turtle extends RDFWriterRIOT
	{
		...
		{
			super(N3JenaWriter.turtleWriter);
		}
	}
	...
	public static class RDFWriterRIOT_Turtle2 extends RDFWriterRIOT
	{
		...
		{
			super(N3JenaWriter.turtleWriterAlt2);
		}
	}

	public static class RDFWriterRIOT_JSONLD extends RDFWriterRIOT
	{
		public RDFWriterRIOT_JSONLD()
		{
			super("JSON-LD");
		}
	}

	public static class RDFWriterRIOT_JSONLDAlt extends RDFWriterRIOT
	{
		public RDFWriterRIOT_JSONLDAlt()
		{
			super("JSONLD");
		}
	}
