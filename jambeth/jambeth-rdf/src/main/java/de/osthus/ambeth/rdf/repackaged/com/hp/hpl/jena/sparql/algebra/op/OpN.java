...
public abstract class OpN extends OpBase
{
	...
	/**
	 * Accumulate an op in the OpN. This exists to help building OpN in teh first place. Once built, an OpN, like any Op should be treated as immutable with no
	 * calls change the sub ops contents. No calls to .add.
	 */
