...
public class OWLTest
{
	...
	/**
	 * <p>
	 * These tests use two documents. One is named importsNNN.rdf, the other is named mainNNN.rdf. These tests indicate the interaction between owl:imports and
	 * the sublanguage levels of the main document.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * This is a negative test. The input document contains some use of the OWL namespace which is not a feature of OWL. These typically show DAML+OIL features
	 * that are not being carried forward into OWL.
	 * </p>
	 */
