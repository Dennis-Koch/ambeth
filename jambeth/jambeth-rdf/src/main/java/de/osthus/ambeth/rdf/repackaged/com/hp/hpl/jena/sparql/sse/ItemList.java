...
public class ItemList extends ItemLocation implements Iterable<Item>
{
	...
	public int hashCode()
	{
		return elements.hashCode() ^ offset;
	}
	...
	{
		elements.addAll(itemList.elements);
	}
	...
	{
		elements.add(Item.createNode(node));
	}

	public void add(String symbol)
	{
		elements.add(Item.createSymbol(symbol));
	}

	public Item get(int idx)
	{
		return elements.get(index(idx));
	}
	...
	{
		return elements.listIterator(offset);
	}
