...
public interface QuerySolution
{
	...
	/**
	 * Return the value of the named variable in this binding, casting to a Resource. A return of null indicates that the variable is not present in this
	 * solution. An exception indicates it was present but not a resource.
	 * 
	 * @param varName
	 * @return Resource
	 */
	...
	/**
	 * Return the value of the named variable in this binding, casting to a Literal. A return of null indicates that the variable is not present in this
	 * solution. An exception indicates it was present but not a literal.
	 * 
	 * @param varName
	 * @return Resource
	 */
