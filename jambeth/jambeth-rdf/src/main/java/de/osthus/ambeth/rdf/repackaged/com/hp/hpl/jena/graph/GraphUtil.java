...
public class GraphUtil
{
	 ...
	 *            Graph
	 * @param p
	 *            Predicate - may be Node.ANY
	 * @param o
	 *            Object - may be Node.ANY
	...
	/**
	 * A safe and cautious remve() function. To avoid any possible ConcurrentModificationExceptions, it finds batches of triples, deletes them and tries again
