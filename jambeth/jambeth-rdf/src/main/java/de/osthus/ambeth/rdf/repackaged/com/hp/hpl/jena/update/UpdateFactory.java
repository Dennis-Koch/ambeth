...
import static de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.Syntax.defaultUpdateSyntax;
import static de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.Syntax.syntaxARQ;
import static de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.Syntax.syntaxSPARQL_11;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.modify.UpdateRequestSink;
...
public class UpdateFactory
{
	...
	/**
	 * Create an UpdateRequest by parsing from a string. See also <tt>read</tt> operations for parsing contents of a file.
	 * 
	 * @param string
	...
	/**
	 * Create an UpdateRequest by parsing from an InputStream. See also <tt>read</tt> operations for parsing contents of a file.
	 * 
	 * @param input
	 ...
	 * 
	 * @param usingList
	 *            The list of externally defined USING statements
	 * @param input
	 *            The source of the update request (must be UTF-8).
	 */
