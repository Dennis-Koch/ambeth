...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.TranslationTable;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.util.FileUtils;

public class DataFormat extends Symbol
{
	public static final DataFormat langNTriples = new DataFormat(FileUtils.langNTriple);

	public static final DataFormat langXML = new DataFormat(FileUtils.langXML);

	public static final DataFormat langXMLAbbrev = new DataFormat(FileUtils.langXMLAbbrev);

	public static final DataFormat langTurtle = new DataFormat(FileUtils.langTurtle);

	public static final DataFormat langN3 = new DataFormat(FileUtils.langN3);
	...
	protected DataFormat(String s)
	{
		super(s);
	}

	protected DataFormat(DataFormat s)
	{
		super(s);
	}
