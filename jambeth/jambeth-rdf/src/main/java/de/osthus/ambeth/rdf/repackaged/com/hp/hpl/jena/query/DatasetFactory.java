...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.core.DatasetImpl;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.core.assembler.DatasetAssembler;
...
public class DatasetFactory
{
	...
	/**
	 * Create a dataset based on two list of URIs. The first lists is used to create the background (unnamed graph) by merging, the second is used to create the
	...
	/**
	 * Create a dataset container based on two list of URIs. The first is used to create the background (unnamed graph), the second is used to create the
	 * collection of named graphs.
	 * 
	 * (Jena calls graphs "Models" and triples "Statements")
	 * 
	...
	/**
	 * Create a named graph container based on two list of URIs. The first is used to create the background (unnamed graph), the second is used to create the
	 * collection of named graphs.
	 * 
	 * (Jena calls graphs "Models" and triples "Statements")
	 * 
