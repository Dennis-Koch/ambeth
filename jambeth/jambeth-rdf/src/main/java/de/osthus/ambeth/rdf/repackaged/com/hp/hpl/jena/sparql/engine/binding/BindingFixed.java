...
/**
 * A binding that is fixed - used in calculating DISTINCT result sets. .hashCode and .equals are overridden for content equality semantics (where "equality"
 * means Node.equals, not Node.sameValueAs).
 */
