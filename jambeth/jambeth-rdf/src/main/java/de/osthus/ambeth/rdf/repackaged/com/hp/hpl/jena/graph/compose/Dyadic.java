...
public abstract class Dyadic extends CompositionBase
{
	...
	/**
	 * When the graph is constructed, copy the prefix mappings of both components into this prefix mapping. The prefix mapping doesn't change afterwards with
	...
	/**
	 * override graphBaseFind to return an iterator that will report when a deletion occurs.
	 */
	@Override
	...
	/**
	 * The method that the overridden graphBaseFind( TripleMatch m ) calls to actually do the work of finding.
	 */
