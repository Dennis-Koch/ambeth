...
public class NTripleWriter extends Object implements RDFWriter
{
	 ...
	 * 
	 * <p>
	 * This writer currently recognises no properties. Invoking this method always causes an <CODE>UnknownPropertyException</CODE> to be raised.
	 * </p>
	 * ?
	 * 
	 * @param propName
	...
	protected static void writeLiteral(Literal l, PrintWriter writer)
	{
		...
		/*
		 * if (l.getWellFormed()) writer.print("xml");
		 */
		writer.print('"');
