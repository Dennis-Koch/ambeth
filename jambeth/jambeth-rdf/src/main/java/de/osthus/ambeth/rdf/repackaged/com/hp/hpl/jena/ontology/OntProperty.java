...
/**
 * <p>
 * Interface encapsulating a property in an ontology. This is an extension to the standard {@link Property} interface, adding a collection of convenience
 * methods for accessing the additional semantic features of properties in OWL and RDFS such as domain, range, inverse, etc. Not all such capabilities exist in
 * all supported ontology languages.
 * </p>
 */
public interface OntProperty extends OntResource, Property
{
	...
	/**
	 * <p>
	 * Assert that this property is sub-property of the given property. Any existing statements for <code>subPropertyOf</code> will be removed.
	 * </p>
	 * 
	 * @param prop
	 *            The property that this property is a sub-property of
	 * @exception ProfileException
	 *                If the {@link Profile#SUB_PROPERTY_OF()} property is not supported in the current language profile.
	 */
	 ...
	 * 
	 * @param direct
	 *            If true, only answer the directly adjacent properties in the property hierarchy: i&#046;e&#046; eliminate any property for which there is a
	 *            longer route to reach that child under the super-property relation.
	 * @return An iterator over the super-properties of this property.
	 * @exception ProfileException
	 *                If the {@link Profile#SUB_PROPERTY_OF()} property is not supported in the current language profile.
	 */
	 ...
	 *            A property to test.
	 * @param direct
	 *            If true, only consider the directly adjacent properties in the property hierarchy
	...
	/**
	 * <p>
	 * Assert that this property is super-property of the given property. Any existing statements for <code>subPropertyOf</code> on <code>prop</code> will be
	 * removed.
	 * </p>
	 * 
	 * @param prop
	 ...
	 * @param direct
	 *            If true, only answer the directly adjacent properties in the property hierarchy: i&#046;e&#046; eliminate any property for which there is a
	 *            longer route to reach that child under the sub-property relation.
	 * @return An iterator over the sub-properties of this property.
	 * @exception ProfileException
	 *                If the {@link Profile#SUB_PROPERTY_OF()} property is not supported in the current language profile.
	 */
	...
	/**
	 * <p>
	 * Assert that the given resource represents the class of individuals that form the domain of this property. Any existing <code>domain</code> statements for
	 * this property are removed.
	 * </p>
	 * 
	 * @param res
	 *            The resource that represents the domain class for this property.
	 * @exception ProfileException
	 *                If the {@link Profile#DOMAIN()} property is not supported in the current language profile.
	 */
	...
	/**
	 * <p>
	 * Answer an iterator over all of the declared domain classes of this property. Each element of the iterator will be an {@link OntResource}.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Assert that the given resource represents the class of individuals that form the range of this property. Any existing <code>range</code> statements for
	 * this property are first removed. Therefore, if the property is known not to have a range declaration, it is more efficient to use {@link #addRange} since
	 * no removal step is necessary. See {@link #addRange} for additional usage notes on the value of <code>res</code>.
	 * </p>
	 * 
	 * @param res
	 *            The resource that represents the range class for this property.
	 * @exception ProfileException
	 *                If the {@link Profile#RANGE()} property is not supported in the current language profile.
	 */
	public void setRange(Resource res);

	/**
	 * <p>
	 * Add a resource representing the range of this property. The resource denotes the class or datatype that objects of statements using this property as
	 * predicate should belong to. For datatype properties, XML Schema Datatype names are pre-declared as resources in the
	 * {@link de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.vocabulary.XSD XSD} vocabulary class. For object properties, the resource should be represent the
	 * range class. Note that {@link OntClass} is a Java sub-class of {@link Resource}, so OntClass objects can be passed directly.
	 * </p>
	 * 
	 * @param res
	...
	/**
	 * <p>
	 * Answer an iterator over all of the declared range classes of this property. Each element of the iterator will be an {@link OntResource}.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Assert that the given property is equivalent to this property. Any existing statements for <code>equivalentProperty</code> will be removed.
	 * </p>
	 * 
	 * @param prop
	 *            The property that this property is a equivalent to.
	 * @exception ProfileException
	 *                If the {@link Profile#EQUIVALENT_PROPERTY()} property is not supported in the current language profile.
	 */
	...
	/**
	 * <p>
	 * Assert that this property is the inverse of the given property. Any existing statements for <code>inverseOf</code> will be removed.
	 * </p>
	 * 
	 * @param prop
	 *            The property that this property is a inverse to.
	 * @exception ProfileException
	 *                If the {@link Profile#INVERSE_OF()} property is not supported in the current language profile.
	 */
	...
	/**
	 * <p>
	 * Answer a property of which this property is the inverse, if known, or null if there is no such property. If there is more than one such property, an
	 * arbitrary selection is made.
	 * </p>
	 * <p>
	 * Note that this method is slightly different to {@link #getInverse}. See the Javadoc on {@link #getInverse} for a detailed explanation.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Answer an iterator over all of the properties that this property is declared to be the inverse of. Each element of the iterator will be an
	 * {@link OntProperty}.
	 * </p>
	 * 
	 ...
	 *                if the resource cannot be converted to a functional property given the language profile and the current state of the underlying model.
	 */
	 ...
	 * @exception ConversionException
	 *                if the resource cannot be converted to a datatype property given the language profile and the current state of the underlying model.
	 */
	@Override
	 ...
	 * @exception ConversionException
	 *                if the resource cannot be converted to an object property given the language profile and the current state of the underlying model.
	 */
	@Override
	 ...
	 * @exception ConversionException
	 *                if the resource cannot be converted to a transitive property given the language profile and the current state of the underlying model.
	 */
	 ...
	 * @exception ConversionException
	 *                if the resource cannot be converted to an inverse functional property given the language profile and the current state of the underlying
	 *                model.
	 */
	 ...
	 * @exception ConversionException
	 *                if the resource cannot be converted to a symmetric property given the language profile and the current state of the underlying model.
	 */
	...
	/**
	 * <p>
	 * Answer the property that has declared itself to be the inverse of this property, if any such property is defined. If no such property is defined, return
	 * null. If more than one inverse is defined, return an arbitrary selection.
	 * </p>
	 * <p>
	 * Note that this method is slightly different from {@link #getInverseOf}. Suppose that we have:
	 * </p>
	 * 
	 * <pre>
	 ...
	 * </pre>
	 * <p>
	 * Then, <code>getInverse()</code> called on the <code>OntProperty</code> corresponding to <code>q</code> will return <code>p</code>, since <code>q</code>
	 * declares itself to be <code>p</code>'s inverse. However, <em>unless an OWL
	 * reasoner is used</em>, calling <code>getInverse()</code> on <code>p</code> will return <code>null</code>. Conversely, absent a reasoner,
	 * <code>{@link #getInverseOf}</code> on <code>p</code> will return <code>q</code>, but will return null when called on <code>q</code> . In the presence of
	 * an OWL reasoner, <code>getInverse()</code> and <code>getInverseOf()</code> are equivalent, since <code>owl:inverseOf</code> is a symmetric property.
	 * </p>
	 * 
	 ...
	 * {@link OntClass#listDeclaredProperties()}. This simulates a frame-like view of properties and classes; for more details see the <a
	 * href="../../../../../../how-to/rdf-frames.html"> RDF frames how-to</a>.
	 * </p>
	 * 
	 * @return An iterator of the classes having this property as one of their declared properties
	 */
	 ...
	 * <p>
	 * Answer an iterator of all of the classes in this ontology, such that each returned class has this property as one of its properties in
	 * {@link OntClass#listDeclaredProperties(boolean)}. This simulates a frame-like view of properties and classes; for more details see the <a
	 * href="../../../../../../how-to/rdf-frames.html"> RDF frames how-to</a>.
	 * </p>
	 * 
	 * @param direct
	 *            If true, use only </em>direct</em> associations between classes and properties
	 * @return An iterator of the classes having this property as one of their declared properties
	 */
	 ...
	 * <p>
	 * <strong>Note</strong> that any such restrictions do not affect the global semantics of this property itself. Restrictions define new class expressions,
	 * and the property constraints are local to that class expression. This method is provided as a convenience to assist callers to navigate the relationships
	 * in the model.
	 * </p>
	 * 
	 * @return An iterator whose values are the restrictions from the local model that reference this property.
	 */
