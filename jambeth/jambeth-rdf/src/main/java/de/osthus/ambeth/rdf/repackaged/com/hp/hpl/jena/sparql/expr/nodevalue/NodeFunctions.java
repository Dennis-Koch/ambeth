...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.expr.ExprTypeException;
...
public class NodeFunctions
{
	...
	public static NodeValue langMatches(NodeValue nv, String langPattern)
	{
		...
		/*
		 * Here is the logic to compare language code. There is a match if the language matches the parts of the pattern - the language may be longer than the
		 * pattern.
		 */
		 ...
		 * 
		 * To do extended: 1. Remove any -*- (but not *-) 2. Compare primary tags. 3. Is the remaining range a subsequence of the remaining language tag?
		 */
