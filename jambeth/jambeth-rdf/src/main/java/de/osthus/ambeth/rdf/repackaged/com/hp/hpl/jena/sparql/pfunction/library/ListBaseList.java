...
public abstract class ListBaseList extends ListBase
{
	...
	@Override
	final protected QueryIterator execOneList(Binding binding, Node listNode, Node predicate, PropFuncArg object, ExecutionContext execCxt)
	{
	...
	protected abstract QueryIterator execOneList(Binding binding, Node listNode, Node predicate, List<Node> argList, ExecutionContext execCxt);
}
