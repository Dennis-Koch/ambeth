 ...
 * 
 * <p>
 * Note: this is compute intensive and memory intensive. It needs to read all the results first (all the results are then in-memory) in order to find things the
 * maximum width of a column value; then it needs to pass over the results again, turning them into output.
 * </p>
 * 
 * @see de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.ResultSetFormatter for convenience ways to call this formatter
 */
