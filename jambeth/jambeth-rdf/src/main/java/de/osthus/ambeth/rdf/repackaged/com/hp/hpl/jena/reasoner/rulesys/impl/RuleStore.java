...
/**
 * Indexes a collection of rule. The currently implementation is a crude first version aimed at supporting the backchaining interpreter. It only indexes on
 * predicate.
 * <p>
...
public class RuleStore
{
	...
	{
		if (isAdd && ruleIndex.contains(rule))
			return;
		if (isAdd)
		{
			ruleIndex.add(rule);
	...
	/**
	 * Helper method to extract all matching clauses from an iterator over rules
	 */
