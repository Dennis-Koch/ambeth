...
public class XSDAbstractDateTimeType extends XSDDatatype
{
	...
	// define constants
	protected final static int CY = 0, M = 1, D = 2, h = 3, m = 4, s = 5, ms = 6, msscale = 8, utc = 7, hh = 0, mm = 1;
	...
	public static void appendFractionalTime(StringBuffer buff, int fsec, int scale)
	{
		...
		while (trunc > 0 && msString.charAt(trunc - 1) == '0')
			trunc--;
	...
	public RDFDatatype normalizeSubType(Object value, RDFDatatype dt)
	{
		if (value instanceof XSDDateTime)
		{
			...
			{
				// We've externally narrowed the type, push this down to the
				// date time
