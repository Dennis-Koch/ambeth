...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.MultiMap;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.expr.aggregate.Accumulator;
...
public class QueryIterGroup extends QueryIterPlainWrapper
{
	...
	private static Iterator<Binding> calc(final QueryIterator iter, final VarExprList groupVarExpr, final List<ExprAggregator> aggregators,
