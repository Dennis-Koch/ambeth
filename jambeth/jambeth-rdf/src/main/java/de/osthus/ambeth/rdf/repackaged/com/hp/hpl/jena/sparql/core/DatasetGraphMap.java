...
public class DatasetGraphMap extends DatasetGraphCollection
{
	...
	/**
	 * Create a new DatasetGraph that initially shares the graphs of the givem DatasetGraph. Adding/removing graphs will only affect this object, not the
	 * argument DatasetGraph but changed to shared graphs are seenby both objects.
	 */
	...
	/**
	 * Called from getGraph when a nonexistent graph is asked for. Return null for "nothing created as a graph"
	 */
