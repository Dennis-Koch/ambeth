...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.expr.aggregate.*;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.update.*;
...
public class ARQParser extends ARQParserBase implements ARQParserConstants
{
	...
	{
		QuadDataAccSink qd = createDeleteDataSink();
		Token t;
				...
				switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk)
				{
					case DISTINCT:
						...
						if (!allowAggregatesInExpressions)
							throwParseException("Aggregate expression not legal at this point", beginLine, beginColumn);
						break;
					default:
						jj_la1[82] = jj_gen;
						;
			...
			case LBRACE:
				...
				switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk)
				{
					case STAR:
						...
						{
							if (true)
								return PathFactory.pathZeroOrMoreN(p);
						}
						break;
					case PLUS:
						jj_consume_token(PLUS);
						...
						{
							if (true)
								return PathFactory.pathOneOrMoreN(p);
						}
						break;
					case INTEGER:
						// {N} {N,M} {N,}
			...
			case CARAT:
				...
				switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk)
				{
					...
					case KW_A:
						...
						{
							if (true)
								return new P_ReverseLink(nRDFtype);
						}
						break;
					default:
						jj_la1[115] = jj_gen;
	...
	final public Node BlankNode() throws ParseException
	{
		...
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk)
		{
			...
			case ANON:
				...
				{
					if (true)
						return createBNode(t.beginLine, t.beginColumn);
				}
				break;
			default:
				jj_la1[169] = jj_gen;
	...
	{
		if (jj_scan_token(ENCODE_FOR_URI))
			return true;
		if (jj_scan_token(LPAREN))
			return true;
		return false;
	...
	{
		jj_la1_0 = new int[] { 0x7200000, 0x180000, 0x180000, 0x0, 0xc00000, 0xc00000, 0xe00, 0x0, 0x6e00, 0x6e00, 0x6e00, 0x0, 0x0, 0x7e00, 0x0, 0x6e00,
				0x6e00, 0x0, 0x0, 0x0, 0xe00, 0x0, 0x0, 0x0, 0x20000000, 0x18000000, 0x6e00, 0x0, 0x6e00, 0xe00, 0x6e00, 0x0, 0x6e00, 0x6e00, 0x10000000,
				0x8000000, 0x18000000, 0x80000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xe00, 0x0, 0xe00, 0x0, 0x7e00,
				0x0, 0x0, 0x7e00, 0x7e00, 0x0, 0x200000, 0x7e00, 0x80000000, 0x0, 0x7e00, 0x7e00, 0x0, 0x80000000, 0x0, 0x6000, 0xe00, 0x6000, 0x0, 0x0, 0xe00,
				0x0, 0xe00, 0x0, 0xe00, 0x400000, 0x0, 0x0, 0x0, 0x0, 0x7e00, 0x0, 0x7e00, 0x46e00, 0x0, 0x46e00, 0x46e00, 0x0, 0x7e00, 0x446e00, 0x446e00,
				0x0, 0x446e00, 0x446e00, 0x0, 0x0, 0x0, 0x0, 0x0, 0x440e00, 0x0, 0x0, 0x0, 0x0, 0x440e00, 0x0, 0x40e00, 0x40e00, 0x40e00, 0x40e00, 0x0, 0x0,
				0x7e00, 0x7e00, 0x7e00, 0x7e00, 0x7e00, 0x6e00, 0x6000, 0x1e00, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x6e00, 0x6e00, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x400000, 0x6e00, 0x400000, 0x400000, 0x400000, 0x400000, 0x400000, 0x400000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x8000, 0x8000,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xe00, 0xc00, 0x1000, };
	}

	private static void jj_la1_init_1()
	{
		jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x10, 0x0, 0x0, 0x0, 0x10000, 0xdbe0c000, 0xdbe0c000, 0xdbe0c000, 0x10, 0x10, 0x0, 0x30, 0x0, 0x0, 0x10, 0x20,
				0x10, 0x8, 0x20, 0x20000, 0x40000, 0x0, 0x0, 0xdbe0c000, 0x10000, 0xdbe0c000, 0xdbe0c000, 0xdbe0c006, 0x6, 0xdbe0c000, 0xdbe0c006, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x8, 0x80, 0x80, 0x88, 0x0, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x2000fd80, 0x0, 0x0, 0x0, 0x0, 0x2000fd80, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x1, 0x0, 0x1, 0x200, 0xdbe0c000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x8000, 0x8000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xdbe0c000, 0xdbe0c000,
				0x0, 0x0, 0xdbe0c000, 0x0, 0x0, 0x0, 0x0, 0xdbe0c000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1be00000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, };
	}

	private static void jj_la1_init_2()
	{
		jj_la1_2 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xfffffe5e, 0xfffffe5e, 0xfffffe5e, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0xfffffe5e, 0x0, 0xfffffe5e, 0xfffffe5e, 0xfffffe5e, 0x0, 0xfffffe5e, 0xfffffe5e, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xfffffe5e, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x180, 0x180, 0x0, 0x180, 0x180, 0x0, 0x0, 0x0, 0x0, 0x0, 0x180, 0x0, 0x0, 0x0, 0x0, 0x180, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xfffffe5e, 0xfffffe5e, 0x0, 0x0, 0xfffffe5e, 0x0, 0x0, 0x0,
				0x0, 0xfffffe5e, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, };
	}

	private static void jj_la1_init_3()
	{
		jj_la1_3 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x6000000, 0x0, 0x7dfffff, 0x7dfffff, 0x7dfffff, 0x0, 0x0, 0x6000000, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1dfffff, 0x0, 0x1dfffff, 0x1dfffff, 0x1dfffff, 0x0, 0x1dfffff, 0x1dfffff, 0x0, 0x0, 0x0, 0x0, 0x0,
				0xf0000000, 0xf0000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10000000, 0x30000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x6000000, 0x0, 0x0,
				0x6000000, 0x6000000, 0x0, 0x0, 0x6000000, 0x0, 0x0, 0x6000000, 0x6000000, 0x0, 0x0, 0x0, 0x0, 0x6000000, 0x0, 0x0, 0x0, 0x6000000, 0x0,
				0x6000000, 0x0, 0x1dfffff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x6000000, 0x0, 0x6000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x6000000, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x6000000, 0x6000000, 0x6000000, 0x6000000,
				0x6000000, 0x0, 0x0, 0x6000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x7dfffff, 0x7dfffff, 0x0, 0x0, 0x1dfffff, 0x0, 0x0,
				0x0, 0x0, 0x7dfffff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x6000000, 0x0, 0x0, 0x0, 0x0, };
	}

	private static void jj_la1_init_4()
	{
		jj_la1_4 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xc3fe0000, 0x0, 0xc3fe0000, 0xc3fe0000, 0xc3fe0000, 0x0, 0x0, 0xc3fe0000, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x427f, 0x427f, 0x100, 0x400, 0x100,
				0x100, 0x100, 0x100, 0x100, 0x100, 0x4000, 0x0, 0x0, 0x8000, 0x0, 0x0, 0x1000, 0x3000, 0xc3fe0000, 0x0, 0x0, 0xc3fe0000, 0xc3fe0000, 0x0, 0x0,
				0xc3fe0000, 0x0, 0x0, 0xc3fe0000, 0xc3fe0000, 0x0, 0x0, 0x100, 0x0, 0xc3fe0000, 0x0, 0x0, 0x0, 0xc3fe0000, 0x0, 0xc3fe0000, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0xc3fe0000, 0x0, 0xc3fe0000, 0x0, 0x0, 0x0, 0x0, 0x0, 0xc3fe0000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x20000, 0x0, 0x20000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xc3fe0000, 0xc3fe0000, 0xc3fe0000, 0xc3fe0000, 0xc3fe0000, 0x0, 0x0,
				0xc3fe0000, 0x0, 0x0, 0x0, 0x0, 0x3f00000, 0x3f00000, 0x0, 0x0, 0x3f00000, 0x0, 0x0, 0xc3fe0000, 0xc3fe0000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0xc3fe0000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3fe0000, 0xe0000, 0x700000, 0x3800000, 0x0, 0xc0000000, 0x0,
				0x0, 0x0, };
	}

	private static void jj_la1_init_5()
	{
		jj_la1_5 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3, 0x0, 0x7, 0x7, 0x4000007, 0x0, 0x0, 0x297, 0x20, 0x0, 0x4000000, 0x0, 0x20, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x4, 0x0, 0x4, 0x4, 0x4, 0x0, 0x4, 0x4, 0x0, 0x0, 0x0, 0x0, 0x400, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x297, 0x0, 0x1000, 0x297, 0x297, 0x1000, 0x0, 0x297, 0x20, 0x1000, 0x297, 0x297, 0x1000, 0x20, 0x0, 0x14,
				0x3, 0x0, 0x14, 0x14, 0x3, 0x14, 0x3, 0x0, 0x4, 0x0, 0x800, 0x14, 0x800, 0x14, 0x297, 0x1000, 0x297, 0x0, 0x400, 0x0, 0x0, 0x800, 0x297,
				0x80004, 0x80004, 0x400, 0x80004, 0x80004, 0x800, 0x80000000, 0x8000000, 0x8000000, 0x5000020, 0x80004, 0x40, 0x840, 0x5000800, 0x5000020,
				0x80004, 0x80000000, 0x0, 0x4, 0x0, 0x0, 0x84, 0x84, 0x297, 0x297, 0x297, 0x297, 0x213, 0x0, 0x0, 0x213, 0x400000, 0x800000, 0x7e000, 0x7e000,
				0x3000000, 0x0, 0xc000000, 0xc000000, 0x3000000, 0xc000000, 0xc000000, 0x3080007, 0x7, 0x14, 0x800, 0x0, 0x800, 0x800, 0x800, 0x0, 0x7080007,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x400, 0x400, 0x400, 0x0, 0x14, 0x10000000, 0x10000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3, 0x0, 0x0, 0x200, };
	}

	private static void jj_la1_init_6()
	{
		jj_la1_6 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x1, 0x0, 0x1, 0x1, 0x0, 0x0, 0x1, 0x1, 0x8, 0x1, 0x0, 0x0,
				0x0, 0x8, 0x0, 0x0, 0x1, 0x1, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, };
	}
