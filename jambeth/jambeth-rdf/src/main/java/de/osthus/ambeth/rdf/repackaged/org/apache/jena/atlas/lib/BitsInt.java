...
public final class BitsInt
{
	...
	/**
	 * Extract the value packed into bits start (inclusive) and finish (exclusive). The value is returned in the low part of the returned int. The low bit is
	 * bit zero.
	 * 
	 * @param bits
	 * @param start
