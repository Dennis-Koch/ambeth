...
public class IO
{
	...
	/**
	 * Open an input stream to a file; do not mask IOExceptions. If the filename is null or "-", return System.in If the filename ends in .gz, wrap in
	 * GZIPInputStream
	 * 
	 * @param filename
	...
	public static void close(de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Closeable resource)
	{
		resource.close();
	}

	public static void closeSilent(de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Closeable resource)
	{
		try
		{
			resource.close();
