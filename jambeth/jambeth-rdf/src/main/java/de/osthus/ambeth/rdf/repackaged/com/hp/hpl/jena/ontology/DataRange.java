...
/**
 * <p>
 * Represents an ontology DataRange: a class-like construct that contains only concrete data literals. See section 6.2 of the OWL language reference for
 * details. In OWL Full, there is no difference between a DataRange and a Class.
 * </p>
 */
public interface DataRange extends OntResource
{
	...
	/**
	 * <p>
	 * Assert that this data range is exactly the enumeration of the given individuals. Any existing statements for <code>oneOf</code> will be removed.
	 * </p>
	 * 
	 * @param en
	...
	/**
	 * <p>
	 * Remove the statement that this enumeration includes <code>lit</code> among its members. If this statement is not true of the current model, nothing
	 * happens.
	 * </p>
	 * 
	 * @param lit
