 ...
 * 
 * <p>
 * This factory interface is slightly unusual, in that, as well as creating and returning RDFReader's, it also provides methods for creating a reader, invoking
 * a read method on it and then shuting it down.
 * </p>
 * 
 * <p>
 ...
 * </ul>
 * <p>
 * System wide defaults for classes to use as readers for these languages are defined. These defaults may be overwridden by setting a system property with a
 * name of the form de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.readers.<lang> to the class name.
 * </p>
 * <p>
 * <b>NOTE:</b> All settings are global in nature
 * </p>
 */
...
public interface RDFReaderF
{
	 ...
	 * @param lang
	 *            the serialization language - <code>null</code> selects the default
	 */
	 ...
	 * @param className
	 *            the class name for readers for this language
	...
	/**
	 * Remove lang from list of readers.. Must be one of the classes that was added using setReaderClassName()
	 * 
	 * @param lang
	 *            The lang to remove.
	 * @return the old class name for this language
	 * @throws IllegalArgumentException
	 *             if lang is one of the initial languages
	 */
