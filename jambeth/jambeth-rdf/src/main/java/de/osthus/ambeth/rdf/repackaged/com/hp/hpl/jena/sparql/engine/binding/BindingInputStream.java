...
package de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.binding;
...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.iterator.IteratorSlotted;
...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.lang.LangEngine;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.out.NodeFmtLib;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.system.*;
...
/**
 * Language for reading in a stream of bindings. See <a href="https://cwiki.apache.org/confluence/display/JENA/BindingIO">BindingIO</a>
 * 
 * <p>
 * Summary:
 * </p>
...
public class BindingInputStream extends LangEngine implements Iterator<Binding>, Closeable
{
	...
	/**
	 * Create an RDF Tuples parser. No need to pass in a buffered InputStream; the code will do it's own buffering.
	 */
