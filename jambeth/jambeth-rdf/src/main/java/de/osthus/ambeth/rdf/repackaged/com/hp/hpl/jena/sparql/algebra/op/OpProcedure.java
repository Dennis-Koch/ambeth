 ...
 * 
 * See also the similar algebra form for property functions. The difference is in argument handling. A property function has a URI and two argment lists, one
 * for subject, one for objects. A procedure is a URI and a list of arguments.
 */
