...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.main.OpExecutorFactory;
...
public class ExecutionContext implements FunctionEnv
{
	...
	/**
	 * Return the active graph (the one matching is against at this point in the query. May be null if unknown or not applicable - for example, doing quad store
	 * access or when sorting
	 */
	@Override
