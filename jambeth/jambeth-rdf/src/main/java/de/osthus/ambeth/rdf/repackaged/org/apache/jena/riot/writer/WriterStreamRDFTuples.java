...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.out.NodeFormatterNT;
...
public class WriterStreamRDFTuples implements StreamRDF
{
	...
	/**
	 * Output tuples, using UTF8 output See {@linkplain StreamRDFLib#writer} for ways to create a AWriter object.
	 */
	...
	/**
	 * Output tuples, choosing ASCII or UTF8 See {@linkplain StreamRDFLib#writer} for ways to create a AWriter object.
	 */
