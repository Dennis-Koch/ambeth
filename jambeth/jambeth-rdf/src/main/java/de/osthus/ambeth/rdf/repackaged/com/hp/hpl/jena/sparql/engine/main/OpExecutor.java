...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.QueryExecException;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.iterator.*;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.main.iterator.QueryIterGraph;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.main.iterator.QueryIterJoin;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.main.iterator.QueryIterLeftJoin;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.main.iterator.QueryIterOptionalIndex;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.main.iterator.QueryIterService;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.main.iterator.QueryIterUnion;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.procedure.ProcEval;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.procedure.Procedure;

/**
 * Turn an Op expression into an execution of QueryIterators.
 * 
 * Does not consider optimizing the algebra expression (that should happen elsewhere). BGPs are still subject to StageBuilding during iterator execution.
 * 
 * During execution, when a substitution into an algebra expression happens (in other words, a streaming operation, index-join-like), there is a call into the
 * executor each time so it does not just happen once before a query starts.
 */
