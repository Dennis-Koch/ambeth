 ...
 * </p>
 */
public class UnionClassImpl extends BooleanClassDescriptionImpl implements UnionClass
{
	// Constants
	// ////////////////////////////////
	...
	/**
	 * A factory for generating UnionClass facets from nodes in enhanced graphs. Note: should not be invoked directly by user code: use
	...
	public static Implementation factory = new Implementation()
	{
		...
		{
			// node will support being an UnionClass facet if it has rdf:type
			// owl:Class and an owl:unionOf statement (or equivalents)
			Profile profile = (eg instanceof OntModel) ? ((OntModel) eg).getProfile() : null;
			Property union = (profile == null) ? null : profile.UNION_OF();

			return (profile != null) && profile.isSupported(node, eg, OntClass.class) && union != null && eg.asGraph().contains(node, union.asNode(), Node.ANY);
		}
	};
