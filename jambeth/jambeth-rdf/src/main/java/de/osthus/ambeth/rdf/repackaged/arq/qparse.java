...
import de.osthus.ambeth.rdf.repackaged.arq.cmdline.ModQueryOut;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.QueryException;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.QueryExecution;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.QueryExecutionFactory;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.Syntax;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.core.QueryCheckException;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.lang.ParserBase;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.resultset.ResultSetException;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.QueryOutputUtils;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.QueryUtils;
...
public class qparse extends CmdARQ
{
	...
	protected void processModulesAndArgs()
	{
		...
		for (String arg : getValues(argDeclPrint))
		{
			...
			else if (arg.equalsIgnoreCase("op") || arg.equalsIgnoreCase("alg") || arg.equalsIgnoreCase("algebra"))
			{
				printOp = true;
			}
	...
	protected void exec()
	{
		try
		{
			...
			{
				LogCtl.set(ParserBase.ParserLoggerName, "INFO");
			}
