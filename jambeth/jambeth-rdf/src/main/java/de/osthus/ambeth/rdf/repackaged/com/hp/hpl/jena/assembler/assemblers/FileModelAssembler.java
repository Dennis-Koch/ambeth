...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.impl.FileGraph;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.impl.FileGraph.NotifyOnClose;
...
public class FileModelAssembler extends NamedModelAssembler implements Assembler
{
	...
	private boolean getBoolean(Resource root, Property p, boolean ifAbsent)
	{
		...
		return r == null ? ifAbsent : r.isLiteral() ? booleanSpelling(r.asNode().getLiteralLexicalForm()) : r.isURIResource() ? booleanSpelling(r.asNode()
				.getLocalName()) : false;
	}
