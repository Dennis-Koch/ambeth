...
/**
 * A writer that records what the current indentation level is, and uses that to insert a prefix at each line. It can also insert line numbers at the beginning
 * of lines.
 */
...
public class IndentedWriter extends AWriterBase implements AWriter, Closeable
{
	...
	/**
	 * Get the absolute column. This is the location where the next charcter on the line will be printed. The IndentedWriter may not yet have padded to this
	 * place.
	 */
	public int getCol()
	{
