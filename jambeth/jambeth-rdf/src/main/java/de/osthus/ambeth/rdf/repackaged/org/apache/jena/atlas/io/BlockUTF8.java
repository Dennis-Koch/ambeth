...
package de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.io;

import java.io.IOException;
import java.nio.ByteBuffer;
import java.nio.CharBuffer;

import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.NotImplemented;

/**
 * Convert between bytes and chars, UTF-8 only.
 * 
 * This code is just the UTF-8 encoding rules - it does not check for legality of the Unicode data. The standard codec do, so do not round-trip with binary
 * compatibility. (Example: a single element of a surrogate pair will be encoded/decoded without lost.
 * 
 * 
 * The usual Charset encoders/decoders can be expensive to start up - they are also not thread safe. Sometimes we want to convert 10's of chars and UTF-8 can be
 * done in code with no lookup tables (which, if used, are cache-unfriendly).
 * 
 * This code is thread safe. It uses code in the hope that JITting will make it fast if used heavily.
 */
...
public class BlockUTF8
{
	...
	/*
	 * Bits 7 U+007F 1 to 127 0xxxxxxx 11 U+07FF 128 to 2,047 110xxxxx 10xxxxxx 16 U+FFFF 2,048 to 65,535 1110xxxx 10xxxxxx 10xxxxxx 21 U+1FFFFF 65,536 to
	 * 1,114,111 11110xxx 10xxxxxx 10xxxxxx 10xxxxxx 26 U+3FFFFFF 111110xx 10xxxxxx 10xxxxxx 10xxxxxx 10xxxxxx 31 U+7FFFFFFF 1111110x 10xxxxxx 10xxxxxx 10xxxxxx
	 * 10xxxxxx 10xxxxxx
	 */
	...
	/**
	 * Put bytes to the output ByteBuffer for charcater ch. The first byte is in x1 and already has the needed bits set.
	 */
