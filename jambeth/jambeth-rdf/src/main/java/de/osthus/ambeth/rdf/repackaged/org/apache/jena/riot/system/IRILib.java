...
public class IRILib
{
	 ...
	 * RFC 3986
	 * 
	 * unreserved = ALPHA / DIGIT / "-" / "." / "_" / "~" gen-delims = ":" / "/" / "?" / "#" / "[" / "]" / "@" sub-delims = "!" / "$" / "&" / "'" / "(" / ")" /
	 * "*" / "+" / "," / ";" / "="
	 */
	...
	/**
	 * Create a string that is a IRI for the filename. The file name may already have file:. The file name may be relative. Encode using the rules for a path
	 * (e.g. ':' and'/' do not get encoded)
	 */
