...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.reasoner.rulesys.RDFSRuleReasoner;
...
public class ReasonerVocabulary
{
	...
	/**
	 * Property to denote the ontology language (OWL, DAML, RDFS) an external reasoner will process. Values are URI's, see
	 * {@link de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.ontology.ProfileRegistry} . Default is OWL.
	 */
