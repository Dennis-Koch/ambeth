...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.algebra.optimize.ExprTransformConstantFold;
...
public class ExprLib
{
	...
	/**
	 * Decide whether an expression is safe for using a a graph substitution. Need to be careful about value-like tests when the graph is not matched in a value
	 * fashion.
	 */
	...
	/**
	 * @param graphHasStringEquality
	 *            True if the graph triple matching equates xsd:string and plain literal
	 * @param graphHasNumercialValueEquality
	...
	/**
	 * Some "functions" are non-deterministic (unstable) - calling them with the same arguments does not yields the same answer each time. Therefore how and
	 * when they are called matters.
	 * 
