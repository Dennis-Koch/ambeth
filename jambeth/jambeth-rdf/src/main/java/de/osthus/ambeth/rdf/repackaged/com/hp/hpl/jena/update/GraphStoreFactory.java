...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.modify.GraphStoreBasic;
...
public class GraphStoreFactory
{
	...
	/**
	 * Create a GraphStore from a dataset so that updates apply to the graphs in the dataset. Throws UpdateException (an ARQException) if the GraphStore can not
	 * be created. This is not the way to get a GraphStore for SDB or TDB - an SDB Store object is a GraphStore no conversion necessary.
	 * 
	 * @param dataset
