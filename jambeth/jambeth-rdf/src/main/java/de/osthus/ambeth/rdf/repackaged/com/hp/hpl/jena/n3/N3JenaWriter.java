...
/**
 * Entry point for N3 writers. This writer will choose the actual writer to use by looking at the system property
 * <code>com.hp.hpl.jena.n3.N3JenaWriter.writer</code> to get the writer name.
 * <p>
...
public class N3JenaWriter implements RDFWriter
{
	...
	/**
	 * General name for the N3 writer. Will make a decision on exactly which writer to use (pretty writer, plain writer or simple writer) when created. Default
	 * is the pretty writer but can be overridden with system property <code>com.hp.hpl.jena.n3.N3JenaWriter.writer</code>.
	 */

	static public final String n3Writer = "N3";

	/**
	 * Name of the N3 pretty writer. The pretty writer uses a frame-like layout, with prefixing, clustering like properties and embedding one-referenced bNodes.
	 */
	static public final String n3WriterPrettyPrinter = "N3-PP";

	/**
	 * Name of the N3 plain writer. The plain writer writes records by subject.
	 */
	static public final String n3WriterPlain = "N3-PLAIN";

	/**
	 * Name of the N3 triples writer. This writer writes one line per statement, like N-Triples, but does N3-style prefixing.
	 */
	...
	/**
	 * Turtle writer. http://www.dajobe.org/2004/01/turtle/
	 */
	...
	N3JenaWriterCommon chooseWriter()
	{
		...
		if (writerName == null || writerName.equals("N3") || writerName.equals(n3WriterPrettyPrinter))
	...
	/**
	 * Write the model out in N3. The writer should be one suitable for UTF-8 which excludes a PrintWriter or a FileWriter which use default character set.
	 * 
	 * Examples:
	 * 
	 * <pre>
	...
	/**
	 * @see de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.rdf.model.RDFWriter#setErrorHandler(de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.rdf.model.RDFErrorHandler)
	 */
	@Override
