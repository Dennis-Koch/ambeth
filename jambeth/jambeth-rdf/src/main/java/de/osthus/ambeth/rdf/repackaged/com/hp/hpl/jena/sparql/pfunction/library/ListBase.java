...
public abstract class ListBase extends PropertyFunctionEval
{
	 ...
	 */
	@Override
	final public QueryIterator execEvaluated(Binding binding, PropFuncArg argSubject, Node predicate, PropFuncArg argObject, ExecutionContext execCxt)
	{
	...
	/**
	 * @param binding
	 *            current binding as input
	 * @param listVar
	 *            a variable.
	 * @param predicate
	 *            the predicate used to invoke this property function
	 * @param object
	 ...
	 */
	protected abstract QueryIterator execObjectBound(Binding binding, Var listVar, Node predicate, Node object, ExecutionContext execCxt);
	 ...
	 * @return QueryIterator
	 */
	protected abstract QueryIterator execObjectList(Binding binding, Var listVar, Node predicate, List<Node> objectArgs, ExecutionContext execCxt);

	/**
	 * Dispatch when the subject is a list - also used when subject and object all unbound after finding all lists.
	 * 
	 * @param binding
	 *            current binding as input
	 * @param listNode
	 *            the list; maybe a variable.
	 * @param predicate
	 *            the predicate used to invoke this property function
	 * @param object
	 *            the object of the property function; maybe a variable
	 * @param execCxt
	 *            Execution context
	 * @return QueryIterator
	 */
	protected abstract QueryIterator execOneList(Binding binding, Node listNode, Node predicate, PropFuncArg object, ExecutionContext execCxt);
}
