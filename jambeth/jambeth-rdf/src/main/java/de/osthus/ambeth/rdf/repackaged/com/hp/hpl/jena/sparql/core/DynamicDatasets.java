...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.graph.GraphUnionRead;
...
public class DynamicDatasets
{
	...
	/**
	 * Given a DatasetGraph and a query, form a DatasetGraph that is the dynamic dataset from the query. Returns the original DatasetGraph if the dataset
	 * description is null.
	 */
	...
	/**
	 * Given a DatasetGraph and a query, form a DatasetGraph that is the dynamic dataset from the collection of graphs from the dataset that go to make up the
	 * default graph (union) and named graphs.
	 */
