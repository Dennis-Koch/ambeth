...
public class DOAP
{
	...
	/**
	 * <p>
	 * Nom du module d'un d�p�t CVS, BitKeeper ou Arch.Module name of a CVS, BitKeeper or Arch repository.Nombre del m�dulo de un repositorio CVS, BitKeeper o
	 * Arch.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Page web � partir de laquelle on peut t�l�charger le programme.P�gina web de la cu�l se puede bajar el software.Web page from which the project software
	 * can be downloaded.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Descripci�n en texto plano de un proyecto, de 2 a 4 enunciados de longitud.Texte descriptif d'un projet, long de 2 � 4 phrases.Plain text description of
	 * a project, of 2-4 sentences in length.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * D�veloppeur principal d'un projet, un meneur du projet.Maintainer of a project, a project leader.Desarrollador principal de un proyecto, un l�der de
	 * proyecto.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * El URL de la antigua p�gina de un proyecto, asociada con exactamente un proyecto.URL of a project's past homepage, associated with exactly one
	 * project.L'URL d'une ancienne page web d'un projet, associ�e avec un unique projet.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * El URL de la p�gina de un proyecto, asociada con exactamente un proyecto.L'URL de la page web d'un projet, associ�e avec un unique projet.URL of a
	...
	/**
	 * <p>
	 * Fecha en la que algo fue creado, en formato AAAA-MM-DD. e.g. 2004-04-05Date � laquelle a �t� cr�� quelque chose, au format AAAA-MM-JJ (par ex.
	 * 2004-04-05)Date when something was created, in YYYY-MM-DD form. e.g. 2004-04-05
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Lenguaje de programaci�n en el que un proyecto es implementado o con el cu�l pretende usarse.Programming language a project is implemented in or intended
	 * for use with.Langage de programmation avec lequel un projet est impl�ment�, ou avec lequel il est pr�vu de l'utiliser.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * El URI de una descripci�n RDF de la licencia bajo la cu�l se distribuye el software.The URI of an RDF description of the license the software is
	 * distributed under.L'URI d'une description RDF de la licence sous laquelle le programme est distribu�.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Operating system that a project is limited to. Omit this property if the project is not OS-specific.Sistema opertivo al cu�l est� limitado el proyecto.
	 * Omita esta propiedad si el proyecto no es espec�fico de un sistema opertaivo en particular.Syst�me d'exploitation auquel est limit� le projet. Omettez
	 * cette propri�t� si le projet n'est pas limit� � un syst�me d'exploitation.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * URL of Wiki for collaborative discussion of project.L'URL du Wiki pour la discussion collaborative sur le projet.URL del Wiki para discusi�n colaborativa
	 * del proyecto.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Descripci�n corta (8 o 9 palabras) en texto plano de un proyecto.Short (8 or 9 words) plain text description of a project.Texte descriptif concis (8 ou 9
	 * mots) d'un projet.
	 * </p>
	 */
