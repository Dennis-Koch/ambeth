...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.StringUtils;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.Timer;
...
public class GraphLoadMonitor extends GraphListenerCounter
{
	...
	private void printAtEnd()
	{
		...
		println(summaryLabel, num(getAddCount()) + " triples: loaded in " + num(timeMilli / 1000.0F) + " seconds [" + num(1000F * getAddCount() / timeMilli)
				+ " triples/s]");
	}
