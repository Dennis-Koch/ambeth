...
public class RDFTest
{
	...
	/**
	 * <p>
	 * This manifest entry is used to describe test cases that do not fall into one of the categories. It may have several associated files, indicated in
	...
	/**
	 * <p>
	 * These tests consist of one or more premise documents, and a consequent document. An inference engine is considered to pass the test if it correctly holds
	 * that the expressions in the premise documents do not entail those in the the conclusion document.
	 * </p>
	 */
	public static final Resource NegativeEntailmentTest = m_model
			.createResource("http://www.w3.org/2000/10/rdf-tests/rdfcore/testSchema#NegativeEntailmentTest");

	/**
	 * <p>
	 * These tests consist of one input document. The document is not legal RDF/XML. A parser is considered to pass the test if it correctly holds the input
	...
	/**
	 * <p>
	 * These tests are specified by one or more premise documents (in RDF/XML or N-Triples) together with a single conclusion document. In addition, the rules
	 * used for determining entailment are specified by test:entailmentRules elements.
	 * </p>
	 */
	public static final Resource PositiveEntailmentTest = m_model
			.createResource("http://www.w3.org/2000/10/rdf-tests/rdfcore/testSchema#PositiveEntailmentTest");
