...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.QueryCancelledException;
...
public abstract class QueryIteratorBase extends PrintSerializableBase implements QueryIterator
{
	...
	/*
	 * If set, any hasNext/next throws QueryAbortedException In normal operation, this is the same setting as requestingCancel. Non-compliant behaviour can
	 * result otherwise. Accessed through cancelAllowContinue()
	 */
