...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.ResultSetFormatter;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.SortCondition;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.algebra.*;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.algebra.table.TableN;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.TableJoin;
...
public class EvaluatorSimple implements Evaluator
{
	...
	public Table pathPattern(TriplePath triplePath)
	{
		...
		QueryIterator qIter = new QueryIterPath(triplePath, QueryIterRoot.create(execCxt), execCxt);
		return TableFactory.create(qIter);
	}
