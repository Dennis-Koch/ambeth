...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.iterator.IteratorArray;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.iterator.IteratorDelayedInitialization;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.ReverseComparator;
...
{
	/*
	 * We want to keep the N least elements (overall return is an ascending sequence so limit+ascending = least). To do that we keep a priority heap of upto N
	 * eleemnts, ordered descending. To keep another element, it must be less than the max so far. This leaves the least N in the heap.
	 */
