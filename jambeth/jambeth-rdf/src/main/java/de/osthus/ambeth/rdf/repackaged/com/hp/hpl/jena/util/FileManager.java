...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.rdf.model.impl.IO_Ctl;
...
public class FileManager
{
	...
	{
		// Singleton pattern adopted in case we later have several file
		// managers.
		if (fmInstance == null)
	...
	{
		// Doesn't call open() - we want to make the syntax guess based on the
		// mapped URI.
