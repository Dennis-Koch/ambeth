...
/**
 * A RIOT serializer for a language. This covers both graphs and datasets. A WriterRIOT is a one-time use object (they may accumulate state, e.g. pretty
 * writers).
 */
public interface WriterDatasetRIOT
{
	 ...
	 *            OutputStream
	 * @param datasetGraph
	 *            DatasetGraph to be written
	 * @param prefixMap
	 *            PrefixMap - maybe null (default should be to use the prefixmapping from the Graph)
	 * @param baseURI
	 *            base URI - may be null for "none"
	 * @param context
