...
public class RDFReaderFImpl extends Object implements RDFReaderF
{
	...
	protected static final String LANGS[] = { "RDF", "RDF/XML", "RDF/XML-ABBREV", "N-TRIPLE", "N-TRIPLES", "N-Triples", "N3", "TURTLE", "Turtle", "TTL",
			"GRDDL", "CSV" };
	// default readers for each language

	protected static final String DEFAULTREADERS[] = { "com.hp.hpl.jena.rdf.arp.JenaReader", "com.hp.hpl.jena.rdf.arp.JenaReader",
			"com.hp.hpl.jena.rdf.arp.JenaReader", Jena.PATH + ".rdf.model.impl.NTripleReader", Jena.PATH + ".rdf.model.impl.NTripleReader",
			Jena.PATH + ".rdf.model.impl.NTripleReader", TURTLEREADER, // N3 replaced by a Turtle-based parser
			TURTLEREADER, TURTLEREADER, TURTLEREADER, GRDDLREADER, "org.apache.jena.riot.adapters.RDFReaderRIOT_CSV",
