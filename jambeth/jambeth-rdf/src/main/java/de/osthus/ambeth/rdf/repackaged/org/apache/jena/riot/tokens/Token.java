...
package de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.tokens;

import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Chars.CH_COMMA;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Chars.CH_DOT;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Chars.CH_LBRACE;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Chars.CH_LBRACKET;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Chars.CH_LPAREN;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Chars.CH_RBRACE;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Chars.CH_RBRACKET;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Chars.CH_RPAREN;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Chars.CH_SEMICOLON;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Lib.equal;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Lib.hashCodeObject;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.tokens.TokenType.BNODE;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.tokens.TokenType.DECIMAL;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.tokens.TokenType.DOUBLE;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.tokens.TokenType.INTEGER;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.tokens.TokenType.IRI;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.tokens.TokenType.LITERAL_DT;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.tokens.TokenType.LITERAL_LANG;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.tokens.TokenType.STRING;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.tokens.TokenType.VAR;

import java.util.ArrayList;
import java.util.List;

import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.io.PeekReader;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.vocabulary.XSD;
...
public final class Token
{
	...
	Token(TokenType type, String image1)
	{
	...
	{
		return tokenType == TokenType.CNTRL;
	}
	...
	/**
	 * Token to Node, a very direct form that is purely driven off the token. Turtle and N-triples need to process the token and not call this: 1/ Use bNode
	 * label as given 2/ No prefix or URI resolution. 3/ No checking.
	 */
	public Node asNode()
	{
		return asNode(null);
	...
	/**
	 * Token to Node, with a prefix map Turtle and N-triples need to process the token and not call this: 1/ Use bNode label as given 2/ No prefix or URI
	 * resolution. 3/ No checking.
	 */
	public Node asNode(PrefixMap pmap)
	{
		...
		// Assumes that bnode labels have been sorted out already.
			case BNODE:
				return NodeFactory.createAnon(new AnonId(tokenImage));
			case IRI:
			...
			case DECIMAL:
				return NodeFactory.createLiteral(tokenImage, null, XSDDatatype.XSDdecimal);
			case DOUBLE:
				return NodeFactory.createLiteral(tokenImage, null, XSDDatatype.XSDdouble);
			case INTEGER:
				return NodeFactory.createLiteral(tokenImage, null, XSDDatatype.XSDinteger);
			case LITERAL_DT:
			{
			...
			case LITERAL_LANG:
				return NodeFactory.createLiteral(tokenImage, tokenImage2, null);
			case STRING:
			case STRING1:
			case STRING2:
			case LONG_STRING1:
	...
	public boolean equals(Object other)
	{
		if (!(other instanceof Token))
			return false;
		Token t = (Token) other;
		return equal(tokenType, t.tokenType) && equal(tokenImage, t.tokenImage) && equal(tokenImage2, t.tokenImage2) && equal(cntrlCode, t.cntrlCode);
	}
