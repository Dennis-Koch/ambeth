...
/**
 * Frame in the LPInterpreter's control stack used to represent matching to the results of a tabled predicate. Conventionally the system state which finds and
 * tables the goal results is called the generator and states which require those results are called consumers.
 * <p>
...
public class ConsumerChoicePointFrame extends GenericTripleMatchFrame implements LPAgendaEntry, LPInterpreterState
{
	 ...
	 * 
	 * @param interpreter
	 *            the parent interpreter whose state is to be preserved here, its arg stack defines the parameters for the target goal
	 */
	 ...
	 * @return FAIL if there are no more matches and the generator is closed, SUSPEND if there are no more matches but the generator could generate more,
	 *         SATISFIED if a match has been found.
	 */
	...
	public void pump()
	{
		...
		{
			// The top level iterator is in charge and will restore and run this
			// choice point itself
		}
	}
