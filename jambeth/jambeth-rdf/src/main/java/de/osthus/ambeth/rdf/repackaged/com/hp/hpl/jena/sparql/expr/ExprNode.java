...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.expr.nodevalue.XSDFuncOp;
...
/**
 * A node that is a constraint expression that can be evaluated An Expr is already a Constraint - ExprNode is the base implementation of all Expr classes that
 * provides the Constraint machinary.
 */
...
public abstract class ExprNode implements Expr
{
	...
	{
		return null;
	} // throw new ExprException("Expr.getVarName called on non-variable") ; }

	@Override
	public ExprVar getExprVar()
	{
		return null;
	} // throw new ExprException("Expr.getVar called on non-variable") ; }
	...
	{
		return null;
	} // throw new ExprException("Expr.getConstant called on non-constant") ; }
