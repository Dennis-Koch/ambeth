...
/**
 * DatasetGraph that <em>caches</em> calls to make graph implementations. Useful for storage layers that use triples+quads storage and the graphs are wrappers
 * to the actual storage layer.
 * 
