...
/**
 * Some simple helper methods used when working with Finders, particularly to compose them into cascade sequences. The cascades are designed to cope with null
 * Finders as well.
 */
public class FinderUtil
{
	...
	private static class Cascade implements Finder
	{
		 ...
		 *            a TriplePattern to be matched against the data
		 * @param continuation
		 *            either a Finder or a normal Graph which will be asked for additional match results if the implementor may not have completely satisfied
		 *            the query.
		 */
		@Override
