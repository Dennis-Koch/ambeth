...
public class IteratorCollection
{
	...
	/**
	 * Answer the elements of the given iterator as a set. The iterator is consumed by the operation. Even if an exception is thrown, the iterator will be
	 * closed.
	 * 
	 * @param i
	...
	/**
	 * Answer the elements of the given iterator as a list, in the order that they arrived from the iterator. The iterator is consumed by this operation: even
	 * if an exception is thrown, the iterator will be closed.
	 * 
	 * @param it
	 *            the iterator to convert
