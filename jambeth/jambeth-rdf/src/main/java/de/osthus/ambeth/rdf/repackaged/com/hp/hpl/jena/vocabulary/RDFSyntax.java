...
/**
 * This class includes fragment IDs from the <a href="http://www.w3.org/TR/rdf-syntax-grammar"> RDF Syntax WD</a>, to identify grammar rules etc. using in the
 * Jena I/O routines. These URIs can be used in some options (specifically the configuration of the RDF/XML-ABBREV writer) to indicate behaviour concerning
 * these rules.
 */
public class RDFSyntax
{
	protected static final String uri = "http://www.w3.org/TR/rdf-syntax-grammar#";
