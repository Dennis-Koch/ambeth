...
public class NodeFormatterTTL extends NodeFormatterNT
{
	...
	public NodeFormatterTTL(String baseIRI, PrefixMap prefixMap, NodeToLabel nodeToLabel)
	{
		...
		this.iriResolver = baseIRI != null ? IRIFactory.jenaImplementation().construct(baseIRI) : null;
	}
	...
	/**
	 * Skip digits [0-9] and return the index just after the digits, which may be beyond the length of the string. May skip zero.
	 */
