...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.RiotNotFoundException;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Management of stream opening, including redirecting through a location mapper whereby a name (e.g. URL) is redirected to another name (e.g. local file).
...
public class StreamManager
{
	...
	/**
	 * Return a default configuration StreamManager with a {@linkplain LocatorFile}, {@linkplain LocatorHTTP}, {@linkplain LocatorFTP} and
	 * {@linkplain LocatorClassLoader}
	 */
