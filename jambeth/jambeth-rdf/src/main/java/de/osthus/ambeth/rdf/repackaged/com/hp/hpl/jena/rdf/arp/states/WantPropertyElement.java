...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.rdf.arp.impl.AResourceInternal;
...
public class WantPropertyElement extends Frame implements WantsObjectFrameI, HasSubjectFrameI
{
	...
	public FrameI startElement(String uri, String localName, String rawName, Attributes atts) throws SAXParseException
	{
		...
		// xml:
				...
				// legal rdf:
						| A_DATATYPE | A_ID | A_NODEID | A_PARSETYPE | A_RESOURCE | A_TYPE,
				// bad rdf:
				A_BADATTRS);
		...
		final int nextStateCode = (ap.datatype == null ? 0 : TYPEDLITERAL) | (ap.parseType == null ? 0 : PARSETYPE)
	...
	{
		return ((propAttrs == null && ap.type == null) || (ap.nodeID == null && ap.resource == null && ap.type == null) || (ap.nodeID == null
				&& ap.resource == null && propAttrs == null)) ? pairwiseIncompatibleErrorMessage(nextStateCode, ap, propAttrs) : complicatedErrorMessage(
