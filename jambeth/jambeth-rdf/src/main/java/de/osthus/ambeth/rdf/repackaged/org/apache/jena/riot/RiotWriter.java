...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.writer.*;
...
/**
 * Direct call to create writers for specific formats. The normal way to write is {@linkplain RDFDataMgr}
 */
public class RiotWriter
{
	...
	/**
	 * Create an N-Triples writer, restricted to ASCII characters in the output. Other chars escaped in \ u sequences.
	 * 
	...
	/**
	 * Create an N-Quads writer, restricted to ASCII characters in the output. Other chars escaped in \ u sequences.
	 * 
