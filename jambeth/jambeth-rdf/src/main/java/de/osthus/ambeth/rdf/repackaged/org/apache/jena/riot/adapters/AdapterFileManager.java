...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.util.TypedStream;
...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.system.stream.LocatorFTP;
...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.system.stream.LocatorURL;
 ...
 * FileManager
 * 
 * A FileManager provides access to named file-like resources by opening InputStreams to things in the filing system, by URL (http: and file:) and found by the
 * classloader. It can also load RDF data from such a system resource into an existing model or create a new (Memory-based) model. There is a global FileManager
 * which provide uniform access to system resources: applications may also create specialised FileManagers.
 * 
 * A FileManager contains a list of location functions to try: the global FileManger has one {@link LocatorFile}, one {@link LocatorClassLoader} and one
 * {@link LocatorURL}
 * 
 * Main operations:
 * <ul>
 ...
 * </ul>
 * 
 * A FileManager works in conjunction with a LocationMapper. A {@link LocationMapper} is a set of alternative locations for system resources and a set of
 * alternative prefix locations. For example, a local copy of a common RDF dataset may be used whenever the usual URL is used by the application.
 * 
...
public class AdapterFileManager extends de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.util.FileManager
{
	...
	@Override
	public void setLocationMapper(de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.util.LocationMapper mapper)
	{
	...
	@Override
	public de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.util.LocationMapper getLocationMapper()
	{
	...
	@Override
	public Iterator<de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.util.Locator> locators()
	{
	...
	/** Remove a locator */
	@Override
	public void remove(de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.util.Locator loc)
	{
		throw new UnsupportedOperationException();
	}
	...
	@Override
	public void addLocator(de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.util.Locator oldloc)
	{
