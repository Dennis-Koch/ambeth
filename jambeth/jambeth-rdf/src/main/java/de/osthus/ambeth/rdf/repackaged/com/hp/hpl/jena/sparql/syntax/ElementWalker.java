...
/**
 * An element visitor that walks the graph pattern tree, applying a visitor at each Element traversed. Does not (NOT)EXISTS in filters. These will need to call
 * down themselves if it is meaningful for the visitor. Bottom-up walk - apply to subelements before applying to current element.
 */
