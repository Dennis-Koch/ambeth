...
public class ResultSetMem implements de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.ResultSetRewindable, ResultSetPeekable
{
	...
	/**
	 * Create an in-memory result set from any ResultSet object. If the ResultSet is an in-memory one already, then no copying is done - the necessary internal
	 * datastructures are shared. This operation destroys (uses up) a ResultSet object that is not an in memory one.
	 */
	...
	{
		throw new java.lang.UnsupportedOperationException(Utils.className(this) + ": Attempt to remove an element");
	}
