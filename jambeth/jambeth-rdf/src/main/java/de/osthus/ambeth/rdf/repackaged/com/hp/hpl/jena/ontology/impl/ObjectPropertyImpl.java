...
public class ObjectPropertyImpl extends OntPropertyImpl implements ObjectProperty
{
	...
	/**
	 * A factory for generating ObjectProperty facets from nodes in enhanced graphs. Note: should not be invoked directly by user code: use
	...
	public static Implementation factory = new Implementation()
	{
		...
		{
			// node will support being an ObjectProperty facet if it has
			// rdf:type owl:ObjectProperty or equivalent
	...
	/**
	 * <p>
	 * Answer a property that is an inverse of this property, ensuring that it presents the ObjectProperty facet.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Answer an iterator over all of the properties that are declared to be inverse properties of this property, ensuring that each presents the objectProperty
	 * facet.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Answer the property that is the inverse of this property, ensuring that it presents the object property facet.
	 * </p>
	 * 
