 ...
 * <P>
 * The {@link Model} interface provides a set of primitive operations on an RDF model. This interface extends those methods with a set of convenience methods.
 * </P>
 * <p>
 * This interface provides methods supporting typed literals. This means that methods are provided which will translate a built in type, or an object to an RDF
 * Literal. This translation is done by invoking the <CODE>toString()</CODE> method of the object, or its built in equivalent. The reverse translation is also
 ...
 * </p>
 * <p>
 * This interface provides methods for supporting enhanced resources. An enhanced resource is a resource to which the application has added behaviour. RDF
 * containers are examples of enhanced resources built in to this package. Enhanced resources are supported by encapsulating a resource created by an
 * implementation in another class which adds the extra behaviour. Factory objects are used to construct such enhanced resources.
 * </p>
 */
public interface ModelCon
{
	 ...
	 * </p>
	 * <p>
	 * The resource is assumed to already exist in the model. If it does not, <CODE>createResource</CODE> should be used instead.
	 * </p>
	 * 
	 ...
	 * </p>
	 * <p>
	 * The property is assumed to already exist in the model. If it does not, <CODE>createProperty</CODE> should be used instead.
	 * </p>
	 * 
	 ...
	 * </p>
	 * <p>
	 * The bag is assumed to already exist in the model. If it does not, <CODE>createBag</CODE> should be used instead.
	 * </p>
	 * 
	 ...
	 * </p>
	 * <p>
	 * The alt is assumed to already exist in the model. If it does not, <CODE>createAlt</CODE> should be used instead.
	 * </p>
	 * 
	 ...
	 * </p>
	 * <p>
	 * The bag is assumed to already exist in the model. If it does not, <CODE>createAlt</CODE> should be used instead.
	 * </p>
	 * 
	 * @return an Alt instance
	 * @param r
	 ...
	 * </p>
	 * <p>
	 * The seq is assumed to already exist in the model. If it does not, <CODE>createSeq</CODE> should be used instead.
	 * </p>
	 * 
	 ...
	 * </p>
	 * <p>
	 * The Seq is assumed to already exist in the model. If it does not, <CODE>createAlt</CODE> should be used instead.
	 * </p>
	 * 
	 * @return an Alt instance
	 * @param r
	...
	/**
	 * Create or find an RDFNode (a {@link Resource} or a {@link Literal}) from a graph Node. This is provided for users and developers operating at the API/SPI
	 * interface, where Resources are constructed from Nodes. Providing this method allows each Model the opportunity to cache node-to-resource maps if it
	 * requires.
	 * 
	 * @param n
	 *            the graph.Node on which to base the Model.RDFNode
	 ...
	 * 
	 * <p>
	 * The value is converted to a string using its <CODE>toString</CODE> method.
	 * </p>
	 * 
	 * @param v
	 *            the value of the literal
	 ...
	 * legal except for plain literals. To create a plain literal with a language tag use {@link Model#createLiteral(String, String) createLiteral}.
	 * </p>
	 * 
	 * @param lex
	 ...
	 * @param o
	 *            is the value to be the object of the statement
	 * 
	 ...
	 *            the predicate of the statement to add
	 * @param lex
	 *            the lexcial form of the literal
	 * @param datatype
	...
	/**
	 * remove the statement <code>(s, p, o)</code> from this model and answer this model. None of <code>s, p, o</code> are permitted to be <code>null</code>:
	 * for wildcard removal, see <code>removeAll</code>.
	 */
	...
	/**
	 * Answer a statement iterator that will iterate over all the statements (S, P, O) in this model where S matches <code>subject</code>, P matches
	 * <code>predicate</code>, and O matches the typed literal corresponding to <code>object</code>.
	 */
	 ...
	 * <code>subject</code> argument, whose predicate matches the <code>predicate</code> argument and whose object matchesthe <code>object</code> argument.
	 * </p>
	 * 
	 ...
	 * <p>
	 * Return an iterator over all the statements in a model that match a pattern. The statements selected are those whose subject matches the
	 * <code>subject</code> argument, whose predicate matches the <code>predicate</code> argument and whose object matchesthe <code>object</code> argument. If
	...
	/**
	 * Answer an iterator [without duplicates] over all the resources in this model which have value o' for property p, where o' is the typed literal
	 * corresponding to o.
	 */
	 ...
	 * @param s
	 *            The subject of the statment tested.
	 * @param p
	 *            The predicate of the statement tested.
	 * @param o
