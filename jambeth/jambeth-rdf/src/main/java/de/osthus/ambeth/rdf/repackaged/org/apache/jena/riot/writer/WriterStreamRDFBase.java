...
/**
 * Core engine for output of triples / quads that is streaming. Handles prefixes and base, toegtehr with the environment for processing. If fed only quads, the
 * output is valid TriG. If fed only triples, the output is valid Turtle.
 */
