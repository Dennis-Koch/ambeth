...
public class JenaTransactionException extends JenaException
{
	...
	public JenaTransactionException(String message)
	{
		super(message);
	}

	public JenaTransactionException(Throwable cause)
	{
		super(cause);
	}

	public JenaTransactionException(String message, Throwable cause)
	{
		super(message, cause);
	}
}
