...
/**
 * A base for transaction handlers - all it does is provide the canonical implementation of executeInTransaction.
 */
public abstract class TransactionHandlerBase implements TransactionHandler
{
	...
	/**
	 * Execute the command <code>c</code> within a transaction. If it completes normally, commit the transaction and return the result. Otherwise abort the
	 * transaction and throw a wrapped exception.
	 */
	@Override
