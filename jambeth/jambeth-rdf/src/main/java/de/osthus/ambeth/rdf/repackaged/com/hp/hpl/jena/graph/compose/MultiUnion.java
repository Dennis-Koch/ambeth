...
public class MultiUnion extends Polyadic
{
	...
	/**
	 * Answer true iff we're optimising find and query over unions with a single element.
	 */
	...
	/**
	 * <p>
	 * Add the given triple to the union model; the actual component model to be updated will be the designated (or default) {@linkplain #getBaseGraph
	 * updateable} graph.
	 * </p>
	 * 
	 * @param t
	...
	/**
	 * <p>
	 * Delete the given triple from the union model; the actual component model to be updated will be the designated (or default) {@linkplain #getBaseGraph
	 * updateable} graph.
	 * </p>
	 * 
	 * @param t
	...
	/**
	 * <p>
	 * Answer an iterator over the triples in the union of the graphs in this composition. <b>Note</b> that the requirement to remove duplicates from the union
	 * means that this will be an expensive operation for large (and especially for persistent) graphs.
	 * </p>
	 * 
	 * @param t
	...
	/**
	 * Answer the result of <code>find( t )</code> on the single graph in this union.
	 */
