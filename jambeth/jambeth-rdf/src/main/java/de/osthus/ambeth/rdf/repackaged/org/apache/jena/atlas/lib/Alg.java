...
public class Alg
{
	...
	/*
	 * Both Arrays and Collections have a binary search implementation. Arrays searches Object[] arrays, and Collections searches List<T>
	 * 
	 * But sometime things are not so easy, and it isn't neat as to what is being searched, like a slice of an NIO Buffer
	 * 
