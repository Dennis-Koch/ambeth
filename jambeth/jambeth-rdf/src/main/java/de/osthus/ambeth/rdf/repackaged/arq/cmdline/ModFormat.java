...
import de.osthus.ambeth.rdf.repackaged.arq.cmdline.ArgModuleGeneral;
...
public class ModFormat implements ArgModuleGeneral
{
	...
	static final List<String> formats = Arrays.asList("RDF/XML", "RDF/XML-ABBREV", "N-TRIPLE", "N-TRIPLES", "N3", "N3-PP", "N3-PLAIN", "N3-TRIPLES",
			"N3-TRIPLE", "TURTLE",
			// "Turtle" ,
			"TTL");
}
