...
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.tokens.TokenType.STRING2;
 ...
 * 
 * <ul>
 * <li>The {@link #parse} method processes the whole stream of tokens, sending each to a {@link de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Sink}
 * object.</li>
 * <li>The <tt>Iterator&lt;X&gt;</tt> interface yields triples one-by-one.</li>
 * </ul>
 * 
 * Normally, bad terms causes the parser to stop (i.e. treat them as errors). In addition, the NTuples subsystem allows triples/quads with "bad" terms to be
 * skipped.
 * 
 * Checking can be switched off completely. If the data is known to be correct, no checking can be a large performance gain. <i>Caveat emptor</i>.
 */
