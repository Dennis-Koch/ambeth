...
/**
 * Base implementation for all numeric datatypes derived from xsd:decimal. The only purpose of this place holder is to support the isValidLiteral tests across
 * numeric types. Note that float and double are not included in this set.
 */
public class XSDBaseNumericType extends XSDDatatype
{
	...
	public boolean isEqual(LiteralLabel value1, LiteralLabel value2)
	{
		if (value1.getDatatype() instanceof XSDBaseNumericType && value2.getDatatype() instanceof XSDBaseNumericType)
		{
			...
			// The cannonicalization step should take care of all cross-type
			// cases, leaving
			// us just that equals doesn't work on BigDecimals in the way you
			// expect
