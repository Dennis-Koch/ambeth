...
/**
 * <p>
 * Interface that encapsulates the elements of a general vocabulary corresponding to a particular ontology language. The intent is that, using a given
 * vocabulary, a given RDF model can be processed as an ontology description, without binding knowledge of the vocabulary into this Java package. For
 * tractability, this limits the vocabularies that can easily be represented to those that are similar to OWL and DAML+OIL.
 * </p>
 */
public interface Profile
{
	...
	/**
	 * <p>
	 * Answer the resource that represents the general class of properties. This will typically be <code>rdf:Property</code>.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Answer the resource that represents the class of properties that are <i>functional</i>, i&#046;e&#046; whose range is unique for a given domain element.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Answer the resource that represents the class of properties that are <i>inverse functional</i>, i&#046;e&#046; whose domain is unique for a given range
	 * element.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Answer the resource that represents the class of ontology header elements. Individuals of this class typically associate meta-data about an ontology
	 * document with the classes and properties in the document.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Answer the resource that represents the documentation class of deprecated classes. Belonging to this class is a hint to developers that a given class has
	 * been superceded in a later revision of the ontology.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Answer the resource that represents the documentation class of deprecated properties. Belonging to this class is a hint to developers that a given
	 * property has been superceded in a later revision of the ontology.
	 * </p>
	 * 
	 ...
	 * </p>
	 * 
	 * @return The property that denotes equivalence between two resources denoting individuals.
	 */
	...
	/**
	 * <p>
	 * Answer the predicate that maps from an {@link #ALL_DIFFERENT} axiom to the set of individuals that are pair-wise different from each other.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Answer the predicate that maps from a {@link #RESTRICTION} to a property that it is a restriction on.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * The <code>rdf:type</code> for cells in this list
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Answer an iterator over the properties in this language that are denoted annotation properties. Not all languages have distinguished annotation
	 * properties.
	 * </p>
	 * 
	 ...
	 * @param res
	 *            A resource (including properties) to test for an alias
	 * @return The alias for <code>res</code>, or one of the aliases for <code>res</code> if more than one is defined, or null if no alias is defined for
	 *         <code>res</code>.
	 * 
	 */
	 ...
	 * @return An iterator over the aliases for <code>res</code>. If there are no aliases, the empty iterator is returned.
	 */
