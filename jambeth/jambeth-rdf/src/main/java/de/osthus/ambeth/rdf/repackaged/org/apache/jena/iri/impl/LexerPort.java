 ...
 * <tt>src/main/jflex/org/apache/jena/iri/impl/port.jflex</tt>
 */
class LexerPort extends AbsLexer implements de.osthus.ambeth.rdf.repackaged.org.apache.jena.iri.ViolationCodes,
		de.osthus.ambeth.rdf.repackaged.org.apache.jena.iri.IRIComponents, Lexer
{
	 ...
	 */
	private static final String ZZ_CMAP_PACKED = "\12\0\1\0\45\0\1\2\1\1\10\1\uffc6\0";
	...
	private static final String ZZ_ROWMAP_PACKED_0 = "\0\0\0\3\0\6\0\6\0\6\0\6";
	...
	private static final String ZZ_TRANS_PACKED_0 = "\1\3\1\4\1\5\1\3\1\4\1\6\3\0";
	...
	private static final String ZZ_ATTRIBUTE_PACKED_0 = "\2\0\4\11";
		...
		while (true)
		{
			...
			switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction])
			{
				case 4:
				{
					rule(2);
					if (yychar == 0)
						error(PORT_SHOULD_NOT_START_IN_ZERO);
				}
				case 5:
					break;
				case 3:
