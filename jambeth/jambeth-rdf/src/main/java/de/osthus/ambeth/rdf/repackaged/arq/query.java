...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.logging.LogCtl;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.RiotException;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.SysRIOT;
import de.osthus.ambeth.rdf.repackaged.arq.cmd.CmdException;
import de.osthus.ambeth.rdf.repackaged.arq.cmd.TerminationException;
import de.osthus.ambeth.rdf.repackaged.arq.cmdline.ArgDecl;
import de.osthus.ambeth.rdf.repackaged.arq.cmdline.CmdARQ;
import de.osthus.ambeth.rdf.repackaged.arq.cmdline.ModDataset;
import de.osthus.ambeth.rdf.repackaged.arq.cmdline.ModDatasetGeneralAssembler;
import de.osthus.ambeth.rdf.repackaged.arq.cmdline.ModEngine;
import de.osthus.ambeth.rdf.repackaged.arq.cmdline.ModQueryIn;
import de.osthus.ambeth.rdf.repackaged.arq.cmdline.ModResultsOut;
import de.osthus.ambeth.rdf.repackaged.arq.cmdline.ModTime;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.resultset.ResultSetException;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.resultset.ResultsFormat;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.QueryExecUtils;
...
public class query extends CmdARQ
{
	...
	/**
	 * Default syntax used when the syntax can not be determined from the command name or file extension The order of determination is:
	 * <ul>
	...
	{
		return Syntax.defaultQuerySyntax;
	}
	...
	protected void processModulesAndArgs()
	{
		...
		if (hasArg(argOptimize))
		{
			...
			if (hasValueOfTrue(argOptimize) || x1.equalsIgnoreCase("on") || x1.equalsIgnoreCase("yes"))
				...
				throw new CmdException("Optimization flag must be true/false/on/off/yes/no. Found: " + getValue(argOptimize));
		}
	}
