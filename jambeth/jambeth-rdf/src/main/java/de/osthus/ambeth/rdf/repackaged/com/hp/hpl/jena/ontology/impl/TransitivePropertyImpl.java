...
public class TransitivePropertyImpl extends ObjectPropertyImpl implements TransitiveProperty
{
	...
	/**
	 * A factory for generating TransitiveProperty facets from nodes in enhanced graphs. Note: should not be invoked directly by user code: use
	...
	public static Implementation factory = new Implementation()
	{
		...
		{
			// node will support being an TransitiveProperty facet if it has
			// rdf:type owl:TransitiveProperty or equivalent
