...
public class OWLResults
{
	...
	/**
	 * <p>
	 * The complete system instance on which the test was run, conceptually including software and hardware components. No range restriction is provided,
	 * however, so the details are flexible; providing an rdfs:label and rdfs:comment may be sufficient for many applications.
	 * </p>
	 */
	 ...
	 * href="http://www.w3.org/TR/xmlschema-2/#dateTime">xsd:dateTime</a>.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * The time taken for the test to run (as far as it did run) on the tested system; an <a xmlns="http://www.w3.org/1999/xhtml"
	 * href="http://www.w3.org/TR/xmlschema-2/#duration">xsd:duration</a>. This value depends on many factors, of course, such as the performance of the
	 * hardware components of the tested system. If the system is opaque, these values should only be used for comparison against other tests run on same
	 * system.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * A TestRun where the system's behavior does not pass the test, but also does not fail. Typically this is caused by behaving in a way the system SHOULD
	 * NOT. For OWL tests, returning an UNKNOWN for most tests should be reported as an IncompleteRun.
	 * </p>
	 */
