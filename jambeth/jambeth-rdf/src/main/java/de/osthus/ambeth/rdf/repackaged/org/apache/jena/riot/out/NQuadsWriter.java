...
{
	/**
	 * @deprecated Use {@linkplain RDFDataMgr#write(OutputStream, DatasetGraph, Lang)} with {@code Lang.NQUADS}.
	 */
	@Deprecated
	...
	/**
	 * @deprecated Use {@linkplain RDFDataMgr#write(OutputStream, Dataset, Lang)} with {@code Lang.NQUADS}.
	 */
	@Deprecated
