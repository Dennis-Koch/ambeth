 ...
 * 
 * <pre>
 * java &lt;class-path&gt; de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.arp.NTriple ( [ -[xstfurR]][ -b xmlBase -[eiw] NNN[,NNN...] ] [ file ] [ url ] )...
 * </pre>
 * <p>
 * All options, files and URLs can be intemingled in any order. They are processed from left-to-right.
 * <dl>
 * file </dt>
 * <dd>Converts RDF/XML file into N-triples</dd>
 * <dt>
 * url</dt>
 * <dd>Converts RDF/XML from URL into N-triples</dd>
 * <dt>
 * -b uri</dt>
 * <dd>Sets XML Base to the absolute URI.</dd>
 * <dt>
 * -r</dt>
 * <dd>Content is RDF (default, no embedding, rdf:RDF tag may be omitted).</dd>
 * <dt>
 * -R</dt>
 * <dd>RDF embedded in XML document, search for obligatory rdf:RDF start element.</dd>
 * <dt>
 * -t</dt>
 * <dd>No n-triple output, error checking only.</dd>
 * <dt>
 * -x</dt>
 * <dd>Lax mode - warnings are suppressed.</dd>
 * <dt>
 * -s</dt>
 * <dd>Strict mode - most warnings are errors.</dd>
 * <dt>
 * -u</dt>
 * <dd>Allow unqualified attributes (defaults to warning).</dd>
 * <dt>
 * -f</dt>
 * <dd>All errors are.error - report first one only.</dd>
 * <dt>
 * -n</dt>
 * <dd>Show line numbers of each triple.</dd>
 * <dt>
 * -b url</dt>
 * <dd>Sets XML Base to the absolute url.</dd>
 * <dt>
 * -e NNN[,NNN...]</dt>
 * <dd>
 * Treats numbered warning conditions as errrors.</dd>
 * <dt>
 * -w NNN[,NNN...]</dt>
 * <dd>
 * Treats numbered error conditions as warnings.</dd>
 * <dt>
 * -i NNN[,NNN...]</dt>
 * <dd>
...
public class NTriple implements ARPErrorNumbers
{
	...
	/**
	 * Starts an RDF/XML to NTriple converter, using an error handler, and an ARPHandler. Statements get processed both by this class, and by the passed in
	 * StatementHandler
	 * 
	 * @param args
	 *            The command-line arguments.
	...
	/*
	 * Options: -x Lax, Warnings suppressed -s Strict, Warnings are errors -f All errors are.error. -u Suppress unqualified attribute warnings -t Error checking
	 * only, no n-triple output -b: set xml:base (same for all files?) -e: convert numbered warnings to errors -i: suppress numbered warnings -w: convert
	 * numbered errors/suppressed warnings to warnings -n: give line numbers
	 */
	static void usage()
	{
	...
	private static class SH implements StatementHandler
	{
		...
		public void statement(AResource subj, AResource pred, ALiteral lit)
		{
			...
			lineNumber();
			/*
			 * if (parseType != null) { System.out.print("# "); if (parseType != null) System.out.print("'" + parseType + "'"); System.out.println(); }
			 */
			resource(subj);
			resource(pred);
			literal(lit);
	 ...
	 * 
	 * @param anonymousID
	 *            Is something that corresponds to an XMLName
