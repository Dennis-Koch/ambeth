...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.LabelExistsException;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.ReadWrite;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.shared.Lock;
...
/**
 * A implementation of a Dataset. This is the "usual" implementation based on wrapping a DatasetGraph and providing an adapter layer from Model/Resource to
 * Graph/Node The characteristics of this adapter depend on the characteristics of DatasetGraph.
 */

public class DatasetImpl implements Dataset
{
	/*
	 * We are cautious - SPARQL Update can change the graphs in a store so we assume DatasetGraph.getGraph is efficient and here cut the overhead of model
	 * wrappers.
	 */
