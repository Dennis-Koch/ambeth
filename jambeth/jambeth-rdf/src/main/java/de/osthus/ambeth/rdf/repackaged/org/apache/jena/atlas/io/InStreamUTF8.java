...
public final class InStreamUTF8 extends Reader implements CharStream
{
	...
	/*
	 * http://en.wikipedia.org/wiki/UTF-8 http://tools.ietf.org/html/rfc3629 http://www.ietf.org/rfc/rfc3629.txt
	 * 
	 * Unicode Byte1 Byte2 Byte3 Byte4 U+0000–U+007F 0 to 127 0xxxxxxx U+0080–U+07FF 128 to 2,047 110yyyxx 10xxxxxx U+0800–U+FFFF 2,048 to 65,535 1110yyyy
	 * 10yyyyxx 10xxxxxx U+10000–U+10FFFF 65,536 to 1,114,111 11110zzz 10zzyyyy 10yyyyxx 10xxxxxx
	 * 
	 * Restricted cases (RFC 3629) 11110101-11110111 F5-F7 245-247 start of 4-byte sequence for codepoint above 10FFFF 11111000-11111011 F8-FB 248-251 start of
	 * 5-byte sequence 11111100-11111101 FC-FD 252-253 start of 6-byte sequence
	 * 
	 * Illegal: 11000000-11000001 C0-C1 192-193 Overlong encoding: start of a 2-byte sequence, but code point <= 127 11111110-11111111 FE-FF 254-255 Invalid:
	 * not defined by original UTF-8 specification
	 */
	...
	/**
	 * Next codepoint, given the first byte of any UTF-8 byte sequence is already known. Not necessarily a valid char (this function can be used a straight UTF8
	 * decoder
	 */
	@Override
