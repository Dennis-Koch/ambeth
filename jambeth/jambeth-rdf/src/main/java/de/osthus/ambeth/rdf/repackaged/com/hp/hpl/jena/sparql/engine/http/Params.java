...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.Convert;
...
public class Params
{
	...
	/**
	 * Create a Params object, initialized from another one. A copy is made so the initial values of the Params object are as of the time this constructor was
	 * called.
	 * 
	 * @param other
	 */
	 ...
	 * @param value
	 *            Value - May be null to indicate none - the name still goes.
	 */
