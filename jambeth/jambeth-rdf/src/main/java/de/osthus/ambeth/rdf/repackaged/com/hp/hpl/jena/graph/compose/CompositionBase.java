...
/**
 * <p>
 * Base class for graphs that are composed of multiple sub-graphs. This is to provide a home for shared functionality that was previously in {@link Dyadic}
 * before refactoring.
 * </p>
 */
public abstract class CompositionBase extends GraphBase
{
	/**
	 * <p>
	 * Answer a {@link Filter} that will reject any element that is a member of iterator i. As a side-effect, i will be closed.
	 * </p>
	 * 
	 * @param i
	 *            A closable iterator
	 ...
	 * 
	 * @param a
	 *            An iterator that will be filtered by rejecting the elements of b
	 * @param b
	 *            A closable iterator
	...
	/**
	 * <p>
	 * Answer an iterator that will record every element delived by <code>next()</code> in the set <code>seen</code>.
	 * </p>
	 * 
	 * @param i
	 *            A closable iterator
	...
	/**
	 * Answer an iterator over the elements of <code>i</code> that are not in the graph <code>seen</code>.
	 */
	...
	/**
	 * <p>
	 * Answer a {@link Filter} that will accept any object that is an element of iterator i. As a side-effect, i will be evaluated and closed.
	 * </p>
	 * 
	 * @param i
	 *            A closable iterator
	...
	/**
	 * <p>
	 * Answer a {@link Filter} that will accept any triple that is an edge of graph g.
	 * </p>
	 * 
	 * @param g
	 *            A graph
