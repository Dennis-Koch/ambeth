...
public class Serializer
{
	...
	static public void serializeARQ(Query query, Prologue p, IndentedWriter writer)
	{
		...
		serializeARQ(query, writer, new FormatterElement(writer, cxt1), new FmtExprSPARQL(writer, cxt1), new FmtTemplate(writer, cxt2));
	}

	static void serializeARQ(Query query, IndentedWriter writer, FormatterElement eltFmt, FmtExprSPARQL exprFmt, FormatterTemplate templateFmt)
	{
