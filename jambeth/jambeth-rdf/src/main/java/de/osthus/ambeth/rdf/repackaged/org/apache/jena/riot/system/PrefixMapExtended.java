...
// UNUSED
/**
 * Implementation of a {@link PrefixMap} which extends another prefix map without ever altering the parent.
 * <p>
 * This allows code to modify a prefix map based off of another map without modifying that original map. This is somewhat different than simply making a copy of
 * an existing map since this implementation is partly a view over another map so will reflect changes that happen to the other map.
 * </p>
 */
