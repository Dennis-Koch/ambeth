 ...
 * <ul>
 * <li><b>derivationLogging</b> - if set to true this causes all derivations to be recorded in an internal data structure for replay through the
 * {@link de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.reasoner.InfGraph#getDerivation getDerivation} method.</li>
 * <li><b>traceOn</b> - if set to true this causes all rule firings and deduced triples to be written out to the Logger at INFO level.</li>
 * </ul>
 */
	...
	public Model getCapabilities()
	{
		if (capabilities == null)
		{
			...
			base.addProperty(ReasonerVocabulary.nameP, "OWL BRule Reasoner")
					...
					.addProperty(ReasonerVocabulary.supportsP, OWL.ObjectProperty).addProperty(ReasonerVocabulary.supportsP, OWL.DatatypeProperty)
					.addProperty(ReasonerVocabulary.supportsP, OWL.FunctionalProperty).addProperty(ReasonerVocabulary.supportsP, OWL.SymmetricProperty)
					.addProperty(ReasonerVocabulary.supportsP, OWL.TransitiveProperty).addProperty(ReasonerVocabulary.supportsP, OWL.InverseFunctionalProperty)

					.addProperty(ReasonerVocabulary.supportsP, OWL.hasValue).addProperty(ReasonerVocabulary.supportsP, OWL.intersectionOf)
					.addProperty(ReasonerVocabulary.supportsP, OWL.unionOf)
					// Only partial
					.addProperty(ReasonerVocabulary.supportsP, OWL.minCardinality)
					// Only partial
					.addProperty(ReasonerVocabulary.supportsP, OWL.maxCardinality)
					// Only partial
					.addProperty(ReasonerVocabulary.supportsP, OWL.cardinality)
					// Only partial
					.addProperty(ReasonerVocabulary.supportsP, OWL.someValuesFrom)
					// Only partial
					.addProperty(ReasonerVocabulary.supportsP, OWL.allValuesFrom)
					// Only partial
					.addProperty(ReasonerVocabulary.supportsP, OWL.sameAs).addProperty(ReasonerVocabulary.supportsP, OWL.differentFrom)
