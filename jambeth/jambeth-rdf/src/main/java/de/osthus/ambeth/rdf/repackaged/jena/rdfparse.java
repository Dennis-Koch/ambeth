...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.rdf.arp.NTriple;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.shared.Command;
 ...
 * 
 * <p>
 * The last two forms are for testing. <code>--test</code> runs ARP against the RDF Core Working Group tests found at w3.org. <code>--internal-test</code> uses
 * a cached copy from within the jena.jar.
 * </p>
 * All options, files and URLs can be intemingled in any order. They are processed from left-to-right.
 * <dl>
 * file </dt>
 * <dd>Converts (embedded) RDF in XML file into N-triples</dd>
 * <dt>
 * url</dt>
 * <dd>Converts (embedded) RDF from URL into N-triples</dd>
 * <dt>
 * -b uri</dt>
 * <dd>Sets XML Base to the absolute URI.</dd>
 * <dt>
 * -r</dt>
 * <dd>Content is RDF (no embedding, rdf:RDF tag may be omitted).</dd>
 * <dt>
 * -t</dt>
