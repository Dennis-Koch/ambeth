...
package de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.n3.turtle.parser;

import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.n3.turtle.ParserBase;
...
public class TurtleParser extends ParserBase implements TurtleParserConstants
{
	...
	final public Node Verb() throws ParseException
	{
		...
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk)
		{
			...
			case EQ:
				...
				p = nOwlSameAs;
				if (strictTurtle)
					throwParseException("= (owl:sameAs) not legal in Turtle", token.beginLine, token.beginColumn);
				break;
			case ARROW:
				jj_consume_token(ARROW);
				p = nLogImplies;
				if (strictTurtle)
					throwParseException("=> (log:implies) not legal in Turtle", token.beginLine, token.beginColumn);
				break;
			default:
				jj_la1[9] = jj_gen;
				jj_consume_token(-1);
	...
	final public Node Collection() throws ParseException
	{
		...
		label_4: while (true)
		{
			...
			if (listHead == nRDFnil)
				listHead = cell;
			if (lastCell != null)
				emitTriple(token.beginLine, token.beginColumn, new Triple(lastCell, nRDFrest, cell));
			n = GraphNode();
			emitTriple(token.beginLine, token.beginColumn, new Triple(cell, nRDFfirst, n));
			lastCell = cell;
			switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk)
			{
				case TRUE:
		...
		if (lastCell != null)
			emitTriple(token.beginLine, token.beginColumn, new Triple(lastCell, nRDFrest, nRDFnil));
		{
			if (true)
				return listHead;
		}
	...
	{
		jj_la1_0 = new int[] { 0x0, 0xde1fc000, 0xde1fc000, 0xc000, 0xde1f0000, 0xc0002000, 0x0, 0xc0002000, 0x0, 0xc0002000, 0x0, 0xde1f0000, 0xde1f0000,
				0xde1f0000, 0x0, 0xde1f0000, 0xde1f0000, 0x1c0000, 0xc000, 0xc000, 0xc000, 0xc000, 0x30000, 0x1e000000, 0xc0000000, 0x80000000, 0x0, };
	}

	private static void jj_la1_init_1()
	{
		jj_la1_1 = new int[] { 0x4000000, 0x2b47, 0x2b47, 0x0, 0x2b47, 0x60001, 0x4000, 0x60001, 0x8000, 0x60001, 0x840, 0x2b47, 0x2b47, 0x2307, 0x10000,
				0x2b47, 0x2103, 0x0, 0x8000008, 0x8000008, 0x8, 0x0, 0x0, 0x0, 0x1, 0x1, 0x2002, };
	}
