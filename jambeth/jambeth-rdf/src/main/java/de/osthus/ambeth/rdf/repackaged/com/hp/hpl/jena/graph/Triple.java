...
/**
 * Triples are the basis for RDF statements; they have a subject, predicate, and object field (all nodes) and express the notion that the relationship named by
 * the predicate holds between the subject and the object.
 */
public class Triple implements TripleMatch
{
	...
	/**
	 * Answer true if <code>o</code> is a Triple with the same subject, predicate, and object as this triple.
	 */
	@Override
	...
	/**
	 * Return the munged hashCodes of the specified nodes, an exclusive-or of the slightly-shifted component hashcodes; this means (almost) all of the bits
	 * count, and the order matters, so (S @P O) has a different hash from (O @P S), etc.
	 */
