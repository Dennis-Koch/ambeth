...
public class XSD
{
	...
	static
	{
		...
		// ENTITIES =
		// ResourceFactory.createResource(XSDDatatype.XSDENTITIES.getURI());
		// NMTOKENS =
		// ResourceFactory.createResource(XSDDatatype.XSDNMTOKENS.getURI());
		// IDREFS =
		// ResourceFactory.createResource(XSDDatatype.XSDIDREFS.getURI());
	}
}
