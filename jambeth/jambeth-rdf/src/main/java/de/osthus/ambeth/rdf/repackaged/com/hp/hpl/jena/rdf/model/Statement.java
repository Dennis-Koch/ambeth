...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.util.iterator.Map1;
 ...
 * 
 * <p>
 * A statement instance tracks which model created it, if any. All the Resource components of a Statement are in the same model as the Statement, if it has one,
 * and are in no model if the Statement isn't.
 * </p>
 * 
 * <p>
...
public interface Statement extends FrontsTriple
{
	 ...
	 * 
	 * <p>
	 * Two statements are considered to be equal if they have the the same subject, predicate and object. A statement can only be equal to another statement
	 * object.
	 * </p>
	 * 
	 ...
	 * 
	 * <p>
	 * There is an unfortunate ambiguity here. GetProperty would normally treat the statement as a resource, and return a property about this statement. This is
	 * not what is wanted in most cases, so getProperty on a statement is defined to call getProperty on its object. If a property of the statement itself is
	 * required, getStatementProperty should be used.
	 * </p>
	 * 
	 * <p>
	 ...
	 *            the property sought
	 * 
	 * @return a statement representing an instance of the required property
	 */
	 ...
	 * 
	 * <p>
	 * The model associated with this statement is searched for a statement with this statement as subject and the specified property as predicate. If such a
	 * statement is found it is return. If more than one exists in the model, then it is undefined which is returned. If no such statement exists, an exception
	 * is thrown.
	 * </p>
	 * 
	 * @param p
	 *            the property sought
	 * 
	 * @return a statement representing an instance of the specified property.
	 */
	 ...
	 * </p>
	 * 
	 * @return The object of the statement interpreted as a value of the the specified type.
	 */
	...
	/**
	 * Answer true iff the Literal object of this statement is well-formed XML (ie equivalent to getLiteral().isWellFormedXML()). If the object is not a
	 * Literal, throw an exception.
	 */
	public boolean hasWellFormedXML();

	/**
	 * Remove this statement (s, p, x) from the model that contains it. Create a new statement (s, p, o'), where o' is the typed literal corresponding to o, add
	 * it to the model, and answer it.
	 */
	...
	/**
	 * answer a ReifiedStatement object that embodies this Statement, has the same Model, and has the given <code>uri</code>.
	 */
