...
public abstract class IRIResolver
{
	...
	/**
	 * Resolve a URI against a base. If baseStr is a relative file IRI then it is first resolved against the current working directory.
	 * 
	 * @param relStr
	 * @param baseStr
	...
	/**
	 * Resolve an IRI against whatever is the base for this process (likely to be based on the current working directory of this process at the time of
	...
	static class IRIResolverSync extends IRIResolver
	{
		...
		@Override
		synchronized protected IRI getBaseIRI()
		{
			return other.getBaseIRI();
		}

		@Override
		synchronized public IRI resolve(String uriStr)
		{
			return other.resolve(uriStr);
		}

		@Override
		synchronized public IRI resolveSilent(String uriStr)
		{
