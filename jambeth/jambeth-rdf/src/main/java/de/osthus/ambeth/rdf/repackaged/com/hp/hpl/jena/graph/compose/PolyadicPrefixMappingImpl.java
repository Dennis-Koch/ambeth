...
public class PolyadicPrefixMappingImpl extends PrefixMappingImpl implements PrefixMapping
{
	...
	/**
	 * Add the bindings in the map to our own. This will fail with a ClassCastException if any key or value is not a String; we make no guarantees about order
	 * or completeness if this happens. It will fail with an IllegalPrefixException if any prefix is illegal; similar provisos apply.
	 * 
	 * @param other
