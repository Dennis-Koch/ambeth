...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Bytes;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Cache;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.CacheFactory;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.InternalErrorException;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.cache.Getter;
 ...
 * <p>
 * New allocators must be created per parser run, or .reset() called. These are fed to a digest to give a bit string, (currently MD5, to get a 128bit bit
 * string) that is used to form a bNode AnonId of hex digits.
 * <p>
 * In addition there is a cache of label->node allocations, using the natural tendency to locality in a database dump. (subject bNodes, bNodes in lists and
 * other data values structures like unit values).
 * <p>
 * Not thread safe.
 */
...
public class BlankNodeAllocatorHash implements BlankNodeAllocator
{
	 ...
	 * <p>
	 * Note that this is called almost immediately by the constructor and on this initial call you will not yet have access to any implementation specific
	 * information used to select the seed.
	 * </p>
	 * <p>
	 * Implementations <strong>must</strong> return a non-null value so if you can't decide a seed prior to seeing your derived implementations constructor
	 * inputs you should return a temporary fake value initially. You can then call {@link #reset()} in your own constructor after you've taken the necessary
	 * steps that allow you to decide how to generate your own seed.
	 * </p>
	 * 
	 * @return Seed value
	 */
