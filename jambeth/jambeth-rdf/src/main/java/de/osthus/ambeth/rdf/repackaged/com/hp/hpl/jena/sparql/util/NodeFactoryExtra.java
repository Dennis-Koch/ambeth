...
public class NodeFactoryExtra
{
	 ...
	 *            Node string to parse
	 * @param pmap
	 *            Prefix Map, null to use no prefix mappings
	 * @return Parsed Node
	...
	public static Node createLiteralNode(String lex, String lang, String datatypeURI)
	{
		...
		Node n = de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.NodeFactory.createLiteral(lex, lang, dType);
		return n;
	}
	...
	{
		return de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.NodeFactory.createLiteral(Integer.toString(integer), "", XSDDatatype.XSDinteger);
	}

	public static Node intToNode(long integer)
	{
		return de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.NodeFactory.createLiteral(Long.toString(integer), "", XSDDatatype.XSDinteger);
	}

	public static Node floatToNode(float value)
	{
		return de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.NodeFactory.createLiteral(Float.toString(value), "", XSDDatatype.XSDfloat);
	}

	public static Node doubleToNode(double value)
	{
		return de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.NodeFactory.createLiteral(Double.toString(value), "", XSDDatatype.XSDdouble);
	}

	public static Node dateTimeToNode(Calendar c)
	{
		String lex = Utils.calendarToXSDDateTimeString(c);
		return de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.NodeFactory.createLiteral(lex, null, XSDDatatype.XSDdateTime);
	}

	public static Node dateToNode(Calendar c)
	{
		String lex = Utils.calendarToXSDDateString(c);
		return de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.NodeFactory.createLiteral(lex, null, XSDDatatype.XSDdate);
	}

	public static Node timeToNode(Calendar c)
	{
		String lex = Utils.calendarToXSDTimeString(c);
		return de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.NodeFactory.createLiteral(lex, null, XSDDatatype.XSDtime);
	}
