...
public class TransitiveEngine
{
	 ...
	 * 
	 * @param subClassCache
	 *            pre-initialized subclass TGC
	 * @param subPropertyCache
	 ...
	 * @param newData
	 *            a dataset to be added to the engine, not known to be already included in the caches from construction time
	...
	public Finder insert(Finder baseData, FGraph newData)
	{
		...
		if ((TransitiveEngine.checkOccuranceUtility(subPropertyOf, newDataG, subPropertyCache) || TransitiveEngine.checkOccuranceUtility(subClassOf, newDataG,
				subPropertyCache)))
		{
	 ...
	 * 
	 * @param cacheSP
	 *            true if caching of subPropertyOf closure is wanted
	 * @param cacheSC
	...
	/**
	 * Caches all subClass declarations, including those that are defined via subProperties of subClassOf. Public to allow other reasoners to use it but not of
	 * interest to end users.
	 * 
	 * @param graph
	 *            a graph whose declarations are to be cached
	 * @param spCache
	 *            the existing state of the subPropertyOf cache
	 * @param scCache
	...
	/**
	 * Test if there are any usages of prop within the given graph. This includes indirect usages incurred by subProperties of prop. Public to allow other
	 * reasoners to use it but not of interest to end users.
	 * 
	 * @param prop
	 *            the property to be checked for
	 * @param graph
	...
	/**
	 * Caches all subPropertyOf declarations, including any meta level ones (subPropertyOf subPropertyOf). Public to allow other reasoners to use it but not of
	 * interest to end users.
	 * 
	 * @param graph
	 *            a graph whose declarations are to be cached
