...
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.iterator.Iter.take;
...
/**
 * Connect a DatasetGraph to a DatasetChanges monitor. Any add or delete to the DatasetGraph is notified to the monitoring object with a {@linkplain QuadAction}
 * to indicate the change made.
 */
...
public class DatasetGraphMonitor extends DatasetGraphWrapper
{
	...
	/**
	 * Create a DatasetGraph wrapper that monitors the dataset for changes (add or delete quads). Use this DatasetGraph for all operations in order to record
	 * changes. Note whether additions of deletions cause an actual change to the dataset or not.
	 * 
	 * @param dsg
	 *            The DatasetGraph to monitor
	 * @param monitor
	 ...
	 *            If true, check to see if the chnage would have an effect (e.g. add is a new quad). If false, log changes as ADD/DELETE regardless of whether
