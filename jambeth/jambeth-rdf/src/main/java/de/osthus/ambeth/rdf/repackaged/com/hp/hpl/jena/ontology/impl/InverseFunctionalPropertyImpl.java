...
public class InverseFunctionalPropertyImpl extends ObjectPropertyImpl implements InverseFunctionalProperty
{
	...
	/**
	 * A factory for generating InverseFunctionalProperty facets from nodes in enhanced graphs. Note: should not be invoked directly by user code: use
	...
	public static Implementation factory = new Implementation()
	{
		...
		public EnhNode wrap(Node n, EnhGraph eg)
		{
			...
			{
				throw new ConversionException("Cannot convert node " + n
						+ " to InverseFunctionalProperty - it must have rdf:type owl:InverseFunctionalProperty or equivalent");
			}
		}
		...
		{
			// node will support being an InverseFunctionalProperty facet if it
			// has rdf:type owl:InverseFunctionalProperty or equivalent
