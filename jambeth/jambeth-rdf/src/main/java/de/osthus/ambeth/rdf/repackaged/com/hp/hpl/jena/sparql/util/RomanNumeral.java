 ...
 * <li><a href="http://www.therobs.com/uman/roman.shtml">Therobs Lex &amp; Yacc Example: Roman Numerals</a> which is were the idea of working right to left,
 * instead of looking ahead, originated for me.</li>
 * </ul>
 */
...
class RValue
{
	static RValue[] table = new RValue[] { new RValue('M', 1000), new RValue('D', 500), new RValue('C', 100), new RValue('L', 50), new RValue('X', 10),
			new RValue('V', 5), new RValue('I', 1) };
