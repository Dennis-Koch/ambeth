...
public class CharacterModel
{
	...
	/*
	 * Does this string start with a composing character as defined by the <a href="http://www.w3.org/TR/charmod"> Character Model 2nd Last Call Working
	 * Draft</a>.
	 * 
	...
	/**
	 * Is this string fully normalized as defined by the <a href="http://www.w3.org/TR/charmod"> Character Model 2nd Last Call Working Draft</a>.
	 * 
	 * @param str
	 *            The string to be tested.
	 */
	...
	/**
	 * Is the character a composing character as defined by the <a href="http://www.w3.org/TR/charmod"> Character Model 2nd Last Call Working Draft</a>.
	 * 
	 * @param x
	...
	/*
	 * Replacing icu4j function for non-zero combining class Data from {@link http://unicode.org/cldr/utility/list-unicodeset.jsp?a=%5B:
	 * Canonical_Combining_Class!=0:%5D}
	 */
	private static boolean isCombining(int c)
	{
		...
		if (c >= 0x0300 && c <= 0x034E)
			return true;
		if (c >= 0x0350 && c <= 0x036F)
			return true;
		if (c >= 0x0483 && c <= 0x0487)
			return true;
		...
		if (c >= 0x06EA && c <= 0x06ED)
			return true;
		if (c >= 0x0730 && c <= 0x074A)
			return true;
		if (c >= 0x07EB && c <= 0x07F3)
			return true;
		if (c >= 0x0816 && c <= 0x0819)
			return true;
		if (c >= 0x081B && c <= 0x0823)
			return true;
		if (c >= 0x0825 && c <= 0x0827)
			return true;
		if (c >= 0x0829 && c <= 0x082D)
			return true;
		if (c >= 0x0859 && c <= 0x085B)
			return true;
		if (c >= 0x0951 && c <= 0x0954)
			return true;
		if (c >= 0x0E38 && c <= 0x0E3A)
			return true;
		if (c >= 0x0E48 && c <= 0x0E4B)
			return true;
		if (c >= 0x0EC8 && c <= 0x0ECB)
			return true;
		if (c >= 0x0F7A && c <= 0x0F7D)
			return true;
		if (c >= 0x0F82 && c <= 0x0F84)
			return true;
		if (c >= 0x135D && c <= 0x135F)
			return true;
		if (c >= 0x1939 && c <= 0x193B)
			return true;
		if (c >= 0x1A75 && c <= 0x1A7C)
			return true;
		if (c >= 0x1B6B && c <= 0x1B73)
			return true;
		if (c >= 0x1CD0 && c <= 0x1CD2)
			return true;
		if (c >= 0x1CD4 && c <= 0x1CE0)
			return true;
		if (c >= 0x1CE2 && c <= 0x1CE8)
			return true;
		if (c >= 0x1DC0 && c <= 0x1DE6)
			return true;
		if (c >= 0x1DFC && c <= 0x1DFF)
			return true;
		if (c >= 0x20D0 && c <= 0x20DC)
			return true;
		if (c >= 0x20E5 && c <= 0x20F0)
			return true;
		...
		if (c >= 0xA8E0 && c <= 0xA8F1)
			return true;
		if (c >= 0xA92B && c <= 0xA92D)
			return true;
		if (c >= 0xAAB2 && c <= 0xAAB4)
			return true;
		if (c >= 0xFE20 && c <= 0xFE26)
			return true;
		if (c >= 0x00010A38 && c <= 0x00010A3A)
			return true;
		if (c >= 0x0001D165 && c <= 0x0001D169)
			return true;
		if (c >= 0x0001D16D && c <= 0x0001D172)
			return true;
		if (c >= 0x0001D17B && c <= 0x0001D182)
			return true;
		if (c >= 0x0001D185 && c <= 0x0001D18B)
			return true;
		if (c >= 0x0001D1AA && c <= 0x0001D1AD)
			return true;
		if (c >= 0x0001D242 && c <= 0x0001D244)
			return true;
	...
	/*
	 * static public void main(String args[]) { int ch = Integer.parseInt(args[0],16); System.out.println(UCharacter.getCombiningClass(ch)); }
	 */
}
