...
package de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.modify;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.http.HttpParams;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.http.Params;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.http.QueryEngineHTTP;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.http.Service;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.update.UpdateProcessor;
...
public abstract class UpdateProcessRemoteBase implements UpdateProcessor
{
	 ...
	 * <p>
	 * Generated string will not include leading ? so that consuming code can decide whether to add this themselves since the generated query string may be
	 * being used in addition to an existing query string.
	 * </p>
	 * 
	 ...
	 * <p>
	 * May be better to use {@link #setAuthenticator(HttpAuthenticator)} as that allows for more complex authentication to be used
	 * </p>
	 * 
	 * @param username
	 *            User name
	 ...
	 * <p>
	 * Note that you can globally set an authenticator via {@link HttpOp#setDefaultAuthenticator(HttpAuthenticator)} to avoid the need to set authentication on
	 * a per-request basis
	 * </p>
	 * 
	 * @param authenticator
	 ...
	 * <p>
	 * If no authenticator is used then the default authenticator will be used, this can be configured via the
