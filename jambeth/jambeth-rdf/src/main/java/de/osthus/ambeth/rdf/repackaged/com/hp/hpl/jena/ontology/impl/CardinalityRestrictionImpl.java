...
public class CardinalityRestrictionImpl extends RestrictionImpl implements CardinalityRestriction
{
	...
	/**
	 * A factory for generating CardinalityRestriction facets from nodes in enhanced graphs. Note: should not be invoked directly by user code: use
	...
	public static Implementation factory = new Implementation()
	{
		...
		{
			// node will support being a CardinalityRestriction facet if it has
			// rdf:type owl:Restriction or equivalent
			// and the combination of owl:onProperty and owl:cardinality (or
			// equivalents)
	...
	/**
	 * <p>
	 * Assert that this restriction restricts the property to have the given cardinality. Any existing statements for <code>cardinality</code> will be removed.
	 * </p>
	 * 
	 * @param cardinality
	 *            The cardinality of the restricted property
	 * @exception ProfileException
	 *                If the {@link Profile#CARDINALITY()} property is not supported in the current language profile.
	 */
	@Override
