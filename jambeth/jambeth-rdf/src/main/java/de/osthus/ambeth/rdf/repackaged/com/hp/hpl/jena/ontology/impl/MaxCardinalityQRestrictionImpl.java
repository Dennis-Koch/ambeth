...
public class MaxCardinalityQRestrictionImpl extends QualifiedRestrictionImpl implements MaxCardinalityQRestriction
{
	...
	/**
	 * A factory for generating QualifiedRestriction facets from nodes in enhanced graphs. Note: should not be invoked directly by user code: use
	...
	{
		// node will support being a QualifiedRestriction facet if it has
	...
	/**
	 * <p>
	 * Assert that this restriction restricts the property to have the given max cardinality. Any existing statements for <code>cardinalityQ</code> will be
	 * removed.
	 * </p>
	 * 
	 * @param cardinality
