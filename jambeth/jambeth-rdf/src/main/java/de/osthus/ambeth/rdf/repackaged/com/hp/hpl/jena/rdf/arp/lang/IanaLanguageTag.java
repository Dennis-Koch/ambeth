...
/**
 * Language codes registered by IANA. An encapsulation of the IANA language registry found at <a href=" http://www.iana.org/assignments/language-tags">
 * http://www.iana.org/assignments/language-tags</a>.
 * 
 * The values were updated on 8th July 2002 from a file dated 7th July 2002.
 */
public class IanaLanguageTag extends LanguageTag
{
	...
	static public IanaLanguageTag find(LanguageTag t)
	{
		...
		if (matches == null)
			return null;
		nextMatch: for (IanaLanguageTag matche : matches)
		{
