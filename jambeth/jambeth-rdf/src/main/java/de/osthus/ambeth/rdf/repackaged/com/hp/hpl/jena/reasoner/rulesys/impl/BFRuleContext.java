...
/**
 * An implementation of the generic RuleContext interface used by the basic forward (BF) rule engine. This provides additional methods specific to the
...
public class BFRuleContext implements RuleContext
{
	 ...
	 * <p>
	 * This is needed to prevent concurrrent modification exceptions which searching the deductions for matches to a given rule.
	 */
	@Override
	...
	{
		// Can't use stackCache.contains because that does not do semantic
		// equality
	...
	/**
	 * In some formulations the context includes deductions that are not yet visible to the underlying graph but need to be checked for. However, currently this
	 ...
	 * 
	 * @param newSize
	 *            the number of variables needed for processing the new rule
	 */
