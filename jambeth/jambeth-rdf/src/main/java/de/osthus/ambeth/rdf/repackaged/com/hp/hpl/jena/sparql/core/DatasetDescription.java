...
public class DatasetDescription
{
	...
	/**
	 * Create a dataset description, given a context. If the context does not have a dataset description, return null. The context uses the key
	 * {@link ARQConstants#sysDatasetDescription}.
	 */
	...
	/**
	 * Create a dataset description, given a query and context. The context overrides the query FROM/FROM NAMED. If neither the context nor query has a dataset
	 * description, return null. The context uses the key {@link ARQConstants#sysDatasetDescription}.
	 */
	...
	{
		return defaultGraphURIs.iterator();
	}

	public Iterator<String> eachNamedGraphURI()
	{
		return namedGraphURIs.iterator();
	}
