...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.shared.NotFoundException;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.algebra.Algebra;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.algebra.Op;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.algebra.Table;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.path.Path;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.serializer.SerializationContext;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.sse.builders.*;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.sse.lang.ParseHandler;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.sse.lang.ParseHandlerPlain;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.sse.lang.ParseHandlerResolver;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.sse.lang.SSE_Parser;
...
public class SSE
{
	...
	{
		return readGraph(filename, null);
	}
	...
	{
		return parseDatasetGraph(string, null);
	}
	...
	{
		return readDatasetGraph(filename, null);
	}
	...
	{
		readDatasetGraph(dsg, filename, null);
	}
	...
	{
		return readTable(filename, null);
	}
	...
	{
		write(IndentedWriter.stdout, dataset);
		IndentedWriter.stdout.flush();
	}
	...
	{
		write(IndentedWriter.stdout, pattern);
		IndentedWriter.stdout.flush();
	}

	public static void write(IndentedWriter out, BasicPattern pattern)
	{
		write(IndentedWriter.stdout, pattern, null);
		IndentedWriter.stdout.flush();
	}
