...
/**
 * listEntry(?list, ?index, ?val) will bind ?val to the ?index'th entry in the RDF list ?list. If there is no such entry the variable will be unbound and the
 * call will fail. Only useable in rule bodies.
 */
public class ListEntry extends BaseBuiltin
{
	 ...
	 * @param context
	 *            the context through which the data values can be found
