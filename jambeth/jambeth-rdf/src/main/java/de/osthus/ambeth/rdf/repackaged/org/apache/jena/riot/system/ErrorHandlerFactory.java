...
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.SysRIOT.fmtMessage;
...
public class ErrorHandlerFactory
{
	...
	public static ErrorHandler errorHandlerStrict(Logger log)
	{
		return new ErrorHandlerStrict(log);
	}

	public static ErrorHandler errorHandlerStd(Logger log)
	{
		return new ErrorHandlerStd(log);
	}

	public static ErrorHandler errorHandlerNoWarnings(Logger log)
	{
		return new ErrorHandlerNoWarnings(log);
	}

	public static ErrorHandler errorHandlerWarning(Logger log)
	{
		return new ErrorHandlerWarning(log);
	}
