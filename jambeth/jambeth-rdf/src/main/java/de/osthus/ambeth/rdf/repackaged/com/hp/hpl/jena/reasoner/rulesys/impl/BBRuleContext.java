...
/**
 * Implementation of RuleContext for use in the backward chaining interpreter. The RuleContext allows builtin predicates to interpret variable bindings to
 * access the static triple data.
 */
public class BBRuleContext implements RuleContext
{
	...
	/**
	 * @see de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.reasoner.rulesys.RuleContext#contains(de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.Node,
	 *      de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.Node, de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.Node)
	 */
	@Override
	...
	/**
	 * @see de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.reasoner.rulesys.RuleContext#contains(de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.Triple)
	 */
	@Override
	...
	/**
	 * @see de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.reasoner.rulesys.RuleContext#find(de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.Node,
	 *      de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.Node, de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.Node)
	 */
	@Override
	...
	/**
	 * @see de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.reasoner.rulesys.RuleContext#getEnv()
	 */
	@Override
	...
	/**
	 * @see de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.reasoner.rulesys.RuleContext#getGraph()
	 */
	@Override
	...
	/**
	 * @see de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.reasoner.rulesys.RuleContext#getRule()
	 */
	@Override
	public Rule getRule()
	{
	...
	/**
	 * @see de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.reasoner.rulesys.RuleContext#setRule(de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.reasoner.rulesys.Rule)
	 */
	@Override
	...
	/**
	 * Assert a new triple in the deduction graph, triggering any consequent processing as appropriate. In the backward case there no immediate consequences so
	 * this is equivalent to a silentAdd.
	 */
	@Override
	...
	/**
	 * Retrieve or create a bNode representing an inferred property value. This is currently only available on backward contexts and not part of the normal
