...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.resultset.ResultSetMem;

public class ResultSetUtils
{
	/**
	 * Extracts a List filled with the binding of selectElement variable for each query solution as RDFNodes (Resources or Literals). Exhausts the result set.
	 * Create a rewindable one to use multiple times.
	 * 
	 * @see de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.ResultSetFactory
	 */
	...
	/**
	 * Extracts a List filled with the binding of selectElement variable for each query solution, turned into a string (URIs or lexical forms). Exhausts the
	 * result set. Create a rewindable one to use multiple times.
	 * 
	 * @see de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.ResultSetFactory
	 */
