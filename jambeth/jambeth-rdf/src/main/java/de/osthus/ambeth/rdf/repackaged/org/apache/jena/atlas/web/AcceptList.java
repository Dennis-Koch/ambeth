...
public class AcceptList
{
	...
	/**
	 * Find the best thing in offer list 8sever side) matching the proposal (client, Accept header). "best" means highest q value, with left most being better
	 * for same q.
	 * 
	 * @param proposalList
	 *            Client list of possibilities
	 * @param offerList
	 *            Server list of possibilities
	 * @return MediaType
	 */
