...
/**
 * <p>
 * Improved optimization for {@code ORDER BY} plus {@code DISTINCT} or {@code REDUCED} combinations, see JENA-441 for original proposal and discussion.
 * </p>
 * <p>
 * This optimization is enabled by default as with most ARQ optimizations and may be disabled by setting the symbol {@link ARQ#optOrderByDistinctApplication} to
 * false.
 * </p>
 ...
 * </p>
 * <ul>
 * <li>Uses both {@code ORDER BY} and {@code DISTINCT} or {@code REDUCED} on the same level of the query</li>
 * <li>There is a fixed list of variables to project i.e. not {@code SELECT *}</li>
 * <li>{@code ORDER BY} conditions only use variables present in the project list</li>
 * </ul>
 * <p>
 ...
 * </pre>
 * <p>
 * In the general case this in unsafe because it would change the semantics of the query since {@code ORDER BY} can access variables that are not projected.
 * However if the conditions outlined are met then this optimization is safe, the algebras will be semantically equivalent and the resulting form likely
 * significantly more performant, of course YMMV depending on how much data you are querying.
 * </p>
 */
