...
/**
 * <p>
 * Interface representing the ontology abstraction for a qualified minimum cardinality restriction. A qualified restriction is a DAML+OIL term for a restriction
...
public interface MinCardinalityQRestriction extends QualifiedRestriction
{
	...
	/**
	 * <p>
	 * Assert that this restriction restricts the property to have the given minimum cardinality. Any existing statements for <code>minCardinalityQ</code> will
	 * be removed.
	 * </p>
	 * 
	 ...
	 *                If the {@link Profile#MIN_CARDINALITY_Q()} property is not supported in the current language profile.
	 */
	...
	/**
	 * <p>
	 * Remove the statement that this restriction has the given minimum qualified cardinality for the restricted property. If this statement is not true of the
