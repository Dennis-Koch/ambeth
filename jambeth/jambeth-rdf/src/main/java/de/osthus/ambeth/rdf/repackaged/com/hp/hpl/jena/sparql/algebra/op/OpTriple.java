...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.Iso;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.util.NodeIsomorphismMap;

/**
 * Algebra operation for a single triple. Not normally used - triples are contained in basic graph patterns (which is the unit of extension in SPARQL, and also
 * the unit for adapting to other data store in ARQ). But for experimentation, it can be useful to have a convenience direct triple access.
 * 
 * @see OpBGP
 */
