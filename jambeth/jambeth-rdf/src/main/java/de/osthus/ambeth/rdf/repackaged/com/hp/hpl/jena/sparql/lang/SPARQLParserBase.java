...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.modify.request.QuadAcc;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.modify.request.QuadDataAccSink;
...
public class SPARQLParserBase extends ParserBase
{
	...
	{
		return (BindingMap) values.get(values.size() - 1);
	}
