...
public class DatasetGraphWrapper implements DatasetGraph, Sync
{
	...
	/**
	 * The dataset to use for redirection - can be overridden. It is also guarantee that this is called only once per delegated call. Changes to the wrapped
	 * object can be made based on that contract.
	 */
