...
public abstract class AbstractProfile implements Profile
{
	 ...
	 * 
	 * @param g
	 *            an enhanced graph to search for triples
	 * @param n
	 *            some node
	 * @param p
	 *            a property containing a predicate node
	...
	/**
	 * Answer a table of binary mappings denoting that one resource is the alias for another (for example rdfs:Class).
	 */
	...
	protected OneToManyMap<Resource, Resource> aliasMap()
	{
		if (m_aliasesMap == null)
		{
			...
			{
				// since alias relationship is symmetric, we record both
				// directions
