...
/**
 * Reasoner implementation which augments or transforms an RDF graph according to a set of rules. The rules are processed using a tabled LP backchaining
 * interpreter which is implemented by the relvant InfGraph class.
 */
