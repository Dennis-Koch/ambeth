...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.lang.SPARQLParser;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.lang.ParserARQ;
...
public class QueryFactory
{
	...
	/**
	 * Make a query from another one by deep copy (a clone). The returned query will be .equals to the original. The returned query can be mutated without
	 * changing the original (at which point it will stop being .equals)
	 * 
	 * @param originalQuery
	 *            The query to clone.
	 * 
	 ...
	 * 
	 * @param query
	 *            Existing, uninitialized query
	 * @param queryString
	 *            The query string
	 * @param baseURI
	 *            URI for relative URI expansion
	 * @param syntaxURI
	 *            URI for the syntax
	 * @throws QueryException
	 *             Thrown when a parse error occurs
