...
/**
 * Writes out RDF in the abbreviated syntax, for human consumption not only machine readable. It is not normal to call the constructor directly, but to use the
 * method RDFWriterF.getWriter("RDF/XML-ABBREV"). Does not support the <code>NSPREFIXPROPBASE</code> system properties. Use <code>setNsPrefix</code> . For best
 * results it is necessary to set the property <code>"prettyTypes"</code>. See setProperty for information.
 * 
 * @see de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.rdf.model.RDFWriterF#getWriter(String)
 */
public class Abbreviated extends BaseXMLWriter implements RDFErrorHandler
{

	private Resource types[] = new Resource[] { OWL.Ontology,
			// OWL.DataRange, named or orphaned dataranges unusual.
			RDFS.Datatype, RDFS.Class, OWL.Class, OWL.ObjectProperty, RDF.Property, OWL.DatatypeProperty, OWL.TransitiveProperty, OWL.SymmetricProperty,
	...
	protected void blockRule(Resource r)
	{
		...
		// sResourcePropertyElt=true;
			...
			sParseTypeCollectionPropertyElt = true;
