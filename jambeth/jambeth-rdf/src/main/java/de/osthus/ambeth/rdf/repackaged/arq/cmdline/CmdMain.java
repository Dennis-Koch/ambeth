 ...
 * 
 * Usage: new YourCommand(args).mainAndExit() which never returns and routes thing to System.exit. or call new YourCommand(args).mainMethod() which should not
 * call System.exit anywhere
 */
