...
/**
 * Factory class for creating {@link FRuleEngineI}. This class is a singleton pattern, the single global instance could be replaced to provide a custom
 * implementation.
 * 
 * <pre>
 * {
...
public class FRuleEngineIFactory
{
	 ...
	 * 
	 * @param parent
	 *            the F or FB infGraph that it using the engine, the parent graph holds the deductions graph and source data.
	 * @param rules
	 *            the rule set to be processed
	 * @param useRETE
	 *            if <code>true</code> force this factory to create a {@link RETEEngine} otherwise a {@link FRuleEngine} is created.
