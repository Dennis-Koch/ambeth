...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.rdf.arp.impl.DefaultErrorHandler;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.rdf.arp.impl.XMLHandler;

/**
 * The interface to set the various handlers on ARP. User defined implementations of this interface are not supported. This is a class rather than an interface
 * to have better backward compatibilitiy with earlier versions, however constructing instances of this class is deprecated.
 */
public class ARPHandlers
{
	...
	/**
	 * Sets the error handler, for both XML and RDF parse errors. XML errors are reported by Xerces, as instances of SAXParseException; the RDF errors are
	 * reported from ARP as instances of ParseException. Code that needs to distingusih between them may look like:
	 * 
	 * <pre>
	 *    void error( SAXParseException e ) throws SAXException {
	 *      if ( e instanceof de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.rdf.arp.ParseException ) {
	 *           ...
	 *      } else {
	 *           ...
	 *      }
	 ...
	 * 
	 * <p>
	 * See the ARP documentation for ErrorHandler for details of the ErrorHandler semantics (in particular how to upgrade a warning to an error, and an error to
	 * a.errorError).
	 * </p>
	 * <p>
