 ...
 * 
 * @see BitsInt (java.util.BitSet does not allow getting the pattern as a long)
 */
public final class BitsLong
{
	...
	/**
	 * Place the value into the bit pattern between start and finish and returns the new value. Leaves other bits alone.
	 * 
	 * @param bits
	 * @param value
	 * @param start
