...
public class PathFactory
{
	...
	public static Path pathLink(Node property)
	{
		return new P_Link(property);
	}
	...
	public static Path pathMod(Path path, long min, long max)
	{
		return new P_Mod(path, min, max);
	}

	public static Path pathFixedLength(Path path, long count)
	{
	...
	public static Path pathAlt(Path path1, Path path2)
	{
		return new P_Alt(path1, path2);
	}

	public static Path pathSeq(Path path1, Path path2)
	{
		return new P_Seq(path1, path2);
	}
