...
public abstract class StatementBase
{
	...
	/**
	 * replace this StaementImpl [ie the one of which this is the base] with (S, P, n). Answer the new StaementImpl. Abstract here to allow methods to be pulled
	 * up.
	 */
	...
	/**
	 * "replace" the Object of this statement with the literal string value _s_. NOTE: this is a convenience function to eliminate the use of a deprecated
	 * constructor; when data-types are put properly into Jena, it will likely disappear.
	 */
	...
	/**
	 * Answer a string describing this Statement in a vagely pretty way, with the representations of the subject, predicate, and object in that order.
	 */
	@Override
