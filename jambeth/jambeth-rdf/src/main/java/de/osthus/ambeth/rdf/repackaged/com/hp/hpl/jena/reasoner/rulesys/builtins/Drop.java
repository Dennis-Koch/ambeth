...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.reasoner.rulesys.BuiltinException;
...
/**
 * A variant of the "remove" builtin that will delete matched triples from the graph but will not trigger further rule processing for the removed triples. This
 * makes it seriously non-monotonic but useful for rewrite rules.
 */
