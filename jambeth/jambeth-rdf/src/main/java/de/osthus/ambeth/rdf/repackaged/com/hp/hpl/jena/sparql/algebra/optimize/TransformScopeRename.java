...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.algebra.OpVisitorByTypeBase;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.algebra.op.OpModifier;
...
/**
 * Rename variables so that names can be treated globally. (project) and (group) can hide variables, but we only need to account for OpProject because group is
 * never executed linearly.
 */
