...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.rdf.model.impl.*;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.reasoner.*;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.util.ResourceUtils;
...
public class OntResourceImpl extends ResourceImpl implements OntResource
{
	...
	public static final String[] KNOWN_LANGUAGES = new String[] { OWL.NS, RDF.getURI(), RDFS.getURI(), XSDDatatype.XSD };

	// Static variables
	// ////////////////////////////////

	/**
	 * A factory for generating OntResource facets from nodes in enhanced graphs. Note: should not be invoked directly by user code: use
	...
	/**
	 * <p>
	 * Answer the model that this resource is attached to, assuming that it is an {@link OntModel}. If this resource is not attached to any model, or is
	 * (unusually) attached to a model that is not an <code>OntModel</code>, answer null.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Answer true if this resource is a symbol in one of the standard ontology languages supported by Jena: RDF, RDFS, OWL or DAML+OIL. Since these languages
	 * have restricted namespaces, this check is simply a convenient way of testing whether this resource is in one of those pre-declared namespaces.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Assert equivalence between the given resource and this resource. Any existing statements for <code>sameAs</code> will be removed.
	 * </p>
	 * 
	 * @param res
	 *            The resource that is declared to be the same as this resource
	 * @exception ProfileException
	 *                If the {@link Profile#SAME_AS()} property is not supported in the current language profile.
	 */
	@Override
	...
	/**
	 * <p>
	 * Assert that the given resource and this resource are distinct. Any existing statements for <code>differentFrom</code> will be removed.
	 * </p>
	 * 
	 * @param res
	 *            The resource that is declared to be distinct from this resource
	 * @exception ProfileException
	 *                If the {@link Profile#DIFFERENT_FROM()} property is not supported in the current language profile.
	 */
	@Override
	 ...
	 * 
	 * @param res
	 *            A resource that declared to be distinct from this resource
	 * @exception ProfileException
	 *                If the {@link Profile#DIFFERENT_FROM()} property is not supported in the current language profile.
	 */
	@Override
	 ...
	 * @exception ProfileException
	 *                If the {@link Profile#SEE_ALSO()} property is not supported in the current language profile.
	 */
	@Override
	...
	/**
	 * <p>
	 * Remove the statement indicating the given resource as a source of additional information about this resource. If this statement is not true of the
	...
	/**
	 * <p>
	 * Assert that the given resource provides a source of definitions about this resource. Any existing statements for <code>isDefinedBy</code> will be
	 * removed.
	 * </p>
	 * 
	 * @param res
	 ...
	 * @exception ProfileException
	 *                If the {@link Profile#IS_DEFINED_BY()} property is not supported in the current language profile.
	 */
	@Override
	...
	/**
	 * <p>
	 * Assert that the given string is the value of the version info for this resource. Any existing statements for <code>versionInfo</code> will be removed.
	 * </p>
	 * 
	 * @param info
	 *            The version information for this resource
	 * @exception ProfileException
	 *                If the {@link Profile#VERSION_INFO()} property is not supported in the current language profile.
	 */
	@Override
	...
	/**
	 * <p>
	 * Remove the statement that the given string provides version information about this resource. If this statement is not true of the current model, nothing
	 * happens.
	 * </p>
	 * 
	 * @param info
	...
	/**
	 * <p>
	 * Assert that the given string is the value of the label for this resource. Any existing statements for <code>label</code> will be removed.
	 * </p>
	 * 
	 * @param label
	 ...
	 * @exception ProfileException
	 *                If the {@link Profile#LABEL()} property is not supported in the current language profile.
	 */
	@Override
	 ...
	 * 
	 * @param label
	 *            A label string for this resource
	 * @param lang
	 *            The language attribute for this label (EN, FR, etc) or null if not specified.
	 * @exception ProfileException
	 *                If the {@link Profile#LABEL()} property is not supported in the current language profile.
	 ...
	 * 
	 * @param lang
	 *            The language attribute for the desired label (EN, FR, etc) or null for don't care. Will attempt to retreive the most specific label matching
	 ...
	 * 
	 * @param lang
	 *            The language to restrict any label values to, or null to select all languages
	...
	{
		checkProfile(getProfile().LABEL(), "LABEL");
		return WrappedIterator.create(listProperties(getProfile().LABEL())).filterKeep(new LangTagFilter(lang)).mapWith(new ObjectMapper());
	}
	...
	/**
	 * <p>
	 * Assert that the given string is the comment on this resource. Any existing statements for <code>comment</code> will be removed.
	 * </p>
	 * 
	 * @param comment
	 ...
	 * @exception ProfileException
	 *                If the {@link Profile#COMMENT()} property is not supported in the current language profile.
	 */
	@Override
	 ...
	 * 
	 * @param comment
	 *            A comment string for this resource
	 * @param lang
	 *            The language attribute for this comment (EN, FR, etc) or null if not specified.
	 * @exception ProfileException
	 *                If the {@link Profile#COMMENT()} property is not supported in the current language profile.
	 ...
	 * 
	 * @param lang
	 *            The language attribute for the desired comment (EN, FR, etc) or null for don't care. Will attempt to retreive the most specific comment
	 *            matching the given language</p>
	...
	{
		checkProfile(getProfile().COMMENT(), "COMMENT");
		return WrappedIterator.create(listProperties(getProfile().COMMENT())).filterKeep(new LangTagFilter(lang)).mapWith(new ObjectMapper());
	}
	 ...
	 * 
	 * @param comment
	 *            A comment string to be removed
	 * @param lang
	 *            A lang tag
	 */
	@Override
	...
	/**
	 * <p>
	 * Set the RDF type (i.e. the class) for this resource, replacing any existing <code>rdf:type</code> property. Any existing statements for the RDF type will
	 * first be removed.
	 * </p>
	 * 
	 * @param cls
	 *            The RDF resource denoting the new value for the <code>rdf:type</code> property, which will replace any existing type property.
	 */
	@Override
	...
	/**
	 * <p>
	 * Add the given class as one of the <code>rdf:type</code>'s for this resource.
	 * </p>
	 * 
	 * @param cls
	...
	/**
	 * <p>
	 * Answer the <code>rdf:type</code> (ie the class) of this resource. If there is more than one type for this resource, the return value will be one of the
	 * values, but it is not specified which one (nor that it will consistently be the same one each time). Equivalent to <code>getRDFType( false )</code>.
	 * </p>
	 * 
	 * @return A resource that is the rdf:type for this resource, or one of them if more than one is defined.
	 */
	@Override
	 ...
	 * <p>
	 * Answer the <code>rdf:type</code> (ie the class) of this resource. If there is more than one type for this resource, the return value will be one of the
	 * values, but it is not specified which one (nor that it will consistently be the same one each time).
	 * </p>
	 * 
	 * @param direct
	 *            If true, only consider the direct types of this resource, and not the super-classes of the type(s).
	 * @return A resource that is the rdf:type for this resource, or one of them if more than one is defined.
	 */
	@Override
	 ...
	 * 
	 * @param direct
	 *            If true, only answer those resources that are direct types of this resource, not the super-classes of the class etc.
	 * @return An iterator over the set of this resource's classes, each of which will be a {@link Resource}.
	 */
	@Override
	...
	/**
	 * <p>
	 * Answer true if this resource is a member of the class denoted by the given class resource. Includes all available types, so is equivalent to <code><pre>
	 ...
	 *            Denotes a class to which this value may belong
	 * @param direct
	 *            If true, only consider the direct types of this resource, ignoring the super-classes of the stated types.
	 * @return True if this resource has the given class as one of its <code>rdf:type</code>'s.
	 */
	@Override
	...
	protected boolean hasRDFType(Resource ontClass, String name, boolean direct)
	{
		...
		if (!direct)
		{
			// just an ordinary query - we can answer this directly (more
			// efficient)
	 ...
	 * 
	 * @param cls
	 *            A resource denoting a class that that is to be removed from the classes of this resource
	 */
	@Override
	 ...
	 * @param p
	 *            A property
	 * @return The cardinality for the property <code>p</code> on this resource, as an integer greater than or equal to zero.
	 */
	@Override
	...
	/**
	 * <p>
	 * Set the value of the given property of this ontology resource to the given value, encoded as an RDFNode. Maintains the invariant that there is at most
	 * one value of the property for a given resource, so existing property values are first removed. To add multiple properties, use
	...
	/**
	 * <p>
	 * Answer the value of a given RDF property for this ontology resource, or null if it doesn't have one. The value is returned as an RDFNode, from which the
	 * concrete data value can be extracted for literals. If the value is a resource, it will present the {@link OntResource} facet. If there is more than one
	 * RDF statement with the given property for the current value, it is not defined which of the values will be returned.
	 * </p>
	 * 
	 * @param property
	 *            An RDF property
	 * @return An RDFNode whose value is the value, or one of the values, of the given property. If the property is not defined the method returns null.
	 */
	@Override
	...
	/**
	 * <p>
	 * Answer an iterator over the set of all values for a given RDF property. Each value in the iterator will be an RDFNode, representing the value (object) of
	...
	/**
	 * <p>
	 * Removes this resource from the ontology by deleting any statements that refer to it, as either statement-subject or statement-object. If this resource is
	 * a property, this method will <strong>not</strong> remove statements whose predicate is this property.
	 * </p>
	 * <p>
	 * <strong>Caveat:</strong> Jena RDF models contain statements, not resources <em>per se</em>, so this method simulates removal of an object by removing all
	 * of the statements that have this resource as subject or object, with one exception. If the resource is referenced in an RDF List, i.e. as the object of
	 * an <code>rdf:first</code> statement in a list cell, this reference is <strong>not</strong> removed. Removing an arbitrary <code>rdf:first</code>
	 * statement from the midst of a list, without doing other work to repair the list, would leave an ill-formed list in the model. Therefore, if this resource
	 * is known to appear in a list somewhere in the model, it should be separately deleted from that list before calling this remove method.
	 * </p>
	 */
	@Override
	public void remove()
	{
		...
		for (Statement s : stmts)
		{
			if (s.getPredicate().equals(first) && s.getObject().equals(this))
			{
				...
				// we don't delete this reference, since it would make the list
				// ill-formed
			...
			else if (s.getObject() instanceof Resource)
			{
				...
				{
					// this value is a list, so we will want to remove all of
					// the elements
					lists.add(obj);
				}
			}
		...
		try
		{
			if (!useInf)
			{
				...
				for (i = listProperties(RDF.type); i.hasNext();)
				{
					...
					// if the type itself is OWL.Class or similar, we should
					// ignore it ... this may
					// arise in cases where the user has materialised results of
					// inference and is then
					// accessing them from a plain model
					// JENA-3: we also ignore if the type is rdfs:Resource or
					// similar, since it's not informative
					if (rType.equals(getProfile().CLASS()) || rType.equals(RDFS.Resource) || rType.equals(RDF.Property) || rType.equals(RDFS.Datatype)
							|| rType.equals(RDF.List))
					{
						continue;
					}

					// otherwise, we check to see if the given type is known to
					// be a class
					for (j = rType.listProperties(RDF.type); j.hasNext();)
					{
						if (j.nextStatement().getResource().equals(getProfile().CLASS()))
						{
							// we have found an rdf:type of the subject that is
							// an owl, rdfs or daml Class
	 ...
	 * @exception ProfileException
	 *                if term is null (indicating it is not in the profile)
	 **/
	 ...
	 * @param lang
	 *            The language we're searching for, assumed non-null.
	...
	protected String selectLang(StmtIterator stmts, String lang)
	{
		...
		while (stmts.hasNext())
		{
			...
			if (n instanceof Literal)
			{
				...
				{
					// found a string with no (i.e. default) language - keep
					// this unless we've got something better
					found = l.getString();
				}
			}
		}
	...
	{
		return (desired == null) || (desired.equalsIgnoreCase(target))
	...
	protected void addListPropertyValue(Property p, String name, RDFNode value)
	{
		...
		if (hasProperty(p))
		{
			...
			if (!values.contains(value))
			{
				...
				// if the previous values was nil, the return value will be a
				// new list
				if (newValues != values)
				{
					removeAll(p);
	...
	protected <T extends RDFNode> T convertToType(Resource type, String name, Class<T> cls)
	{
		...
		// we're told that adding this rdf:type will make the as() possible -
		// let's see
	 ...
	 * @param name
	 *            The short name of the property (for generating error messages)
	 * @param cls
	 *            Class object denoting the facet to map the returned values to
	 * @param orderRel
	 *            If direct, and we are not using an inference engine, this is the property to use to define the maximal lower elements of the partial order
	 * @param direct
	 *            If true, only return the direct (adjacent) values
	 * @param inverse
	 *            If true, use the inverse of p rather than p
	 * @return An iterator of nodes that are in relation p to this resource (possibly inverted), which have been mapped to the facet denoted by <code>cls</code>
	 *         .
	 */
	protected <T extends Resource> ExtendedIterator<T> listDirectPropertyValues(Property p, String name, Class<T> cls, Property orderRel, boolean direct,
			boolean inverse)
	{
		Iterator<T> i = null;
		checkProfile(p, name);
		...
		if (!direct || ((ig != null) && ig.getReasoner().supportsProperty(sc)))
		{
			...
			// ensure we have an extended iterator of statements this
			// rdfs:subClassOf _x
	...
	/**
	 * <p>
	 * In the absence of a reasoner that can compute direct (adjacent) property values, we must perform the calculation of the direct values computationally
	 * here.
	 * </p>
	 * 
	 * @param p
	...
	private <T extends Resource> Iterator<T> computeDirectValues(Property p, Property orderRel, boolean inverse, Resource subject, Resource object,
			Map1<Statement, T> mapper)
	{
		...
		// we need to keep this node out of the iterator for now, else it will
		// spoil the maximal
		// generator compression (since all the (e.g.) sub-classes will be
		// sub-classes of this node
		...
		// we now compress the list by reducing all equivalent values to a
		...
		// then reduce each part of the partition to a singleton, but remember
		// the others
		s.clear();
		for (List<T> part : partition)
		{
			// if this is a singleton we just add it to the compressed
			// candidates
			if (part.size() == 1)
			{
				s.add(part.get(0));
		...
		// now s1 contains a reduced set of nodes, in which any fully-connected
		// sub-graph under
		// orderRel has been reduced to a single representative

		// generate the short list as the maximal bound under the given partial
		// order
		s = ResourceUtils.maximalLowerElements(s, orderRel, inverse);

		// create a list of these values lower elements, plus their equivalents
		// (if any)
	...
	protected static class AsMapper<T extends RDFNode> implements Map1<RDFNode, T>
	{
		...
		public AsMapper(Class<T> as)
		{
			m_as = as;
		}

		@Override
		public T map1(RDFNode x)
		{
			return x.as(m_as);
		}
	}
	...
	protected static class ResourceAsMapper<T extends RDFNode> implements Map1<Resource, T>
	{
		...
		public ResourceAsMapper(Class<T> as)
		{
			m_as = as;
		}

		@Override
		public T map1(Resource x)
		{
			return x.as(m_as);
		}
	}
	...
	protected static class SubjectAsMapper<T extends RDFNode> implements Map1<Statement, T>
	{
		...
		public SubjectAsMapper(Class<T> as)
		{
			m_as = as;
		}
	...
	protected class SingleEqualityFilter<T> extends Filter<T>
	{
		private T m_obj;

		public SingleEqualityFilter(T x)
		{
			m_obj = x;
		}
