...
public class HasValueRestrictionImpl extends RestrictionImpl implements HasValueRestriction
{
	...
	/**
	 * A factory for generating HasValueRestriction facets from nodes in enhanced graphs. Note: should not be invoked directly by user code: use
	...
	public static Implementation factory = new Implementation()
	{
		...
		{
			// node will support being a HasValueRestriction facet if it has
			// rdf:type owl:Restriction or equivalent
			// and the combination of owl:onProperty and owl:hasValue (or
			// equivalents)
