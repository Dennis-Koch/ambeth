...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.shared.LockMRSW;
...
/**
 * <p>
 * DatasetGraph framework : readonly dataset need only provide find(g,s,p,o), getGraph() and getDefaultGraph() although it may wish to override other operations
 * and do better.
 * </p>
 * 
 * <p>
