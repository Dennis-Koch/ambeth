...
import static de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.rdf.arp.ARPErrorNumbers.EM_FATAL;
import static de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.rdf.arp.ARPErrorNumbers.WARN_MALFORMED_XMLLANG;
...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.checker.CheckerLiterals;
...
public class LangRDFXML implements LangRIOT
{
	...
	// syntactically valid.
	private static int[] additionalErrors = new int[] { WARN_MALFORMED_XMLLANG
