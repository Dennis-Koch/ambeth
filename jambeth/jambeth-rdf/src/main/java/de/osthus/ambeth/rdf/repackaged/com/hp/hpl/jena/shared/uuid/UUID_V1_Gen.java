...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.shared.uuid.JenaUUID.UUIDFormatException;
...
{
	// Constants
	static final int versionHere = 1; // Version 1: time-based. This is one
	 ...
	 * 
	 * UUID = <time_low> "-" <time_mid> "-" <time_high_and_version> "-" <variant_and_sequence> "-" <node> time_low = 4*<hexOctet> time_mid = 2*<hexOctet>
	 * time_high_and_version = 2*<hexOctet> variant_and_sequence = 2*<hexOctet> node = 6*<hexOctet> hexOctet = <hexDigit><hexDigit>
	 */
	...
	{
		long timeHigh = timestamp >>> (60 - 12); // Top 12 bits of 60 bit
													// number.
	...
	private void setInitialState()
	{
		...
		node = Bits.unpack(random, 0, 47); // Low 48bits, except groups address
											// bit
