...
import static de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.modify.request.Target.Decl.ALL$;
import static de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.modify.request.Target.Decl.DEFAULT$;
import static de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.modify.request.Target.Decl.IRI$;
import static de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.modify.request.Target.Decl.NAMED$;
...
public class Target
{
	...
	public boolean equals(Object obj)
	{
		...
		if (graphIRI == null)
		{
			if (other.graphIRI != null)
				return false;
		}
		else if (!graphIRI.equals(other.graphIRI))
			return false;
		return true;
	}
}
