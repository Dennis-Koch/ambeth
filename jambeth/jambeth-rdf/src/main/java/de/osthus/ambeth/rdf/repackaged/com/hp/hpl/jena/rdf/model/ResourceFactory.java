 ...
 * 
 * <p>
 * This class creates resources and properties and things of that ilk. These resources are <i>not</i> associated with a user-modifiable model: doing getModel()
 * on them will return null.
 * </p>
 * 
 * <p>
 * It is designed as a singleton. There are static convenience methods on this class itself, so the easy way to create resource is for example to do something
 * like:
 * </p>
 * 
 * <pre>
 ...
 * 
 * <p>
 * If a factory object is needed, then this can be obtained using the <code>getInstance</code> method on the class. The factory object used may be changed using
 * the <code>setInstance</code> method.
 * </p>
 */
public class ResourceFactory
{
	 ...
	 * 
	 * @param value
	 *            a java Object, the default RDFDatatype for that object will be used
	 ...
	 * 
	 * @param namespace
	 *            URIREF of the namespace of the property
	 * @param localName
	...
	/**
	 * create a new statement. Uses the current factory object to create a new statement.</p>
	 * 
	 * @param subject
	...
	public interface Interface
	{
		 ...
		 * @param predicate
		 *            predicate of the new statement
		 * @param object
		 *            object of the new statement
