...
public class ComplementClassImpl extends OntClassImpl implements ComplementClass
{
	...
	/**
	 * A factory for generating ComplementClass facets from nodes in enhanced graphs. Note: should not be invoked directly by user code: use
	...
	public static Implementation factory = new Implementation()
	{
		...
		{
			// node will support being an ComplementClass facet if it has
			// rdf:type owl:Class and an owl:complementOf statement (or
			// equivalents)
	...
	/**
	 * <p>
	 * Answer the property that is used to construct this boolean expression, for example {@link Profile#UNION_OF()}.
	 * </p>
	 * 
