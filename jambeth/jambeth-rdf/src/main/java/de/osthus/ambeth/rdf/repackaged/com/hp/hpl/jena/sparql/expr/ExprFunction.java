...
/**
 * A function in the expression hierarchy. Everything that is evaluable (i.e. not NodeValue, NodeVar) is a function). It is useful to distinguish between
 * values, vars and functions. The exists operations (which take a op, not arguments) are functions of zero arguments.
 */
