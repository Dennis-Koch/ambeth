...
package de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.expr.aggregate;
...
abstract class AccumulatorExpr implements Accumulator
{
	...
	/**
	 * Called when the expression beeing aggregated evaluates OK. Can throw ExprEvalException - in which case the accumulateError is called
	 */
	protected abstract void accumulate(NodeValue nv, Binding binding, FunctionEnv functionEnv);

	/**
	 * Called when an evaluation of the expression causes an error or when the accumulation step throws ExprEvalException
	 */
