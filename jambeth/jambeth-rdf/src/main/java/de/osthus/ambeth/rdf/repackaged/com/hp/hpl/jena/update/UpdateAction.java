...
package de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.update;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.QuerySolution;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.lang.UpdateParser;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.modify.UpdateSink;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.modify.UsingList;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.modify.UsingUpdateSink;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.modify.request.UpdateWithUsing;

/**
 * A class of forms for executing SPARQL Update operations. parse means the update request is in a String or an InputStream; read means read the contents of a
 * file.
 */
...
public class UpdateAction
{
	 ...
	 * 
	 * @param usingList
	 *            A list of USING or USING NAMED statements that be added to all {@link UpdateWithUsing} queries
	 * @param input
	 ...
	 *            A list of USING or USING NAMED statements that be added to all {@link UpdateWithUsing} queries
	 * @param dataset
	 *            The dataset to apply the changes to
	 * @param input
	 *            The source of the update request (must be UTF-8).
	 * @param baseURI
	 *            The base URI for resolving relative URIs (may be <code>null</code>)
	 * @param syntax
	 *            The update language syntax
	 */
	 ...
	 *            The source of the update request (must be UTF-8).
	 * @param inputBinding
	 *            Initial binding to be applied to Update operations that can apply an initial binding (i.e. UpdateDeleteWhere, UpdateModify). May be
	 *            <code>null</code>
	 * @param baseURI
	 *            The base URI for resolving relative URIs (may be <code>null</code>)
	 * @param syntax
