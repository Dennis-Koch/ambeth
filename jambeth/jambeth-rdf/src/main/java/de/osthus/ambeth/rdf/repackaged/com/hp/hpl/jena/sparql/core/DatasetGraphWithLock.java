...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.JenaTransactionException;
...
/**
 * A DatasetGraph that uses the dataset lock to give weak transactional behaviour, that is the application see transaction but they are not durable. Only
 * provides multiple-reader OR single-writer, and no write-transction abort.
 */
public class DatasetGraphWithLock extends DatasetGraphTrackActive implements Sync
{
	...
	/**
	 * Return whether abort is provided. Just by locking, a transaction can not write-abort (the chnages have been made and not recorded). Subclasses may do
	 * better and still rely on this locking class.
	 */
