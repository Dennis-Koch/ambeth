...
public class ContextMBean implements DynamicMBean
{
	...
	{
		return context.getAsString(Symbol.create(name));
	}
	...
	public MBeanInfo getMBeanInfo()
	{
		...
		/*
		 * String className, String description, MBeanAttributeInfo[] attributes, MBeanConstructorInfo[] constructors, MBeanOperationInfo[] operations,
		 * MBeanNotificationInfo[] notifications) throws IllegalArgumentException
		 */
		MBeanInfo info = new MBeanInfo(this.getClass().getName(), "ARQ global context", attrInfo, null, // Constructors
				null, // Operations
				null // Notifications
		);
		return info;
