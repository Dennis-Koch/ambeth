...
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.RDFLanguages.CSV;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.RDFLanguages.N3;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.RDFLanguages.NQUADS;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.RDFLanguages.NTRIPLES;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.RDFLanguages.RDFJSON;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.RDFLanguages.RDFXML;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.RDFLanguages.TRIG;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.RDFLanguages.TURTLE;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.RDFLanguages.RDFNULL;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.RDFLanguages.filenameToLang;
...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.iterator.IteratorResourceClosing;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.json.io.parser.TokenizerJSON;
...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.out.CharSpace;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.system.ErrorHandlerFactory;
...
/**
 * Operations to access RIOT parsers and send the output to a StreamRDF (triples or quads as appropriate). This class is probably not what you want to use. It
 * is public to give maximum compatibility.
 * 
...
{
	/**
	 * Parse a file, sending output to a StreamRDF sink. Must be in a triples syntax.
	 * 
	 * @param filename
	 * @param dest
	 *            Where to send the triples from the parser.
	 */
	 ...
	 * @param filename
	 * @param lang
	 *            Language, or null for "guess from URL" (e.g. file extension)
	 * @param dest
	 *            Where to send the triples from the parser.
	 */
	 ...
	 *            Language, or null for "guess from URL" (e.g. file extension)
	 * @param baseIRI
	 *            Base IRI, or null for based on input filename
	 * @param dest
	 *            Where to send the triples from the parser.
	 */
	...
	public static LangRIOT createParser(InputStream input, Lang lang, String baseIRI, StreamRDF dest)
	{
		...
		Tokenizer tokenizer = (lang == RDFJSON) ? new TokenizerJSON(PeekReader.makeUTF8(input)) : TokenizerFactory.makeTokenizerUTF8(input);
	...
	public static LangRIOT createParser(Reader input, Lang lang, String baseIRI, StreamRDF dest)
	{
		...
		Tokenizer tokenizer = (lang == RDFJSON) ? new TokenizerJSON(PeekReader.make(input)) : TokenizerFactory.makeTokenizer(input);
		return createParser(tokenizer, lang, baseIRI, dest);
	}
	 ...
	 * @param filename
	 * @param sink
	 *            Where to send the quads from the parser.
	 * @see RiotReader#parse
	 */
	 ...
	 * @param filename
	 * @param lang
	 *            Language, or null for "guess from filename" (e.g. extension)
	 * @param baseIRI
	 *            Base IRI, or null for base on input filename
	 * @param sink
	 *            Where to send the quads from the parser.
	 * @see RiotReader#parse
	 */
