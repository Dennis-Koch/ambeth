...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.iri.IRIComponents;
...
public class IRIFactoryImpl extends AbsIRIFactoryImpl implements ViolationCodes, Force, IRIComponents
{
	...
	/*
	 * static final long conformanceMasks[] = { // RFC3986 (1l<<ILLEGAL_CHAR) |(1l<<ILLEGAL_PERCENT_ENCODING) |(1l<<EMPTY_SCHEME)
	 * |(1l<<IP_V4_HAS_FOUR_COMPONENTS) |(1l<<IP_V4_OCTET_RANGE) |(1l<<IP_V6_OR_FUTURE_ADDRESS_SYNTAX) |(1l<<IRI_CHAR) |(1l<<LTR_CHAR)
	 * |(1l<<NOT_XML_SCHEMA_WHITESPACE) |(1l<<SCHEME_MUST_START_WITH_LETTER) |(1l<<UNWISE_CHAR) |(1l<<WHITESPACE) |(1l<<ARBITRARY_CHAR) , // RFC3987
	 * (1l<<ILLEGAL_CHAR) |(1l<<ILLEGAL_PERCENT_ENCODING) |(1l<<EMPTY_SCHEME) |(1l<<IP_V4_HAS_FOUR_COMPONENTS) |(1l<<IP_V4_OCTET_RANGE)
	 * |(1l<<IP_V6_OR_FUTURE_ADDRESS_SYNTAX) |(1l<<LTR_CHAR) |(1l<<NOT_XML_SCHEMA_WHITESPACE) |(1l<<SCHEME_MUST_START_WITH_LETTER) |(1l<<UNWISE_CHAR)
	 * |(1l<<WHITESPACE) |(1l<<ARBITRARY_CHAR) , // RDF (1l<<ILLEGAL_CHAR) |(1l<<ILLEGAL_PERCENT_ENCODING) |(1l<<EMPTY_SCHEME) |(1l<<IP_V4_HAS_FOUR_COMPONENTS)
	 ...
	 * |(1l<<ILLEGAL_PERCENT_ENCODING) |(1l<<EMPTY_SCHEME) |(1l<<IP_V4_HAS_FOUR_COMPONENTS) |(1l<<IP_V4_OCTET_RANGE) |(1l<<IP_V6_OR_FUTURE_ADDRESS_SYNTAX)
	 * |(1l<<SCHEME_MUST_START_WITH_LETTER) |(1l<<NON_XML_CHARACTER) , // XMLSchema (1l<<ILLEGAL_CHAR) |(1l<<ILLEGAL_PERCENT_ENCODING) |(1l<<EMPTY_SCHEME)
	 * |(1l<<IP_V4_HAS_FOUR_COMPONENTS) |(1l<<IP_V4_OCTET_RANGE) |(1l<<IP_V6_OR_FUTURE_ADDRESS_SYNTAX) |(1l<<SCHEME_MUST_START_WITH_LETTER)
	 * |(1l<<NOT_XML_SCHEMA_WHITESPACE) |(1l<<NON_XML_CHARACTER) , // IDN // (1l<<ACE_PREFIX) 0 , // Should (1l<<LOWERCASE_PREFERRED)
	 * |(1l<<PORT_SHOULD_NOT_BE_EMPTY) |(1l<<PORT_SHOULD_NOT_START_IN_ZERO) // |(1l<<SCHEME_NAMES_SHOULD_BE_LOWER_CASE)
	 * |(1l<<PERCENT_ENCODING_SHOULD_BE_UPPERCASE) |(1l<<IPv6ADDRESS_SHOULD_BE_LOWERCASE) |(1l<<USE_PUNYCODE_NOT_PERCENTS) , // Minting /* consider HAS_PASSWORD
	 * vs LOWER_CASE_PREFERRED The former should be an error unless switched off (but it can be, unlike a MUST), whereas the latter should be a warning by
	 * default. / (1l<<LOWERCASE_PREFERRED) |(1l<<PORT_SHOULD_NOT_BE_EMPTY) |(1l<<PORT_SHOULD_NOT_START_IN_ZERO) // |(1l<<SCHEME_NAMES_SHOULD_BE_LOWER_CASE)
	 * |(1l<<PERCENT_ENCODING_SHOULD_BE_UPPERCASE) |(1l<<IPv6ADDRESS_SHOULD_BE_LOWERCASE) |(1l<<USE_PUNYCODE_NOT_PERCENTS) , // DNS (1l<<NOT_DNS_NAME) , };
	 */
	...
	/*
	 * protected long recsToMask(int recs) { long mask = 0; for (int i=0; recs != 0 && i<conformanceMasks.length; i++) { if ((recs & (1<<i)) != 0) { mask |=
	 * conformanceMasks[i]; recs &= ~(1<<i); } } return mask; }
	 */
