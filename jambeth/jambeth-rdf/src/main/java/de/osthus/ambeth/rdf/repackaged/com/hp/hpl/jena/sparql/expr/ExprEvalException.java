...
/**
 * Exception for a dynamic evaluation exception. The current solution is likely to be rejected. See also QueryFatalException which aborts the whole query
 * execution.
 */
...
public class ExprEvalException extends ExprException
{
	...
	public ExprEvalException(String msg, Throwable cause)
	{
		super(msg, cause);
	}
