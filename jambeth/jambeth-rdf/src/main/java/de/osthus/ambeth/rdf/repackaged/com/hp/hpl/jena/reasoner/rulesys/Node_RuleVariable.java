...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.Node_Variable;
 ...
 * variables to have an offset index in the rule environment vector. The variables can also suport prolog-like reference chains and trails but these are not yet
 * used.
 * <p>
...
public class Node_RuleVariable extends Node_Variable
{
	 ...
	 * 
	 * @param label
	 *            the text label for the variable
	 * @param index
	...
	/**
	 * Return an indexable object for this Node. This is actually the rule label. This is weird but needed because equals is (deliberately) perverse on
	 * Node_RuleVariable so if we want to put then in a Set or Map we need something with a better equals function.
	 */
	 ...
	 * 
	 * @return either a concrete node value or the last variable in the reference chain.
	 */
	public Node deref()
	{
