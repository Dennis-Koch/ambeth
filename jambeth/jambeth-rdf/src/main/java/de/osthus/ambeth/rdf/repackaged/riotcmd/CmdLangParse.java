...
import de.osthus.ambeth.rdf.repackaged.arq.cmdline.CmdGeneral;
import de.osthus.ambeth.rdf.repackaged.arq.cmdline.ModLangParse;
import de.osthus.ambeth.rdf.repackaged.arq.cmdline.ModSymbol;
...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.ReaderRIOT;
...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.lang.StreamRDFCounting;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.out.NodeToLabel;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.process.inf.InfFactory;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.riot.process.inf.InferenceSetupRDFS;
...
public abstract class CmdLangParse extends CmdGeneral
{
	...
	protected void output(String label, long numberTriples, long timeMillis, LangHandler handler)
	{
		...
		System.out.flush();
		System.err.printf("%s : %,5.2f sec  %,d %s  %,.2f %s\n", label, timeMillis / 1000.0, numberTriples, handler.getItemsName(), timeSec == 0 ? 0.0
				: numberTriples / timeSec, handler.getRateName());
	}
