...
/**
 * <p>
 * Interface representing the ontology abstraction for a qualified maximum cardinality restriction. A qualified restriction is a DAML+OIL term for a restriction
 * with a cardinality constraint <em>and</em> a constraint that the values of the restricted property must all belong to the given class. At the current time,
 * qualified restrictions are part of DAML+OIL, but not part of OWL.
 * </p>
 */
public interface MaxCardinalityQRestriction extends QualifiedRestriction
{
	...
	/**
	 * <p>
	 * Assert that this restriction restricts the property to have the given maximum cardinality. Any existing statements for <code>maxCardinalityQ</code> will
	 * be removed.
	 * </p>
	 * 
	 ...
	 *                If the {@link Profile#MAX_CARDINALITY_Q()} property is not supported in the current language profile.
	 */
	...
	/**
	 * <p>
	 * Remove the statement that this restriction has the given maximum qualified cardinality for the restricted property. If this statement is not true of the
