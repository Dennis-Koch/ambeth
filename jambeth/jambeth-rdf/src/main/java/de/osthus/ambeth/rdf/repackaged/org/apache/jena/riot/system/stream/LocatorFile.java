...
/**
 * Location files in the filing system. A FileLocator can have a "current directory" - this is separate from any location mapping (see @link{LocationMapping})
...
public class LocatorFile implements Locator
{
	 ...
	 * <p>
	 * For MS Window, if asked to {@linkplain #open} a file name with a drive letter, the code assumes it is not relative to the working directory of this
	 * {@code LocatorFile}.
	 */
	...
	/**
	 * Make a filename (no URI scheme, no windows drive) absolute if there is a setting for directory name thisDir
	 */
