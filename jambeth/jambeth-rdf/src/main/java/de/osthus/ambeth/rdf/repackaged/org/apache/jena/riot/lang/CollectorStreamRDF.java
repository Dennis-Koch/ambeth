...
/**
 * StreamRDF implementations which store received triples and quads in a {@link java.util.Collection}.
 * 
 * The resulting collection can be retrieved via the {@link #getTriples()} and {@link #getQuads()} methods.
 * 
 * The implementations are suitable for single-threaded parsing, for use with small data or distributed computing frameworks (e.g. Hadoop) where the overhead of
 * creating many threads for a push-pull parser setup is significant.
 */
