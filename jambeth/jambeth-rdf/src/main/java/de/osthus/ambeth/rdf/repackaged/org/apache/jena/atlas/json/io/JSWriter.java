...
package de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.json.io;

import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Chars.CH_QUOTE1;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Chars.CH_QUOTE2;
import static de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Chars.CH_ZERO;
...
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.BitsInt;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Chars;
import de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Ref;
...
public class JSWriter
{
	...
	/*
	 * Output a JSON string with escaping. \" \\ \/ \b \f \n \r \t control characters (def?) \ u four-hex-digits
	 */
	...
	/*
	 * Output a JSON string with escaping. Optionally allow base words (unquoted strings) which, for member names, is legal javascript but not legal JSON. The
	 * Jena JSON parser accepts them.
	 */
