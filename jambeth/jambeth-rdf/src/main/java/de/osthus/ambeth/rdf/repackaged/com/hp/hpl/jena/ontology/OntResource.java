...
public interface OntResource extends Resource
{
	 ...
	 *             if the resource is not bound to an {@link OntModel}, since that's the only way to get the profile for the resource
	 */
	public Profile getProfile();

	/**
	 * <p>
	 * Answer true if this resource is a symbol in one of the standard ontology languages supported by Jena: RDF, RDFS or OWL. Since these languages have
	 * restricted namespaces, this check is simply a convenient way of testing whether this resource is in one of those pre-declared namespaces.
	 * </p>
	 * 
	 ...
	 * 
	 * @param lang
	 *            The language attribute for the desired label (EN, FR, etc) or null for don't care. Will attempt to retrieve the most specific label matching
	 ...
	 * 
	 * @param lang
	 *            The language tag to restrict the listed labels to, or null to select all labels
	 ...
	 * @param lang
	 *            A lang tag, or null if not specified
	 */
	 ...
	 * 
	 * @param lang
	 *            The language attribute for the desired comment (EN, FR, etc) or null for don't care. Will attempt to retrieve the most specific comment
	 ...
	 * 
	 * @param lang
	 *            The language tag to restrict the listed comments to, or null to select all comments
	 * @return An iterator over RDF {@link Literal}'s.
	 * @exception ProfileException
	 *                If the {@link Profile#COMMENT()} property is not supported in the current language profile.
	 */
	...
	/**
	 * <p>
	 * Answer the <code>rdf:type</code> (i.e. the class) of this resource. If there is more than one type for this resource, the return value will be one of the
	 ...
	 * @return An iterator over the set of this resource's classes. Each member of the iteration will be an {@link Resource}. Use
	 *         <code>.as(&nbsp;OntClass.class&nbsp;)</code> to map this resource to an OntClass.
	...
	/**
	 * <p>
	 * Answer the value of a given RDF property for this resource, or null if it doesn't have one. The value is returned as an RDFNode, from which the concrete
	 * data value can be extracted for literals. If the value is a resource, it will present the {@link OntResource} facet. If there is more than one RDF
	 * statement with the given property for the current value, it is not defined which of the values will be returned.
	 * </p>
	 * 
	 * @param property
	 *            An RDF property
	...
	/**
	 * <p>
	 * Answer an iterator over the values for a given RDF property. Each value in the iterator will be an {@link RDFNode}.
	 * </p>
	 * 
	 * @param property
