...
public class GraphView extends GraphBase implements Sync
{
	...
	/**
	 * Return the graph name for this graph in the dataset it is a view of. Returns {@code null} for the default graph.
	 */
	...
	{
		return isDefaultGraph(gn);
	}

	protected final boolean isUnionGraph()
	{
		return isUnionGraph(gn);
	}
