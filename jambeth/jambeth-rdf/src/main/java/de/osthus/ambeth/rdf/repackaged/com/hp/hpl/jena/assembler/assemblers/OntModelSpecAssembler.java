...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.assembler.exceptions.ReasonerClashException;
...
/**
 * An OntModelSpecAssembler constructs OntModelSpec's from their RDF description. The description allows the document manager, the reasoner factory, the ont
 * language, and the import model getter to be specified: the default values will be those of OWL_MEM_RDFS_INF, unless the root is ja:SPOO for some constant
 * SPOO of OntModelSpec, in which case the defaults are taken from there.
 */
public class OntModelSpecAssembler extends AssemblerBase implements Assembler
{
	...
	/**
	 * Answer the default OntModelSpec for this root, which will be <code>DEFAULT</code> unless <code>root</code> has the JA namespace and a local name which is
	 * the name of an OntModelSpec constant (in OntModelSpec), in which case it's that constant's value.
	 */
