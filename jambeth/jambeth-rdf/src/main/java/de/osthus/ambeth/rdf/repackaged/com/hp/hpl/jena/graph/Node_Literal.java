...
public class Node_Literal extends Node_Concrete
{
	 ...
	 * 
	 * @see de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.Node#getIndexingValue()
	 */
	@Override
	...
	/**
	 * Test that two nodes are semantically equivalent. In some cases this may be the sames as equals, in others equals is stricter. For example, two xsd:int
	...
	{
		return o instanceof Node_Literal && ((LiteralLabel) label).sameValueAs(((Node_Literal) o).getLiteral());
	}
