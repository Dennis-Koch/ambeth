...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.reasoner.rulesys.impl.BBRuleContext;
 ...
 * </pre>
 * 
 * where X is the instance and P the property for which a temporary value is required, T will be bound to the temp value (a bNode) and D is an optional type cor
 * the T value.
 */
