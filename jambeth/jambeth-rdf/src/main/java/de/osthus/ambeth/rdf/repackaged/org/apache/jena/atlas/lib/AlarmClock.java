...
/**
 * An AlarmClock is an object that will make a callback (with a value) at a preset time. Simple abstraction of add/reset/cancel of a Runnable. Currently, backed
 * by {@linkplain ScheduledThreadPoolExecutor}
 */
