...
public class ThresholdPolicyFactory
{
	...
	/**
	 * A threshold policy based on the {@link de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.ARQ#spillToDiskThreshold} symbol in the given Context. If
	 * the symbol is not set, then the {@link #never()} policy is used by default.
	 */
