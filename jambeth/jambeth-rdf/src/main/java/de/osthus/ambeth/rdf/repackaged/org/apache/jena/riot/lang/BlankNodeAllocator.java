...
{
	/**
	 * Allocate based on a non-null label. Calling this twice, with the same label will generate equivalent nodes but they may not be identicial (i.e they are
	 * .equals but may not be ==)
	 */
	public Node alloc(String label);

	/**
	 * Create a fresh blank node, different from anything generated so far. Will not clash with a node allocated by {@linkplain #alloc}
	 */
	public Node create();
