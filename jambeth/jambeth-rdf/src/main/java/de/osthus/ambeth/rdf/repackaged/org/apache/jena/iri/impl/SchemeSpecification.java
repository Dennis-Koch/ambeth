...
public class SchemeSpecification extends Specification implements ViolationCodes, IRIComponents
{
	...
	public void setPattern(int component, String string)
	{
		...
		// pattern[Parser.invFields[PATH]] = pattern[Parser.invFields[QUERY]] =
		// p;
		// } else {
	...
	/**
	 * The given subDelims have syntactic use within this component in this scheme, and must be %-escaped for non-syntactic purposes. For the other subDelims
	 * the percent-escaped form, and the normal form are equivalent.
	 */
	@Override
