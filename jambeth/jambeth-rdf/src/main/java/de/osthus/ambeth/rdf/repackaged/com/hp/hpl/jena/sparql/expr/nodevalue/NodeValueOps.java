...
package de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.expr.nodevalue;

import static de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.datatypes.xsd.XSDDatatype.XSD;
import static de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.expr.ValueSpaceClassification.VSPACE_DATE;
import static de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.expr.ValueSpaceClassification.VSPACE_DATETIME;
import static de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.expr.ValueSpaceClassification.VSPACE_DURATION;
import static de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.expr.ValueSpaceClassification.VSPACE_NUM;
import static de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.expr.ValueSpaceClassification.VSPACE_STRING;
import static de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.expr.ValueSpaceClassification.VSPACE_TIME;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.expr.ExprEvalTypeException;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.expr.NodeValue;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.expr.ValueSpaceClassification;
...
{
	/*
	 * Date/time/duration coverage add, subtract (duration, duration)
	 * 
	 * (xsd:duration, xsd:duration) -> xsd:duration 10.6.1 op:add-yearMonthDurations 10.6.2 op:subtract-yearMonthDurations (xsd:duration, xsd:duration) ->
	 * xsd:duration 10.6.6 op:add-dayTimeDurations 10.6.7 op:subtract-dayTimeDurations* Java has general duration subtract
	 * 
	 * Subtract two date/times
	 * 
	 * (xsd:dateTime, xsd:dateTime) -> xsd:duration 10.8.1 op:subtract-dateTimes -> xsd:dayTimeDuration (xsd:date, xsd:date) -> xsd:duration 10.8.2
	 * op:subtract-dates (xsd:time, xsd:time) -> xsd:duration 10.8.3 op:subtract-times
	 * 
	 * Date/time and duration* Java has general duration subtract (error needed?)
	 * 
	 * (xsd:dateTime, xsd:duration) -> xsd:dateTime 10.8.4 op:add-yearMonthDuration-to-dateTime 10.8.5 op:add-dayTimeDuration-to-dateTime 10.8.6
	 * op:subtract-yearMonthDuration-from-dateTime 10.8.7 op:subtract-dayTimeDuration-from-dateTime
	 * 
	 * (xsd:date, xsd:duration) -> xsd:date 10.8.8 op:add-yearMonthDuration-to-date 10.8.9 op:add-dayTimeDuration-to-date 10.8.10
	 * op:subtract-yearMonthDuration-from-date 10.8.11 op:subtract-dayTimeDuration-from-date
	 * 
	 * (xsd:time, xsd:duration) -> xsd:time 10.8.12 op:add-dayTimeDuration-to-time 10.8.13 op:subtract-dayTimeDuration-from-time
	 * 
	 * (xsd:duration, xsd:double) -> xsd:duration 10.6.8 op:multiply-dayTimeDuration
	 */

	/*
	 * Missing: (xsd:duration, xsd:double) -> xsd:duration 10.6.9 op:divide-dayTimeDuration
	 * 
	 * (xsd:duration, xsd:duration) -> xsd:decimal 10.6.10 op:divide-dayTimeDuration-by-dayTimeDuration
	 */
	/*
	 * Notes: Does not consider whether a duration is dayTime or yearMonth for addition and subtraction. As per the Java (Xerces) implementation, it just work
	 * on durations.
	 */
	...
	public static NodeValue additionNV(NodeValue nv1, NodeValue nv2)
	{
		...
		if (vs1.equals(VSPACE_DURATION) && vs2.equals(VSPACE_DURATION))
		{
			...
			if (isDTDur)
				...
				n = de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.graph.NodeFactory.createLiteral(lex, XSDDatatype.XSDduration);
