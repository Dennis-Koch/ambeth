...
/**
 * The main ResultSet implementation for returning results from queries. This version is "use once" - you can not reset the result set because the results of
 * the query are not remembered so as not to consume potentially large amounts of memory.
 */
...
public class ResultSetStream implements ResultSet
{
	...
	private void close()
	{
		// ARQ QueryIterators are de.osthus.ambeth.rdf.repackaged.org.apache.jena.atlas.lib.Closable.
	...
	/**
	 * Return the "row number" - a count of the number of possibilities returned so far. Remains valid (as the total number of possibilities) after the iterator
	 * ends.
	 */
