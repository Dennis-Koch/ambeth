...
public interface OntClass extends OntResource
{
	...
	/**
	 * <p>
	 * Answer a class that is the super-class of this class. If there is more than one such class, an arbitrary selection is made. If there is no such
	 * super-class, return null.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Answer an iterator over all of the classes that are super-classes of this class. Each element of the iterator will be an {@link OntClass}. See
	 * {@link #listSubClasses(boolean )} for a full explanation of the <em>direct</em> parameter.
	 * </p>
	 * 
	 * @param direct
	 *            If true, only answer the directly adjacent classes in the super-class relation: i&#046;e&#046; eliminate any class for which there is a longer
	 ...
	 * model. The direct parameter is provided to allow, for example, a level-by-level traversal of the class hierarchy, starting at some given root. Observe
	 * that in Jena 1, passing <code>true</code> will tend to increase the number of results returned; in Jena 2 passing <code>true</code> will tend to reduce
	 * the number of results.
	 * </p>
	 * 
	 * @param direct
	 *            If true, only answer the directly adjacent classes in the sub-class relation: i&#046;e&#046; eliminate any class for which there is a longer
	...
	/**
	 * <p>
	 * Answer a class that is equivalent to this class. If there is more than one such class, an arbitrary selection is made. See
	 * {@link #listEquivalentClasses()} for a note on equivalent classes when using a reasoner.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Answer an iterator over all of the classes that are known to be equivalent to this class. Equivalence may be asserted in the model (using, for example,
	 * <code>owl:equivalentClass</code>, or may be inferred by the reasoner attached to the model. <strong>Note</strong> that the OWL semantics entails that
	 * every class is equivalent to itself, so when using a reasoning model clients should expect that this class will appear as a member of its own equivalent
	 * classes.
	 * </p>
	 * <p>
	 * Each element of the returned iterator will be an {@link OntClass}.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Return an iteration of the properties associated with a frame-like view of this class. This captures an informal notion of the <em>properties
	 * of a class</em>, by looking at the domains of the properties in this class's model, and matching them to this class. A full description of the frame-like
	 * view of a class may be found in: <a href="//how-to/rdf-frames.html">RDF frames how-to</a> for full details.
	 * <p>
	 * Note that many cases of determining whether a property is associated with a class depends on RDFS or OWL reasoning. This method may therefore return
	 * complete results only in models that have an attached reasoner. See the
	 * 
	 * @return An iteration of the properties that are associated with this class by their domain.
	 */
	...
	/**
	 * <p>
	 * Answer an iterator over the individuals in the model that have this class among their types. Equivalent to {@link #listInstances(boolean)} with an
	 * argument <code>false</code>.
	 * <p>
	 * 
	...
	/**
	 * <p>
	 * Answer true if this class is one of the roots of the local class hierarchy. This will be true if either (i) this class has <code>owl:Thing</code> as a
	 * direct super-class, or (ii) it has no declared super-classes (including anonymous class expressions).
	 * </p>
	 * 
	 ...
	 * 
	 * @param cls
	 *            An ontology class that will be operand of the complement
