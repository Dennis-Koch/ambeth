...
public class UpdateEngineMain extends UpdateEngineBase
{
	...
	/**
	 * Returns the {@link UpdateSink}. In this implementation, this is done by with an {@link UpdateVisitor} which will visit each update operation and send the
	 * operation to the associated {@link UpdateEngineWorker}.
	 */
	@Override
