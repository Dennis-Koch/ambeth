...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.query.ResultSetFactory;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.algebra.OpAsQuery;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.algebra.OpVars;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.algebra.op.OpService;
...
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.Rename;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.iterator.QueryIter;
import de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.iterator.QueryIteratorResultSet;
...
public class Service
{
	...
	/**
	 * Use this Symbol to allow passing additional service context variables SERVICE <IRI> call. Parameters need to be grouped by SERVICE <IRI>, a Map<String,
	 * Context> is assumed. The key of the first map is the SERVICE IRI, the value is a Context who's values will override any defaults in the original context.
	 * 
	 ...
	 * 
	 * @see de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.sparql.engine.QueryExecutionBase
	 */
