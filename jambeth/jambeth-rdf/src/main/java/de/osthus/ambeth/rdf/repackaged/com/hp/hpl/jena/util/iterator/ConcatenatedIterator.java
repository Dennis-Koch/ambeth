...
/**
 * An iterator that represents the concatenation of two individual iterators. The concatenated iterator will range over the elements of the first iterator,
 ...
 *             {@link de.osthus.ambeth.rdf.repackaged.com.hp.hpl.jena.util.iterator.WrappedIterator}
 */
@Deprecated
public class ConcatenatedIterator<T> implements Iterator<T>
{
	 ...
	 * 
	 * @param iter0
	 *            The first iterator. Elements of this iterator will appear first in the elements read from the concatenation.
	 * @param iter1
	 *            The second iterator. Elements of this iterator will appear second in the elements read from the concatenation.
	 */
	 ...
	 * 
	 * @return The next object in the iteration, which will correspond to the next object in the underlying iteration, projected to the range of the projection
	 *         function.
	...
	public T next()
	{
		...
		if (next0 || next1)
		{
			// Casts necessary : without, it does not compile with 1.6.0 update
			// 11 (it does in Eclipse)
	...
	/**
	 * Set the default value for this iteration, which will be a value that is guaranteed to be returned as a member of the iteration. To guarantee that the
	 * default value is only returned if it has not already been returned by the iterator, setting the default value should occur before the first call to
	 * {@link #next}.
	 * 
	 * @param defaultValue
	 *            The default value for the iteration, or null for there to be no default value. The default default value is null.
	 */
