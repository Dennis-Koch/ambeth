...
{
	String rdfns = "http://www.w3.org/1999/02/22-rdf-syntax-ns#".intern();
	...
	int CoreAndOldTerms = E_RDF | A_DEPRECATED | A_ABOUT | A_ID | A_NODEID | A_RESOURCE | A_PARSETYPE | A_DATATYPE | A_BAGID;
