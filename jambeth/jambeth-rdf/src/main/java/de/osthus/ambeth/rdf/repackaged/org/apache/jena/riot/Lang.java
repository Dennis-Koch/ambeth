...
/**
 * A "language" (syntax). A language has a name, some alternative names, a content type, some alternative content types, and a list of associated file
 * extensions. Names, content types and file extensions must be unique to one language. To create a Lang constant, use {@link LangBuilder} and register with
 * {@link RDFLanguages}.
 */
public class Lang
{
	...
	public boolean equals(Object other)
	{
		...
		return this.label == otherLang.label && this.contentType.equals(otherLang.contentType) && this.altContentTypes.equals(otherLang.altContentTypes)
