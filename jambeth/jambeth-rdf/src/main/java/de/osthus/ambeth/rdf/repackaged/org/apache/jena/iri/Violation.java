...
/**
 * Information concerning a violation of some specification concerning IRIs. This may be wrapped in an {@link IRIException} and thrown, or may be returned by
 * {@link IRI#violations(boolean)}. Which conditions result in errors and warnings depends on the setting of the related {@link IRIFactory}.
 */
public abstract class Violation implements ViolationCodes, IRIComponents
{
	...
	/**
	 * The value from {@link ViolationCodes} corresponding to this condition.
	 * 
	...
	/**
	 * The IRI that triggered this condition. If an IRI has been constructed by resolving a relative reference against a base IRI then exceptions associated
	 * with that IRI will have the most informative value here, which can be any of the three IRIs involved (the base IRI, the relative IRI or the resolved
	 * IRI).
	 * 
	...
	/**
	 * A value from {@link IRIComponents} indicating which component of the IRI is involved with this error.
	 * 
	...
	/**
	 * A short description of the error condition. (Short is in comparison with {@link #getLongMessage()}, not an absolute value).
	 * 
