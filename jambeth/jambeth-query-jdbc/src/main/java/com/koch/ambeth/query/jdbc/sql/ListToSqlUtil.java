...
public final class ListToSqlUtil {
	...
	public void expandValue(IAppendable querySB, Object value, IOperand self,
			IMap<Object, Object> nameToValueMap) {
		expandValue(querySB, value, self, nameToValueMap, null, null);
	}

	public void expandValue(IAppendable querySB, Object value, IOperand self,
			IMap<Object, Object> nameToValueMap, String prefix, String suffix) {
	...
	protected void expandItem(IAppendable querySB, Object value, IOperand self,
			IMap<Object, Object> nameToValueMap) {
		if (value == null) {
			querySB.append("NULL");
		}
