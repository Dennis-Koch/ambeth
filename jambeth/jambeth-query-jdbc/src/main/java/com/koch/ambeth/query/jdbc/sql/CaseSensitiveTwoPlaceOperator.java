...
abstract public class CaseSensitiveTwoPlaceOperator extends TwoPlaceOperator {
	...
	protected void processLeftOperandAspect(IAppendable querySB, IMap<Object, Object> nameToValueMap,
		...
		if (supportsMultiValueOperand()
				&& java.sql.Array.class.isAssignableFrom(leftOperandFieldType)) {
	...
	protected void processRightOperandAspect(IAppendable querySB, IMap<Object, Object> nameToValueMap,
		...
		if (supportsMultiValueOperand() && rightOperand instanceof IMultiValueOperand) {
			...
			handleMultiValueOperand((IMultiValueOperand) rightOperand, querySB, nameToValueMap, joinQuery,
					leftOperandFieldType, parameters);
		...
		super.processRightOperandAspect(querySB, nameToValueMap, joinQuery, leftOperandFieldType,
				parameters);
		if (!caseSensitive) {
			querySB.append(')');
		}
	...
	protected void handleMultiValueOperand(IMultiValueOperand operand, IAppendable querySB,
	...
	protected void handleWithSingleValueLeftField(IAppendable querySB,
	...
	protected void handleWithMultiValueLeftField(IAppendable querySB,
			IMap<Object, Object> nameToValueMap, IList<Object> parameters,
			IList<IList<Object>> splitValues) {
		Class<?> leftOperandFieldType = getLeftOperandFieldSubType();
		connectionDialect.handleWithMultiValueLeftField(querySB, nameToValueMap, parameters,
				splitValues, caseSensitive, leftOperandFieldType);
		nameToValueMap.remove(QueryConstants.REMAINING_RIGHT_OPERAND_HANDLE);
	}
}
