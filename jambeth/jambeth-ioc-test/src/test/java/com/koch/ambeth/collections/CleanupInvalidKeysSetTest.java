...
public class CleanupInvalidKeysSetTest extends AbstractIocTest
		implements IInvalidKeyChecker<TestKey> {
	...
	public void invalidKeys() {
		CleanupInvalidKeysSet<TestKey> set = new CleanupInvalidKeysSet<>(this);
		int count = 1000000;
		for (int a = count; a-- > 0;) {
