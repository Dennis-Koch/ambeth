...
public class ByteArrayConverterTest {
	...
	public void testConvertValueToType_Plain() {
		...
		byte[] converted =
				(byte[]) fixture.convertValueToType(byte[].class, String.class, expected, null);
		String actual =
				(String) fixture.convertValueToType(String.class, byte[].class, converted, null);
	...
	public void testConvertValueToType_Base64() {
		String expected = "Not yet implemented";
		byte[] converted = (byte[]) fixture.convertValueToType(byte[].class, String.class, expected,
				EncodingInformation.SOURCE_PLAIN | EncodingInformation.TARGET_BASE64);
		String actual = (String) fixture.convertValueToType(String.class, byte[].class, converted,
