...
@TestPropertiesList({
		@TestProperties(name = AmbethIocRunnerTest.TEST_PROPERTY_NAME, value = "value1"),
		@TestProperties(name = AmbethIocRunnerTest.TEST_PROPERTY_NAME, value = "value2"),
		@TestProperties(name = "test.string.empty", value = ""),
