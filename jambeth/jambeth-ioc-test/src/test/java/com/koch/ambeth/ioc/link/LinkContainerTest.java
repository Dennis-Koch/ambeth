...
public class LinkContainerTest extends AbstractIocTest {
    ...
    public void setUp() {
        ...
        childContext = beanContext.createService(beanContextFactory -> beanContextFactory.registerExternalBean(FOREIGN_CONTEXT_NAME, foreignContext), LinkContainerTestModule.class);
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_NAME"), @TestProperties(name = RegistryProp, value = "BY_EXTENDABLE")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_NAME"), @TestProperties(name = RegistryProp, value = "BY_NAME_AND_EXTENDABLE")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_NAME"), @TestProperties(name = RegistryProp, value = "BY_NAME_AND_EVENT")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_NAME"), @TestProperties(name = RegistryProp, value = "BY_NAME_AND_PROPERTY")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_NAME"), @TestProperties(name = RegistryProp, value = "BY_INSTANCE_AND_EXTENDABLE")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_NAME"), @TestProperties(name = RegistryProp, value = "BY_INSTANCE_AND_EVENT")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_NAME"), @TestProperties(name = RegistryProp, value = "BY_INSTANCE_AND_PROPERTY")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_NAME"), @TestProperties(name = RegistryProp, value = "BY_AUTOWIRING_AND_EXTENDABLE")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_NAME"), @TestProperties(name = RegistryProp, value = "BY_AUTOWIRING_AND_EVENT")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_NAME"), @TestProperties(name = RegistryProp, value = "BY_AUTOWIRING_AND_PROPERTY")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_NAME_AND_METHOD"), @TestProperties(name = RegistryProp, value = "BY_EXTENDABLE")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_NAME_AND_METHOD"), @TestProperties(name = RegistryProp, value = "BY_NAME_AND_EXTENDABLE")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_NAME_AND_METHOD"), @TestProperties(name = RegistryProp, value = "BY_NAME_AND_EVENT")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_NAME_AND_METHOD"), @TestProperties(name = RegistryProp, value = "BY_NAME_AND_PROPERTY")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_NAME_AND_METHOD"), @TestProperties(name = RegistryProp, value = "BY_INSTANCE_AND_EXTENDABLE")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_NAME_AND_METHOD"), @TestProperties(name = RegistryProp, value = "BY_INSTANCE_AND_EVENT")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_NAME_AND_METHOD"), @TestProperties(name = RegistryProp, value = "BY_INSTANCE_AND_PROPERTY")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_CONF"), @TestProperties(name = RegistryProp, value = "BY_EXTENDABLE")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_CONF"), @TestProperties(name = RegistryProp, value = "BY_NAME_AND_EXTENDABLE")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_CONF"), @TestProperties(name = RegistryProp, value = "BY_NAME_AND_EVENT")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_CONF"), @TestProperties(name = RegistryProp, value = "BY_NAME_AND_PROPERTY")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_CONF"), @TestProperties(name = RegistryProp, value = "BY_INSTANCE_AND_EXTENDABLE")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_CONF"), @TestProperties(name = RegistryProp, value = "BY_INSTANCE_AND_EVENT")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_CONF"), @TestProperties(name = RegistryProp, value = "BY_INSTANCE_AND_PROPERTY")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_INSTANCE"), @TestProperties(name = RegistryProp, value = "BY_EXTENDABLE")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_INSTANCE"), @TestProperties(name = RegistryProp, value = "BY_NAME_AND_EXTENDABLE")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_INSTANCE"), @TestProperties(name = RegistryProp, value = "BY_NAME_AND_EVENT")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_INSTANCE"), @TestProperties(name = RegistryProp, value = "BY_NAME_AND_PROPERTY")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_INSTANCE"), @TestProperties(name = RegistryProp, value = "BY_INSTANCE_AND_EXTENDABLE")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_INSTANCE"), @TestProperties(name = RegistryProp, value = "BY_INSTANCE_AND_EVENT")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = ListenerProp, value = "BY_INSTANCE"), @TestProperties(name = RegistryProp, value = "BY_INSTANCE_AND_PROPERTY")
    })
    ...
    public static enum RegistryVariant {
        BY_EXTENDABLE, BY_NAME_AND_EXTENDABLE, BY_NAME_AND_PROPERTY, BY_NAME_AND_EVENT, BY_INSTANCE_AND_EXTENDABLE, BY_INSTANCE_AND_PROPERTY, BY_INSTANCE_AND_EVENT, BY_AUTOWIRING_AND_EXTENDABLE,
        BY_AUTOWIRING_AND_PROPERTY, BY_AUTOWIRING_AND_EVENT;
    }
    ...
    public static class LinkContainerTestModule implements IInitializingModule {
        ...
        @Override
        public void afterPropertiesSet(IBeanContextFactory beanContextFactory) throws Throwable {
            IBeanConfiguration registryC = beanContextFactory.registerBean(REGISTRY_NAME, TestRegistry.class).autowireable(ITestListenerExtendable.class, ITestRegistry.class);
