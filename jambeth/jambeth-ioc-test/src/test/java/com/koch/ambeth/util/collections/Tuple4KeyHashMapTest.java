...
public class Tuple4KeyHashMapTest {
    ...
    protected Tuple4KeyHashMap<Integer, Long, Double, Float, Object> fillForTest() {
        Tuple4KeyHashMap<Integer, Long, Double, Float, Object> map = new Tuple4KeyHashMap<>();
        for (int a = 100; a-- > 20; ) {
    ...
    @Test
    public void init() {
        Tuple4KeyHashMap<Integer, Long, Double, Float, Object> map = new Tuple4KeyHashMap<>(100, 0.75f);
        map.init();
    }
