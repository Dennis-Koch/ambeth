...
public class LogStreamTest extends AbstractIocTest {
	...
	public void testStream() throws Throwable {
		...
		ILogger log1 =
				context1.getService(ILoggerCache.class).getCachedLogger(props1, LogStreamTest.class);
		ILogger log2 =
				context2.getService(ILoggerCache.class).getCachedLogger(props2, LogStreamTest.class);
