...
public class ClassTupleExtendableContainerTest extends AbstractIocTest {
	...
	public void setUp() throws Exception {
		fixture = new ClassTupleExtendableContainer<>("object", "type", false);
	}
	...
	public void registerSimple() {
		...
		Assert.assertSame("Registration failed", obj1,
				fixture.getExtension(ArrayList.class, byte[].class));
		Assert.assertSame("Registration failed", 1, fixture.getExtensions().size());
		Assert.assertSame("Registration failed", obj1,
				fixture.getExtensions().get(new ConversionKey(ArrayList.class, byte[].class)));
	}
	...
	public void strongAndWeakSimple() {
		...
		Assert.assertSame("String registration failed", obj1,
				fixture.getExtension(ArrayList.class, String.class));
		Assert.assertSame("Weak registration to parent class failed", obj1,
				fixture.getExtension(AbstractList.class, String.class));
		Assert.assertSame("Weak registration to interface failed", obj1,
				fixture.getExtension(List.class, String.class));
		Assert.assertSame("Weak registration to parent interface failed", obj1,
				fixture.getExtension(Collection.class, String.class));

		Assert.assertSame("String registration failed", obj1,
				fixture.getExtension(ArrayList.class, CharSequence.class));
		Assert.assertSame("Weak registration to parent class failed", obj1,
				fixture.getExtension(AbstractList.class, CharSequence.class));
		Assert.assertSame("Weak registration to interface failed", obj1,
				fixture.getExtension(List.class, CharSequence.class));
		Assert.assertSame("Weak registration to parent interface failed", obj1,
				fixture.getExtension(Collection.class, CharSequence.class));
	}
	...
	public void strongAndWeak() {
		...
		Assert.assertSame("Registration failed somehow", obj2,
				fixture.getExtension(LinkedList.class, String.class));
	}

	/**
	 * Checks that unregistering an extension from a specific type does interfere neither with other
	 * specific types of same extension nor with other extensions
	 */
	@Test
	public void strongIsolated() {
		fixture = new ClassTupleExtendableContainer<>("object", "type", true);
		...
		Assert.assertSame("Registration failed somehow", obj2,
				fixture.getExtension(LinkedList.class, CharSequence.class));
		Assert.assertSame("Registration failed somehow", obj1,
				fixture.getExtension(ArrayList.class, CharSequence.class));
		Assert.assertSame("Registration failed somehow", obj1,
				fixture.getExtension(List.class, CharSequence.class));
