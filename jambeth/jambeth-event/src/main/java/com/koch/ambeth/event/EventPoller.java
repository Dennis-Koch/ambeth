...
public class EventPoller implements IEventPoller, IOfflineListener, IStartingBean, IDisposableBean {
    ...
    public void startPolling() {
        ...
        thread = new Thread(() -> {
            if (thread == Thread.currentThread()) {
                pcs.firePropertyChange(this, P_ACTIVE, false, true);
            }
            try {
                ...
                if (thread == Thread.currentThread()) {
                    setConnected(false);
                    pcs.firePropertyChange(this, P_ACTIVE, true, false);
                }
            }
        });
    ...
    protected long tryPolling(long currentServerSession, long currentEventSequence, AtomicBoolean errorOccured) {
        ...
        try {
            ...
            while (currEx != null) {
                if (currEx instanceof EventPollException) {
                    ...
                    eventDispatcher.dispatchEvent(new EventSessionChanged(eventService, currentServerSession, newServerSession));
                    break;
                }
    ...
    protected void setConnected(boolean connected) {
        ...
        pcs.firePropertyChange(this, P_CONNECTED, oldConnected, connected);
    }
