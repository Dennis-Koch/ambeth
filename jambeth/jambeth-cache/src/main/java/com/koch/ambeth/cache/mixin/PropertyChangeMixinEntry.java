...
public class PropertyChangeMixinEntry {
	...
	public PropertyChangeMixinEntry(Class<?> type, String propertyName, String javaBeansPropertyName,
		...
		PropertyChangeMixin.evaluateDependentProperties(type, prop, propertyNames,
		...
		while (true) {
			...
			for (String currPropertyName : new ArrayList<>(propertyNames)) {
				...
				PropertyChangeMixin.evaluateDependentProperties(type, currProp, propertyNames,
						propertyInfoProvider);
			}
