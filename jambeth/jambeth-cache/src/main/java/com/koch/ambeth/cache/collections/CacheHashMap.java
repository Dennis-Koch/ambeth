...
public class CacheHashMap implements Iterable<CacheMapEntry> {
	...
	public CacheHashMap(int initialCapacity, float loadFactor,
			ICacheMapEntryTypeProvider cacheMapEntryTypeProvider) {
	...
	protected void addEntry(final Class<?> entityType, final Object id, final byte idIndex,
			final Object value, final int bucketIndex) {
	...
	public Object put(final Class<?> entityType, final byte idIndex, final Object id,
			final Object value) {
		final int hash = hash(extractHash(entityType, id, idIndex));
		CacheMapEntry[] table = this.table;
		final int i = hash & (table.length - 1);
	...
	public boolean putIfNotExists(final Class<?> entityType, final byte idIndex, final Object id,
			final Object value) {
		final int hash = hash(extractHash(entityType, id, idIndex));
		CacheMapEntry[] table = this.table;
		final int i = hash & (table.length - 1);
	...
	public boolean removeIfValue(final Class<?> entityType, final byte idIndex, final Object id,
			final Object value) {
		final int hash = hash(extractHash(entityType, id, idIndex));
		CacheMapEntry[] table = this.table;
		final int i = hash & (table.length - 1);
	...
	protected final Object removeEntryForKey(final Class<?> entityType, final byte idIndex,
			final Object id) {
		final int hash = hash(extractHash(entityType, id, idIndex));
		CacheMapEntry[] table = this.table;
		final int i = hash & (table.length - 1);
	...
	protected CacheMapEntry createEntry(final Class<?> entityType, final Object id,
			final byte idIndex, final Object value, final CacheMapEntry nextEntry) {
		ICacheMapEntryFactory factory =
				cacheMapEntryTypeProvider.getCacheMapEntryType(entityType, idIndex);
