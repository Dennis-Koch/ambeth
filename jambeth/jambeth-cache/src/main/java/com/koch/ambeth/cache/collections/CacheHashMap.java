...
public class CacheHashMap implements Iterable<CacheMapEntry> {
    ...
    protected final Object removeEntryForKey(final Class<?> entityType, final byte idIndex, final Object id) {
        var hash = hash(extractHash(entityType, id, idIndex));
    ...
    protected CacheMapEntry createEntry(final Class<?> entityType, final Object id, final byte idIndex, final Object value, final CacheMapEntry nextEntry) {
        var factory = cacheMapEntryTypeProvider.getCacheMapEntryType(entityType, idIndex);
    ...
    protected void transfer(final CacheMapEntry[] newTable) {
        ...
        for (int a = table.length; a-- > 0; ) {
            ...
            while (entry != null) {
                ...
                var hash = hash(extractHash(entry.getEntityType(), entry.getId(), entry.getIdIndex()));
                var i = hash & newCapacityMinus1;
    ...
    public Object[] toArray() {
        var index = 0;
        var targetArray = new Object[size()];
        var table = this.table;
        for (int a = table.length; a-- > 0; ) {
            var entry = table[a];
            while (entry != null) {
    ...
    public void clear() {
        ...
        for (int a = table.length; a-- > 0; ) {
            ...
            if (entry != null) {
                table[a] = null;
                while (entry != null) {
                    var nextEntry = entry.getNextEntry();
                    entryRemoved(entry);
                    entry = nextEntry;
                }
            }
