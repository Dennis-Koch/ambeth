...
public class MergePrefetchPathsCache {
    ...
    private final Tuple3KeyHashMap<Class<?>, PrefetchPath[], IMap<Class<?>, PrefetchPath[]>, PrefetchPath[]> prefetchPathsMap = new Tuple3KeyHashMap<>();
    ...
    public PrefetchPath[] mergePrefetchPaths(Class<?> entityType, PrefetchPath[] relativePrefetchPath, IMap<Class<?>, PrefetchPath[]> entityTypeToPrefetchPaths) {
        ...
        prefetchPaths = tempPrefetchPaths.toArray(PrefetchPath[]::new);
