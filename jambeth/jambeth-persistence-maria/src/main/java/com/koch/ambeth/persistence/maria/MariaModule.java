...
public class MariaModule implements IInitializingModule, IPropertyLoadingBean {
	...
	public void afterPropertiesSet(IBeanContextFactory beanContextFactory) throws Throwable {
		...
		beanContextFactory.registerBean(MariaExtendedDialect.class)
		...
		beanContextFactory.registerBean(MariaSequencePrimaryKeyProvider.class)
				.autowireable(IPrimaryKeyProvider.class);

		beanContextFactory.registerBean(MariaConnectionExtension.class)
