...
public class CharArrayConverterTest {
	...
	public void testConvertValueToType_Plain() {
		...
		char[] converted =
				(char[]) fixture.convertValueToType(char[].class, String.class, expected, null);
		String actual =
				(String) fixture.convertValueToType(String.class, char[].class, converted, null);
	...
	public void testConvertValueToType_Base64() {
		String expected = "Not yet implemented";
		char[] converted = (char[]) fixture.convertValueToType(char[].class, String.class, expected,
				EncodingInformation.SOURCE_PLAIN | EncodingInformation.TARGET_BASE64);
		String actual = (String) fixture.convertValueToType(String.class, char[].class, converted,
