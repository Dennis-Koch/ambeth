...
public class Tuple2KeyHashMapTest {
	...
	protected Tuple2KeyHashMap<Integer, Long, Object> fillForTest() {
		Tuple2KeyHashMap<Integer, Long, Object> map = new Tuple2KeyHashMap<>();
		for (int a = 100; a-- > 20;) {
	...
	@Test
	public void init() {
		Tuple2KeyHashMap<Integer, Long, Object> map =
				new Tuple2KeyHashMap<>(100, 0.75f);
		map.init();
	}
	...
	public void serialize() throws Throwable {
		...
		}
		{
			...
			Tuple2KeyHashMap<Integer, Long, Object> cloneMap =
					(Tuple2KeyHashMap<Integer, Long, Object>) is.readObject();
