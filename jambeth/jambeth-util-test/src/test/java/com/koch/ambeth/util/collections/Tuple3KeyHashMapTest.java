...
public class Tuple3KeyHashMapTest
{
	...
	{
		Tuple3KeyHashMap<Integer, Long, Double, Object> map = new Tuple3KeyHashMap<Integer, Long, Double, Object>();
		for (int a = 100; a-- > 20;)
		{
	...
	public void init()
	{
		Tuple3KeyHashMap<Integer, Long, Double, Object> map = new Tuple3KeyHashMap<Integer, Long, Double, Object>(100, 0.75f);
		map.init();
	}
