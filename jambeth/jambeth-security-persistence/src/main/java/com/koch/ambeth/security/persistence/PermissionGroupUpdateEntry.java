...
public class PermissionGroupUpdateEntry {
    ...
    protected List<Object> permissionGroupIds;

    protected int startIndexInAllObjRefs;

    public PermissionGroupUpdateEntry(Class<?> entityType, IPermissionGroup permissionGroup) {
    ...
    public List<Object> getPermissionGroupIds() {
        return permissionGroupIds;
    }

    public void setPermissionGroupIds(List<Object> permissionGroupIds) {
