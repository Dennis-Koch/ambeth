...
INSERT INTO "BL_ENTITY_ANNO" (ID, VERSION, TYPE)  VALUES (1, 1, 'de.osthus.ambeth.audit.model.Audited');
...
-- Value object
INSERT INTO "BL_ENTITY_TYPE" (ID, VERSION, NAME, SUPERCLASS, IS_CLASS) VALUES (2, 2, 'de.osthus.ambeth.persistence.blueprint.TestClassV', 'de.osthus.ambeth.persistence.blueprint.TransferEntity', 1);
