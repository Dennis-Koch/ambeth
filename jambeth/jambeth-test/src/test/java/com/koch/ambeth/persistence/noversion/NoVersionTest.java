...
@TestPropertiesList({
        ...
        @TestProperties(name = ServiceConfigurationConstants.mappingFile, value = "com/koch/ambeth/persistence/noversion/orm.xml"),
...
public class NoVersionTest extends AbstractInformationBusWithPersistenceTest {
    ...
    public void testCreate() throws Exception {
        var entity = entityFactory.createEntity(NoVersion.class);
    ...
    public void testUpdate() throws Exception {
        var newName = "eins punkt zwei";
        var entity = cache.getObject(NoVersion.class, 1);
        assertFalse(newName.equals(entity.getName()));
        entity.setName(newName);
        noVersionService.update(entity);

        var actual = cache.getObject(NoVersion.class, 1);
    ...
    public void testQuery() throws Exception {
        var qb = queryBuilderFactory.create(NoVersion.class);
        var query = qb.build(qb.let(qb.property("Name")).isEqualTo(qb.value("zwei")));
    ...
    public void testUpdateWithoutOptimisticLocking() throws Exception {
        ...
        var entityInst1 = cache.getObject(NoVersion.class, 1);
        var entityInst2 = cacheFactory.create(CacheFactoryDirective.SubscribeGlobalDCE, "test").getObject(NoVersion.class, 1);
        ...
        var actual1 = cacheFactory.create(CacheFactoryDirective.SubscribeGlobalDCE, "test").getObject(NoVersion.class, 1);
        assertEquals(newName1, actual1.getName());

        entityInst2.setName(newName2);
        noVersionService.update(entityInst2);

        var actual2 = cacheFactory.create(CacheFactoryDirective.SubscribeGlobalDCE, "test").getObject(NoVersion.class, 1);
