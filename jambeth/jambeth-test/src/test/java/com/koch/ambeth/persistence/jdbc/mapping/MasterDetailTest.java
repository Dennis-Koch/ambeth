...
public class MasterDetailTest extends AbstractInformationBusWithPersistenceTest {
    ...
    public void testNewVOs() {
        ...
        masterVO.getDetails().getDetails().addAll(Arrays.asList(new DetailVO(), new DetailVO(), new DetailVO(), new DetailVO(), new DetailVO(), new DetailVO()));
    ...
    public void testNewBOs() {
        var masterBO = entityFactory.createEntity(Master.class);
        masterBO.setDetails(entityFactory.createEntity(Detail.class, 6));

        var masterVO = mapperService.mapToValueObject(masterBO, MasterVO.class);
