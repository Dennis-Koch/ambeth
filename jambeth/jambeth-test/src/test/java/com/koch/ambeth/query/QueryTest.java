...
public class QueryTest extends AbstractInformationBusWithPersistenceTest {
    ...
    public void testRetrieveAsEntityCursor() throws Exception {
        ...
        transaction.processAndCommit(new DatabaseCallback() {
            @Override
            public void callback(com.koch.ambeth.util.collections.ILinkedMap<Object, IDatabase> persistenceUnitToDatabaseMap) throws Exception {
    ...
    public void retrieveWhereNullByEqual() throws Exception {
        ...
        IQuery<QueryEntity> query = qb.build(qb.let(qb.property(propertyName3)).isEqualTo(qb.valueName(paramName1)));
    ...
    public void retrieveWhereNotNullByEqual() throws Exception {
        ...
        IQuery<QueryEntity> query = qb.build(qb.let(qb.property(propertyName3)).isNotEqualTo(qb.valueName(paramName1)));
    ...
    public void retrieveWhereGTNullByEqual() throws Exception {
        IQuery<QueryEntity> query = qb.build(qb.let(qb.property(propertyName3)).isGreaterThan(qb.valueName(paramName1)));
    ...
    public void retrieveByDate_long() {
        ...
        IQuery<QueryEntity> query = qb.build(qb.let(qb.property("UpdatedOn")).isEqualTo(qb.value(updatedOn)));
    ...
    public void retrieveByDate_Date() {
        ...
        IQuery<QueryEntity> query = qb.build(qb.let(qb.property("UpdatedOn")).isEqualTo(qb.value(updatedOnDate)));
        IList<QueryEntity> res = query.retrieve();
        Assert.assertNotNull(res);
        Assert.assertEquals(1, res.size());
        Assert.assertEquals(1, res.get(0).getId());
    ...
    public void retrieveByDate_Timestamp() {
        ...
        IQuery<QueryEntity> query = qb.build(qb.let(qb.property("UpdatedOn")).isEqualTo(qb.value(timestamp)));
        IList<QueryEntity> res = query.retrieve();
        Assert.assertNotNull(res);
        Assert.assertEquals(1, res.size());
        Assert.assertEquals(1, res.get(0).getId());
    ...
    public void retrievePagingAfterUpdate() throws Exception {
        transaction.processAndCommit(new DatabaseCallback() {
            ...
            public void callback(ILinkedMap<Object, IDatabase> persistenceUnitToDatabaseMap) throws Exception {
                ...
                IPagingQuery<QueryEntity> query = qb.buildPaging(qb.let(qb.property(QueryEntity.Name1)).isNotEqualTo(qb.value(name1Value)));
    ...
    public void testJoinQuery() throws Exception {
        ...
        IQuery<QueryEntity> query = qb.build(qb.let(qb.property("Fk.Version")).isEqualTo(qb.valueName(paramName1)));
    ...
    public void testJoinToSelfQuery() throws Exception {
        ...
        ISqlJoin joinClause1 = qb.join(QueryEntity.class, qb.and(qb.let(verQE1).isEqualTo(verQE2), qb.let(idQE1).isNotEqualTo(idQE2)), JoinType.LEFT);
    ...
    public void testQueryKeyUniqueness() throws Exception {
        IQuery<QueryEntity> query = qb.build(qb.or(qb.let(qb.property("Id")).isEqualTo(qb.value(3)), qb.let(qb.property("Fk.Version")).isEqualTo(qb.value(3))));
        IQueryKey queryKey = query.getQueryKey(nameToValueMap);

        qb = queryBuilderFactory.create(QueryEntity.class);
        IQuery<QueryEntity> query2 = qb.build(qb.or(qb.let(qb.property("Fk.Id")).isEqualTo(qb.value(3)), qb.let(qb.property("Version")).isEqualTo(qb.value(3))));
