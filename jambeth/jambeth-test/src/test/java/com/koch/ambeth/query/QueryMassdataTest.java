...
public class QueryMassdataTest extends AbstractInformationBusWithPersistenceTest {
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = CacheConfigurationConstants.ServiceResultCacheActive, value = "true"), @TestProperties(name = PersistenceConfigurationConstants.QueryCacheActive, value = "true")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = CacheConfigurationConstants.SecondLevelCacheActive, value = "true"), @TestProperties(name = PersistenceConfigurationConstants.QueryCacheActive, value = "true")
    })
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = CacheConfigurationConstants.SecondLevelCacheActive, value = "true"), @TestProperties(name = CacheConfigurationConstants.ServiceResultCacheActive, value = "true")
    })
