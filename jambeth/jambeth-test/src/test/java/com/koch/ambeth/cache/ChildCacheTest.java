...
public class ChildCacheTest extends AbstractInformationBusTest {
    ...
    public void testGetObjectsListOfIObjRefSetOfCacheDirective() {
        ...
        List<Object> actual = childCache.getObjects(orisToGet, CacheDirective.returnMisses());
    ...
    public void testPutIntern() {
        ...
        childCache.putIntern(objectToCache, new ArrayList<>(), alreadyHandledSet, new HashSet<IObjRef>());
