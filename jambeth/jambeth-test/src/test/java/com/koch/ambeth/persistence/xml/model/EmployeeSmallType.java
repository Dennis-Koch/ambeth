...
public class EmployeeSmallType extends AbstractEntity {
	...
	protected EmployeeSmallType supervisor;
	...
	public EmployeeSmallType getSupervisor() {
		return supervisor;
	}

	public void setSupervisor(EmployeeSmallType supervisor) {
