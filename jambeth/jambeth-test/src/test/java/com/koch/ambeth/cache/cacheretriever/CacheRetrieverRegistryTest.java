...
@TestProperties(name = ServiceConfigurationConstants.mappingFile, value = CacheRetrieverRegistryTest.basePath + "orm.xml;" + CacheRetrieverRegistryTest.basePath + "external-orm.xml")
...
public class CacheRetrieverRegistryTest extends AbstractInformationBusWithPersistenceTest {
    ...
    @Test
    public void testGetEntityByAlternateId() {
        int id = 152;
    ...
    @Test
    public void testLocalEntityWithExternalToOneRelationFK() {
        int id = 893;
    ...
    @Test
    public void testLocalEntityWithExternalToOneRelationLinkTable() {
        int id = 893;
        String name = "LocalEntity " + id;
        LocalEntity actual = cache.getObject(LocalEntity.class, id);
        assertNotNull(actual);
    ...
    @Test
    public void testLocalEntityWithExternalToManyRelationLinkTable() {
        int id = 893;
        LocalEntity actual = cache.getObject(LocalEntity.class, id);
