...
public class SimpleInMemoryDatabaseTest extends AbstractInformationBusWithPersistenceTest {
    ...
    @Test
    @TestPropertiesList({
            @TestProperties(name = PersistenceConfigurationConstants.DatabasePoolMaxUsed, value = "5"), @TestProperties(name = PersistenceConfigurationConstants.DatabasePoolMaxUnused, value = "5")
    })
