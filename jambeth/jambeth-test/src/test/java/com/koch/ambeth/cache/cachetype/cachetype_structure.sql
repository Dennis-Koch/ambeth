...
CREATE TABLE "TBL_BASE"
  (
    ...
    CONSTRAINT "FK_BASE_AE_NAME_TO_AE_NAME" FOREIGN KEY ("AE_NAME") REFERENCES "TBL_AE" ("NAME") DEFERRABLE INITIALLY IMMEDIATE
);
...
CREATE TABLE "TBL_BASE2"
  (
    ...
    CONSTRAINT "FK_BASE2_AE_NAME_TO_AE_NAME" FOREIGN KEY ("AE_NAME") REFERENCES "TBL_AE" ("NAME") DEFERRABLE INITIALLY IMMEDIATE
);
