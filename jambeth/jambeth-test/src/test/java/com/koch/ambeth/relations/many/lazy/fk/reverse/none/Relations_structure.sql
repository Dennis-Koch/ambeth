...
CREATE TABLE "ENTITY_A" (
    ...
    CONSTRAINT "ENTITY_A_AK_NAME" UNIQUE ("NAME"),
    CONSTRAINT "LINK_ENTITY_A_ENTITY_B_FK1" FOREIGN KEY ("ENTITY_B_ID") REFERENCES "ENTITY_B" ("ID") DEFERRABLE INITIALLY DEFERRED
);
...
CREATE TABLE "ENTITY_B" (
    ...
    CONSTRAINT "ENTITY_B_AK_NAME" UNIQUE ("NAME")
);
