...
public class FinderTest extends AbstractInformationBusWithPersistenceTest {
    ...
    public void testRetrieve() {
        var entity = entityBService.retrieve(1);
    ...
    public void testRetrieveList() {
        var entities = entityBService.retrieve(Arrays.asList(1, 2));
    ...
    public void testFindReferences() {
        ...
        var filterDescriptor = new FilterDescriptor<>(Entity.class);
        ...
        var pagingResponse = entityBService.findReferences(pagingRequest, filterDescriptor, sortDescriptors);
    ...
    public void testFindReferencesAlternateIdName() {
        ...
        var pagingResponse = entityBService.findReferencesAlternate(pagingRequest, filterDescriptor, sortDescriptors);
        assertNotNull(pagingResponse);
        assertNotNull(pagingResponse.getRefResult());
        assertEquals(1, pagingResponse.getRefResult().size());
    ...
    public void testFindEntities() {
        ...
        var pagingResponse = entityBService.findEntities(pagingRequest, filterDescriptor, sortDescriptors);
        assertNotNull(pagingResponse);
    ...
    public void testFindBoth() {
        ...
        var pagingResponse = entityBService.findBoth(pagingRequest, filterDescriptor, sortDescriptors);
        assertNotNull(pagingResponse);
        assertNotNull(pagingResponse.getRefResult());
        assertEquals(1, pagingResponse.getRefResult().size());
        assertEquals(2, pagingResponse.getRefResult().get(0).getId());
