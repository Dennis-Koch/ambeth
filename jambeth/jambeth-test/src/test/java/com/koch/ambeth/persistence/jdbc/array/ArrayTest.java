...
public class ArrayTest extends AbstractInformationBusWithPersistenceTest {
    ...
    public void createShortArray2() {
        Short[] array = new Short[] {
                Short.valueOf((short) 10), Short.valueOf((short) 8), Short.MIN_VALUE, Short.MAX_VALUE, Short.valueOf((short) 0)
        };
    ...
    public void selectStringArray() {
        ...
        IQuery<ArrayObject> query = queryBuilder.build(queryBuilder.let(queryBuilder.property("ArrayContentString")).isIn(queryBuilder.value(Arrays.<String>asList("bla", "hallo")), false));
