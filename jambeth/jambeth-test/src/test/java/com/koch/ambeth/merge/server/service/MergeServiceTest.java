...
public class MergeServiceTest extends AbstractInformationBusWithPersistenceTest {
    ...
    public void testConvertChangeContainersToCommands_oneCreateContainer() {
        ...
        fixture.convertChangeContainersToCommands(fixture.database.getCurrent(), allChanges, tableChangeMap, typeToIdlessReferenceMap, linkChangeCommands, toDeleteMap, objRefToChangeContainerMap,
