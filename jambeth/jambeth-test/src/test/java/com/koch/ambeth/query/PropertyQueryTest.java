...
public class PropertyQueryTest extends AbstractInformationBusWithPersistenceTest {
    ...
    public void testSimpleQuery() throws Exception {
        ...
        IQuery<QueryEntity> query = qb.build(qb.let(qb.property(propertyName1)).isEqualTo(qb.value(expectedIds.get(0))));
    ...
    public void testPropertyOverLinkTable() throws Exception {
        ...
        IQuery<QueryEntity> query = qb.build(qb.let(qb.property(propertyName6)).isEqualTo(qb.value(2)));
    ...
    public void testMidRangeQuery() throws Exception {
        ...
        IQuery<QueryEntity> query = qb.build(
                qb.or(qb.and(qb.let(qb.property(propertyName2)).isEqualTo(qb.value(2)), qb.and(qb.let(idProp).isNotEqualTo(qb.value(1)), qb.let(idProp).isNotEqualTo(qb.value(5)))),
    ...
    public void testJoinQuery() throws Exception {
        ...
        IQuery<QueryEntity> query = qb.build(qb.let(qb.property(propertyName3)).isEqualTo(qb.parameterValue(paramName1)));
    ...
    public void testJoinQuery2() throws Exception {
        ...
        IQuery<QueryEntity> query = qb.build(qb.or(qb.and(qb.let(qb.property(propertyName3)).isEqualTo(qb.value(3)), qb.let(qb.property(propertyName4)).isNotEqualTo(qb.value(2))),
    ...
    public void testJoinQuery2_proxyAPI() throws Exception {
        ...
        IQuery<QueryEntity> query = qb.build(qb.or(//
                qb.and(qb.let(fk.getJoinValue1()).isEqualTo(3), qb.let(fk.getJoinValue2()).isNotEqualTo(2)), //
    ...
    public void testTwoJoinsQuery() throws Exception {
        ...
        IQuery<QueryEntity> query = qb.build(qb.let(qb.property(propertyName5)).isEqualTo(qb.value(3)));
    ...
    public void testRelationByValue() throws Exception {
        ...
        IQuery<QueryEntity> query = qb.build(qb.let(qb.property(propertyName7)).isEqualTo(qb.value(2)));
    ...
    public void testRelationByEntity() throws Exception {
        ...
        IQuery<QueryEntity> query = qb.build(qb.let(qb.property(propertyName7)).isEqualTo(qb.value(jqe)));
    ...
    public void testAndList() {
        ...
        IQuery<QueryEntity> query =
                qb.build(qb.and(qb.let(qb.property("Version")).isEqualTo(qb.value(2)), qb.let(qb.property("Id")).isEqualTo(qb.value(3)), qb.let(qb.property("Version")).isEqualTo(qb.value(2))));
