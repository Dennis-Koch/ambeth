...
public class EmbeddedTypeTest extends AbstractInformationBusWithPersistenceTest {
    ...
    public void simple() throws Throwable {
        ...
        // scope in
        // production code!
        ITableMetaData table = transaction.processAndCommitWithResult(
                persistenceUnitToDatabaseMap -> persistenceUnitToDatabaseMap.iterator().next().getValue().getTableByType(ParentOfEmbeddedType.class).getMetaData());
    ...
    public void selectWithQueryBuilder() throws Throwable {
        ...
        IQuery<ParentOfEmbeddedType> query = qb.build(qb.let(qb.property("MyEmbeddedType.Name")).isEqualTo(qb.parameterValue(param1)));
