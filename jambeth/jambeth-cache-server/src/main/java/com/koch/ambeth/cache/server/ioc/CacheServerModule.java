...
@FrameworkModule
public class CacheServerModule implements IFrameworkModule {
    @Override
    public void afterPropertiesSet(IBeanContextFactory beanContextFactory) throws Throwable {
        ...
        IBeanConfiguration cacheLocalDataChangeListener = beanContextFactory.registerBean(CacheLocalDataChangeListener.class).propertyRefs(CacheModule.CACHE_DATA_CHANGE_LISTENER);
