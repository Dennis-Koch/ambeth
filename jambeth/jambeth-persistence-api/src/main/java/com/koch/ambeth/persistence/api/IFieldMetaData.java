...
public interface IFieldMetaData extends INamed {
	/**
	 *
	 * @return true, if this IField instance is an alternate id (single column unique constraint) for
	 *         the related ITable
	 */
	...
	/**
	 * Getter for additional information (like sub-types of a java type, e.g. on java.sql.Arrays of
	...
	/**
	 * Returns the proprietary type name given directly from the persistence provider (e.g. JDBC
	 * driver)
	 *
	 * @return The proprietary type name given directly from the persistence provider (e.g. JDBC
	 *         driver)
	 */
