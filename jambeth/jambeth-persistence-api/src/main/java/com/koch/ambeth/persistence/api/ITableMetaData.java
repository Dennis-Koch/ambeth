...
public interface ITableMetaData {
    ...
    /**
     * Get all primitive fields which are treated as unique and represent an alternate id for the
     * entity retrieval
     *
     * @return List of all unique constrained value fields which should be treated like alternate id
     * fields
     */
    IFieldMetaData[][] getAlternateIdsFields();
     ...
     *
     * @param idIndex
     * @return primary id field, if idIndex == -1, otherwise the alternate id field at this idIndex >= 0
     */
    IFieldMetaData getIdFieldByAlternateIdIndex(int idIndex);

    /**
     * Get id or alternate id field dependent on the specified idIndex. Supports composite id scenarios
     *
     * @param idIndex
     * @return fields together composing the primary id field, if idIndex == -1, otherwise the fields composing an alternate id field at this idIndex >= 0
     */
    IFieldMetaData[] getIdFieldsByAlternateIdIndex(int idIndex);
     ...
     * @param memberName Name of the member to map.
     * @return Mapped field.
     */
    ...
    boolean isIdField(String fieldName);
     ...
     *
     * @param linkName   Name of the link to map.
     * @param memberName Name of the member to map.
     * @return Mapped link.
     */
    ...
    /**
     * Getter for a field index identified by the name of the field. The index maps directly to the
     * field instance in the list of getAllFields().
     *
     * @param fieldName Name of the identifying member.
     * @return Field index mapped to the member (correlating to the list of getAllFields())
     */
    int getFieldIndexByName(String fieldName);

    /**
     * Getter for a field identified by the name of the property (primitive, relation, id, and
     * version) mapped to this field.
     *
     * @param propertyName Name of the identifying property.
    ...
    /**
     * Getter for the member name mapped to a field in this table and referenced by a link identified
     * by the given link name.
     *
     * @param linkName Identifying link name.
