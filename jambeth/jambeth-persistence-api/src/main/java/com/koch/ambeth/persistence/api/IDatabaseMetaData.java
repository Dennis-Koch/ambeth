...
public interface IDatabaseMetaData {
	...
	/**
	 * Getter for a permission group table table identified by either an entity table or a link
	 * table.
	 *
	...
	/**
	 * Getter for a table identified by the persisted entity type. This is equivalent to calling
	 * 'getTableByType(entityType, false)'.
	 *
	 * @param entityType Identifying type.
	 ...
	 *
	 * @param entityType Identifying type.
	 * @param tryOnly true, if null just be returned instead of an {@link IllegalStateException}
	 * @return Table used for persisting the given entity type.
	 */
	ITableMetaData getTableByType(Class<?> entityType, boolean tryOnly);
