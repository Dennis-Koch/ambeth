...
public interface ILinqFinder {
	...
	/**
	 * Selects ID and version of the only entity with a given value in this field. If there are no or
	 * more than one entities an exception is thrown.
	 *
	 * @param value Identifying value.
	 * @return Cursor to ID and version of all selected entities.
	 */
	...
	/**
	 * Selects ID and version of the first entity with a given value in this field. If there is no
