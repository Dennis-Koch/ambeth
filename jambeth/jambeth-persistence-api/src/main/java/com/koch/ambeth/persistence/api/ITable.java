...
public interface ITable {
     ...
     */
    IVersionCursor selectVersion(int idIndex, List<?> ids);
     ...
     * @param whereSql                   SQL string containing the WHERE clause without the key word
     * @param orderBySql                 SQL string containing the ORDER BY clause without the key word
     * @param limitSql                   SQL string containing the LIMIT clause without the key word
     * @param parameters
     * @return Cursor to ID and version of all selected entities.
     */
    IVersionCursor selectVersionWhere(List<String> additionalSelectColumnList, CharSequence whereSql, CharSequence orderBySql, CharSequence limitSql, List<Object> parameters);

    /**
     * Selects ID, version, and all value fields of all given entities in table.
     *
     * @param idIndex      index of the alternate ID ID member.
     ...
     */
    ICursor selectValues(int idIndex, List<?> alternateIds);
