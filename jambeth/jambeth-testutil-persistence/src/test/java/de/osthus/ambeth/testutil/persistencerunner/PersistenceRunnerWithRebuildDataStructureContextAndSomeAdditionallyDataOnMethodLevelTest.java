...
/**
 * Test for the AmbethPersistenceRunner which has the {@link SQLStructure}, the {@link SQLDataRebuild} and the {@link SQLData} annotations (on class and some on
 * method level) set (or set to true) and has an annotation set (on class level) which would trigger a context rebuild like {@link TestModule} or
 * {@link TestProperties}.
 */
...
public class PersistenceRunnerWithRebuildDataStructureContextAndSomeAdditionallyDataOnMethodLevelTest extends AbstractPersistenceRunnerTest
{
