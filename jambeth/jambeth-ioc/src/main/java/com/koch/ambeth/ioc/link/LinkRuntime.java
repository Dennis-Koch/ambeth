...
public class LinkRuntime<D> extends BeanRuntime<ILinkContainer> implements ILinkRegistryNeededRuntime<D>, ILinkRuntimeWithOptional, ILinkRuntimeOptional, ILinkRuntimeFinish {
    ...
    protected BeanConfiguration createBeanConfiguration(Class<?> beanType) {
        ...
        return new LinkConfiguration<>(beanType, proxyFactory, null);
    }

    @Override
    public ILinkRuntimeOptional with(Object... arguments) {
        propertyValue(AbstractLinkContainer.P_ARGUMENTS, arguments);
        return this;
    }

    @Override
    public ILinkRuntimeFinish optional() {
        propertyValue(AbstractLinkContainer.P_OPTIONAL, "true");
        return this;
    }
    ...
    public ILinkRegistryNeededRuntime<?> listener(IBeanConfiguration listenerBean) {
        propertyValue(AbstractLinkContainer.P_LISTENER_BEAN, listenerBean);
        return this;
    }

    public ILinkRegistryNeededRuntime<?> listener(String listenerBeanName) {
        propertyValue(AbstractLinkContainer.P_LISTENER_NAME, listenerBeanName);
        return this;
    }

    public ILinkRegistryNeededRuntime<?> listener(Object listener) {
        propertyValue(AbstractLinkContainer.P_LISTENER, listener);
        return this;
    }

    public ILinkRegistryNeededRuntime<?> listenerMethod(String methodName) {
        propertyValue(AbstractLinkContainer.P_LISTENER_METHOD_NAME, methodName);
        return this;
    }

    @Override
    public ILinkRuntimeWithOptional to(Class<?> autowiredRegistryClass) {
        propertyValue(AbstractLinkContainer.P_REGISTRY_TYPE, autowiredRegistryClass);
        return this;
    }

    @Override
    public ILinkRuntimeWithOptional to(Object registry, Class<?> registryClass) {
        propertyValue(AbstractLinkContainer.P_REGISTRY, registry);
        propertyValue(AbstractLinkContainer.P_REGISTRY_TYPE, registryClass);
        return this;
    }
    ...
    public ILinkRuntimeWithOptional to(Object registry, String propertyName) {
        propertyValue(AbstractLinkContainer.P_REGISTRY, registry);
        propertyValue(AbstractLinkContainer.P_REGISTRY_PROPERTY_NAME, propertyName);
        return this;
    }
    ...
    public ILinkRegistryNeededRuntime<D> toContext(IServiceContext beanContext) {
        propertyValue(AbstractLinkContainer.P_FOREIGN_BEAN_CONTEXT, beanContext);
        return this;
    }

    @Override
    public ILinkRegistryNeededRuntime<D> toContext(String nameOfBeanContext) {
        propertyValue(AbstractLinkContainer.P_FOREIGN_BEAN_CONTEXT_NAME, nameOfBeanContext);
        return this;
    }
}
