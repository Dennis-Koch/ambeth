...
public class BeanMonitoringSupport implements DynamicMBean {
	...
	public Object getAttribute(String attribute)
		...
		IPropertyInfoProvider propertyInfoProvider =
				beanContext.getService(IPropertyInfoProvider.class);
	...
	public void setAttribute(Attribute attribute) throws AttributeNotFoundException,
		...
		IPropertyInfo propertyInfo =
				propertyInfoProvider.getProperty(bean.getClass(), attribute.getName());
		Object value = beanContext.getService(IConversionHelper.class)
				.convertValueToType(propertyInfo.getPropertyType(), attribute.getValue());
	...
	public AttributeList setAttributes(AttributeList attributes) {
		...
		for (int a = 0, size = attributes.size(); a < size; a++) {
			...
			Object value =
					conversionHelper.convertValueToType(propertyInfo.getPropertyType(), attribute.getValue());
			propertyInfo.setValue(bean, value);
		}
	...
	public Object invoke(String actionName, Object[] params, String[] signature)
		...
		Method method =
				ReflectUtil.getDeclaredMethod(false, bean.getClass(), null, actionName, (Class<?>[]) null);
		try {
