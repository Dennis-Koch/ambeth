...
public class PropertiesPreProcessor implements IBeanPreProcessor, IInitializingBean {
    ...
    public void preProcessProperties(IBeanContextFactory beanContextFactory, IServiceContext beanContext, IProperties props, String beanName, Object service, Class<?> beanType,
        ...
        for (var prop : properties) {
            ...
            var propertyAttribute = prop.getAnnotation(Property.class);
            ...
            var value = props.get(propertyAttribute.name());

            if (value == null) {
                var stringValue = propertyAttribute.defaultValue();
