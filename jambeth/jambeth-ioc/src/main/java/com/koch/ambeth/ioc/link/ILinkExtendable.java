...
/**
 * Interface for linking a bean (extension/plugin) to an extendable during bean context startup
 ...
 * beanContextFactory.link("intConverter").to(IDedicatedConverterExtendable.class).with(Integer.class,
 * String.class);<br>
 * beanContextFactory.link("intConverter").to(IDedicatedConverterExtendable.class).with(String.class,
 * Integer.class);
 */
public interface ILinkExtendable {
	 ...
	 *
	 * @param listenerBeanName Name of the bean to add to registry.
	 * @param autowiredRegistryClass Autowire interface of the registry.
	 */
	@Deprecated
	 ...
	 * @param listenerBeanName Name of the bean to add to registry.
	 * @param autowiredRegistryClass Autowire interface of the registry.
	 * @param arguments Keys to register the bean for.
	 */
	@Deprecated
	 ...
	 * @deprecated Replaced by fluent interface to cover more use cases with less methods.
	 *
	 * @param listenerBean Identifier for the bean to add to registry.
	 * @param autowiredRegistryClass Autowire interface of the registry.
	 */
	@Deprecated
	 ...
	 * @deprecated Replaced by fluent interface to cover more use cases with less methods.
	 *
	 * @param registryBeanName Name of the registry.
	 * @param listenerBeanName Name of the bean to add to registry.
