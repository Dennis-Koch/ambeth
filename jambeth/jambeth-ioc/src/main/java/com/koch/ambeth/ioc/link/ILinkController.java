...
/**
 * Service bean for registering a bean (extension/plugin) to extendables at runtime using a fluent
 * interface.
 *
 * @see ILinkExtendable
 */
public interface ILinkController {
	 ...
	 *
	 * @param serviceContext IoC context containing the bean and the registry.
	 ...
	 * @return Next step of the fluent interface.
	 */
	ILinkRegistryNeededRuntime<?> link(IServiceContext serviceContext,
	 ...
	 * @return Next step of the fluent interface.
	 */
	ILinkRegistryNeededRuntime<?> link(IServiceContext serviceContext, Object listener,
			String methodName);
	 ...
	 * without using the fluent interface.
	 *
	 * @param listenerBean Identifier for the bean to add to a registry.
	 * @param methodName Name of the registry method.
	 * @return The LinkConfiguration object.
	 */
	LinkConfiguration<Object> createLinkConfiguration(IBeanConfiguration listenerBean,
			String methodName);

	/**
	 * Start linking a object or bean instance to a specific registry method without using the fluent
	 * interface.
	 *
	 * @param listener Object or bean to add to a registry.
	 * @param methodName Name of the registry method.
	...
	@Deprecated
	IBeanConfiguration createLinkConfiguration(String registryBeanName, String listenerBeanName,
			Class<?> registryClass);
	...
	@Deprecated
	IBeanConfiguration createLinkConfiguration(String listenerBeanName,
	...
	@Deprecated
	void link(IServiceContext serviceContext, String registryBeanName, String listenerBeanName,
			Class<?> registryClass, Object... arguments);
	...
	@Deprecated
	void link(IServiceContext serviceContext, IBeanConfiguration listenerBean,
			Class<?> autowiredRegistryClass);
	...
	@Deprecated
	void link(IServiceContext serviceContext, String listenerBeanName,
			Class<?> autowiredRegistryClass);
