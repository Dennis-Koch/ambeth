...
/**
 * Thrown by {@link ICancellation#ensureNotCancelled()} if {@link ICancellation#isCancelled()}
 * returns true
 */
public class CancelledException extends RuntimeException {
	...
	public CancelledException(String message, Throwable cause, boolean enableSuppression,
