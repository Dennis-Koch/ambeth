...
public class BeanContextFactory implements IBeanContextFactory, ILinkController, IDisposable {
    ...
    public static IServiceContext createBootstrap(IProperties properties, Class<?>[] bootstrapModules, Object[] bootstrapModuleInstances) {
        ...
        try {
            ...
            propertiesPreProcessor.preProcessProperties(null, null, newProps, "delegatingConversionHelper", delegatingConversionHelper, DelegatingConversionHelper.class, null,
            ...
            parentContextFactory.registerWithLifecycle(threadLocalCleanupController).autowireable(IThreadLocalCleanupController.class, IThreadLocalCleanupBeanExtendable.class);
            ...
            parentContextFactory.registerExternalBean(classLoaderProvider).autowireable(IClassLoaderProvider.class);
            ...
            parentContextFactory.registerExternalBean(interningFeature).autowireable(IInterningFeature.class);
    ...
    public BeanContextFactory(IThreadLocalObjectCollector objectCollector, ILinkController linkController, IBeanContextInitializer beanContextInitializer, IProxyFactory proxyFactory,
            ITypeInfoProvider typeInfoProvider, Properties properties, BeanContextFactory parent) {
    ...
    public IServiceContext create(String contextName, CheckedConsumer<IBeanContextFactory> registerPhaseDelegate, List<IBeanInstantiationProcessor> instantiationProcessors,
            List<IBeanPreProcessor> preProcessors, List<IBeanPostProcessor> postProcessors, IExternalServiceContext externalServiceContext) {
    ...
    public IServiceContext create(String contextName, ServiceContext parent, CheckedConsumer<IBeanContextFactory> registerPhaseDelegate) {
