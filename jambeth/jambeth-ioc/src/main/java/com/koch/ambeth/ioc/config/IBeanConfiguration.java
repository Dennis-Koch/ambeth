...
public interface IBeanConfiguration {
	...
	/**
	 * Getter for the configurations abstract flag. This defines the bean as real bean or template for
	 * other beans.
	 *
	...
	/**
	 * A bean that was registered by class at start time is always registered with life cycle. Only if
	 * the bean was registered as an instance it may not be called on life cycle events.
	 *
	...
	/**
	 * Getter for the precedence level of this bean. By the precedence level the order of bean
	 * initializations can be changed. The initialization order of beans with the same precedence
	 * level is undefined, except for resolving dependencies.
	 *
	...
	/**
	 * Flag if this bean configuration is allowed to replace an existing configuration for the given
	 * bean name.
	 *
	...
	/**
	 * Getter for the ignored property names. Those are properties to be ignored by the dependency
	 * injection.
	 *
	 ...
	 *
	 * @param precedenceType Precedence level of this bean.
	 ...
	 *
	 * @param parentBeanTemplateName Name of the template bean configuration to use.
	 * @return This bean configuration.
	 */
	 ...
	 *
	 * @param typeToPublish Autowire type for this bean.
	 * @return This bean configuration.
	 */
	 ...
	 *
	 * @param typesToPublish Autowire types for this bean.
	 * @return This bean configuration.
	 */
	 ...
	 * - An asterisk/star (*) in front of the bean name ignores the current IoC context and directs
	 * the search to its parent context, even if a bean with the name exists in the current
	 * context.<br>
	 ...
	 *
	 * @param propertyName Name of the target property.
	 * @param bean Bean configuration of the bean to inject.
	 * @return This bean configuration.
	 */
	 ...
	 * @return This bean configuration.
	 */
	IBeanConfiguration propertyRefFromContext(String propertyName, String fromContext,
			String beanName);

	/**
	 * Specifies a property injection and references the bean to inject by its name. The property will
	 * be chosen by the type of the specified bean to match the property type.
	 *
	...
	/**
	 * Specifies multiple property injections and references the beans to inject by their names. The
	 * properties will be chosen by the type of the specified beans to match the property type.
	 *
	 * @see IBeanConfiguration#propertyRef(String, String)
	 *
	 * @param beanNames Names of the beans to inject.
	 * @return This bean configuration.
	 */
	IBeanConfiguration propertyRefs(String... beanNames);

	/**
	 * Specifies a property injection and references the bean to inject by its bean configuration. The
	 * property will be chosen by the type of the specified bean to match the property type.
	 *
	 * @param bean Bean configuration of the bean to inject.
	 * @return This bean configuration.
	 */
	...
	/**
	 * Specifies multiple property injections and references the beans to inject by their bean
	 * configurations. The properties will be chosen by the type of the specified beans to match the
	 * property type.
	 *
	 * @param bean Bean configurations of the beans to inject.
	 * @return This bean configuration.
	 */
	IBeanConfiguration propertyRefs(IBeanConfiguration... beans);

	/**
	 * Specifies a property injection including the value to be injected. This value may be any bean,
	 * Object or primitive value matching the properties type.
	 *
	 * @param propertyName Name of the target property.
	 ...
	 *
	 * @param propertyName Name of the property to be ignored.
	 * @return This bean configuration.
	 */
	 ...
	 *
	 * @param propertyNames Names of properties to be ignored.
	 * @return This bean configuration.
	 */
