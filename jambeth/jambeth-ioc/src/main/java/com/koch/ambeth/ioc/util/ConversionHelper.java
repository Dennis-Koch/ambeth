...
public class ConversionHelper extends IConversionHelper implements IThreadLocalCleanupBean {
    ...
    public <T> IPreparedConverter<T> prepareConverter(Class<T> expectedType, Object exemplaryValue) {
        return prepareConverterIntern(expectedType, exemplaryValue, null);
    }
    ...
    public <T> IPreparedConverter<T> prepareConverter(Class<T> expectedType, Object exemplaryValue, Object exemplaryAdditionalInformation) {
        return prepareConverterIntern(expectedType, exemplaryValue, exemplaryAdditionalInformation);
    }
