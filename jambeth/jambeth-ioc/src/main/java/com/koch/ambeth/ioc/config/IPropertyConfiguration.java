...
public interface IPropertyConfiguration {
	...
	/**
	 * Getter for the name of the IoC context where the bean to inject on the property has to be
	 * looked up.
	 *
	...
	/**
	 * Getter for the name of the target been. Even unnamed beans are referred to by the IoC container
	 * by a generated name.
	 *
	 * @return Bean name.
	 */
	...
	/**
	 * Flag if this property configuration is optional. If so this configuration will be ignored if
