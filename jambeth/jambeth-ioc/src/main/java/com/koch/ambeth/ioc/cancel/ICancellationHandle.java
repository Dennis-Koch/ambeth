...
public interface ICancellationHandle extends AutoCloseable {
     ...
     * @param state
     */
    <V> void withCancellationAwareness(CheckedConsumer<V> consumer, V state);
     ...
     * @param runnable
     */
    void withCancellationAwareness(CheckedRunnable runnable);
     ...
     * @return
     */
    <R> R withCancellationAwareness(CheckedSupplier<R> runnable);
     ...
     * @return
     */
    <R, V> R withCancellationAwareness(CheckedFunction<V, R> runnable, V state);
}
