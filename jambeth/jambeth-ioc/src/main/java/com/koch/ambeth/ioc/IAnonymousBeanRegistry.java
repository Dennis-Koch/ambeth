...
public interface IAnonymousBeanRegistry {
	/**
	 * To register an already instantiated anonymous bean in the context. Injections will be made and
	 * life cycle methods will be called.
	 *
	...
	/**
	 * Register an object instance implementing {@link IDisposable} for the bean context shutdown life
	 * cycle event.
	 *
	 * @param disposable Disposable object instance.
	 */
	void registerDisposable(IDisposable disposable);

	/**
	 * Register an object instance implementing {@link IDisposableBean} for the bean context shutdown
	 * life cycle event.
	 *
	 * @param disposable Disposable object instance.
	 */
	...
	/**
	 * To register an already instantiated anonymous bean in the context. Injections will be made,
	 * life cycle methods will not be called.
	 *
