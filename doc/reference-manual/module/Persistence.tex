...
\begin{itemize}
	...
	\item \prettyref{configuration:DatabaseChecksumAlgorithm}
	...
	\item \prettyref{configuration:JdbcConnectionInterfaces}
	...
	\item \prettyref{configuration:PersistenceParallelExecutorName}
	\item \prettyref{configuration:PersistenceParallelReadActive}
\end{itemize}
%% CONFIGURATION END
