...
\begin{itemize}
  \item An example for a module is the \prettyref{module:Audit} module. Use this module if you need full \prettyref{regulations:21CFRPart11} Title 21 CFR Part 11 audit support for your application.
