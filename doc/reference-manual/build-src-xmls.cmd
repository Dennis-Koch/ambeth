...
call mvn -f %javaModuleDir2%\pom.xml dependency:copy-dependencies -DoutputDirectory=%javaSrcDir% -DincludeGroupIds=de.osthus.ambeth

rem Copy all external library jars
call mvn -f %javaModuleDir2%\pom.xml dependency:copy-dependencies -DoutputDirectory=%javaLibDir% -DexcludeGroupIds=de.osthus.ambeth
...
@call mvn exec:java -Dexec.mainClass="de.osthus.classbrowser.java.Program" -DjarFolders="%javaSrcDir%" -DlibraryJarFolders="%javaLibDir%" -DtargetPath="%dataDir%" -DmoduleRootPath="%javaModuleDir%"
