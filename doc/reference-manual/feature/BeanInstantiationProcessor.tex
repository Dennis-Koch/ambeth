...
\newline
A major usecase for such an \textit{InstantiationProcessor} is the \javadoc{de.osthus.ambeth.propertychange.PropertyChangeInstantiationProcessor}{PropertyChangeInstantiationProcessor} - working behind the scenes of the \prettyref{annotation:PropertyChangeAspect} annotation.
