...
\AvailableInJavaAndCsharp{To use this feature annotate your entities with \type{@EntityEqualsAspect} (Java) or \type{[EntityEqualsAspect]} (C\#). As a result you get the following functionality at runtime:}
