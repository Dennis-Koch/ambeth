...
\begin{itemize}
	...
	\item \prettyref{configuration:SecurityLoginPasswordChangerecommendation}
	...
	\item \prettyref{configuration:SecuritySignatureKeyProviderName}
	\item \prettyref{configuration:SecuritySignatureLength}
	\item \prettyref{configuration:SecuritySignaturePaddingAlgorithmName}
	\item \prettyref{configuration:SecuritySignatureProviderName}
\end{itemize}
%% CONFIGURATION END
