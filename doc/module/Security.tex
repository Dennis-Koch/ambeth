...
After a successful authentication \& authorization the information gets stored in a thread-local security handle. To be of any use your beans have to be secured declaratively with the \typea{@SecurityContext}{jambeth-security/src/main/java/de/osthus/ambeth/security/SecurityContext.java} annotation:
