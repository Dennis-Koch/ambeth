...
{
    public class EntityPrivilegeEnhancementHint : IEnhancementHint, ITargetNameEnhancementHint
    {
        protected readonly Type entityType;

        protected readonly bool create, read, update, delete, execute;

        public EntityPrivilegeEnhancementHint(Type entityType, bool create, bool read, bool update, bool delete, bool execute)
        {
        ...
        public override bool Equals(Object obj)
        {
            ...
            if (!(obj is EntityPrivilegeEnhancementHint))
            {
                return false;
            }
        ...
        {
            return GetType().GetHashCode() ^ EntityType.GetHashCode() ^ PropertyPrivilegeImpl.ToBitValue(Create, Read, Update, Delete, Execute);
        }
        ...
        {
            if (typeof(EntityPrivilegeEnhancementHint).Equals(includedHintType))
            {
                return this;
            }
            return null;
