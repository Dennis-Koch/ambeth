...
namespace De.Osthus.Ambeth.Persistence
{
    public interface ITableMetaData
    {
         ...
         */
        IList<IFieldMetaData> getPrimitiveFields();

        IList<IFieldMetaData> getFulltextFields();
         ...
         * @return List of all value fields.
         */
        IList<IFieldMetaData> getAllFields();
         ...
         */
        IList<IDirectedLinkMetaData> getLinks();
