...
{
    public class EntityTypePrivilegeVisitor : ClassVisitor
    {
        ...
        public EntityTypePrivilegeVisitor(IClassVisitor cv, IEntityMetaData metaData, bool? create, bool? read, bool? update, bool? delete, bool? execute)
            : base(cv)
        {
        ...
        public void visitEnd()
        {
            ...
            MethodInstance template_m_getPrimitivePropertyPrivilege = new MethodInstance(null, typeof(ITypePrivilege), typeof(ITypePropertyPrivilege),
            ...
            MethodInstance template_m_setPrimitivePropertyPrivilege = new MethodInstance(null, MethodAttributes.Family, typeof(void), "SetPrimitivePropertyPrivilege",
                    typeof(int), typeof(ITypePropertyPrivilege));

            MethodInstance template_m_getRelationPropertyPrivilege = new MethodInstance(null, typeof(ITypePrivilege), typeof(ITypePropertyPrivilege),
            ...
            {
                IMethodVisitor mg = VisitMethod(new MethodInstance(null, typeof(ITypePrivilege), typeof(bool?), "get_CreateAllowed"));
                mg.Push(create);
                mg.ReturnValue();
                mg.EndMethod();
            }
            {
                IMethodVisitor mg = VisitMethod(new MethodInstance(null, typeof(ITypePrivilege), typeof(bool?), "get_ReadAllowed"));
                mg.Push(read);
                mg.ReturnValue();
                mg.EndMethod();
            }
            {
                IMethodVisitor mg = VisitMethod(new MethodInstance(null, typeof(ITypePrivilege), typeof(bool?), "get_UpdateAllowed"));
                mg.Push(update);
                mg.ReturnValue();
                mg.EndMethod();
            }
            {
                IMethodVisitor mg = VisitMethod(new MethodInstance(null, typeof(ITypePrivilege), typeof(bool?), "get_DeleteAllowed"));
                mg.Push(delete);
                mg.ReturnValue();
                mg.EndMethod();
            }
            {
                IMethodVisitor mg = VisitMethod(new MethodInstance(null, typeof(ITypePrivilege), typeof(bool?), "get_ExecuteAllowed"));
                mg.Push(execute);
                mg.ReturnValue();
                mg.EndMethod();
            }
            {
                IMethodVisitor mg = VisitMethod(new MethodInstance(null, typeof(ITypePrivilege), typeof(ITypePropertyPrivilege), "GetDefaultPropertyPrivilegeIfValid"));
                mg.PushNull();
                mg.ReturnValue();
                mg.EndMethod();
            }
        ...
        protected void implementConstructor(MethodInstance template_m_setPrimitivePropertyPrivilege, MethodInstance template_m_setRelationPropertyPrivilege)
        {
            ...
            Type propertyPrivilegeType = typeof(ITypePropertyPrivilege);
        ...
        protected void ImplementGetSetPropertyPrivilege(Member[] members, MethodInstance template_getPropertyPrivilege, MethodInstance template_setPropertyPrivilege)
        {
            ...
            for (int index = 0, size = members.Length; index < size; index++)
            {
                ...
                FieldInstance field = ImplementField(new FieldInstance(FieldAttributes.Private, GetFieldName(member), typeof(ITypePropertyPrivilege)));
                fields[index] = field;
            }
